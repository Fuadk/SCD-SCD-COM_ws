...
exports.PolylineConnectionResizeAdorner = void 0;
...
class PolylineConnectionResizeAdorner extends AdornerBase_1.AdornerBase {
    ...
    createHandlePoints() {
        ...
        for (let i = 0; i < points.length - 1;) {
            ...
            if (pStart.x !== pEnd.x || pStart.y !== pEnd.y) {
                ...
                result.push({ vertex: false, point: new math_1.Point((pStart.x + pEnd.x) / 2, (pStart.y + pEnd.y) / 2) });
    ...
    _createHandles() {
        ...
        this.handles = [];
        if ((this.connection.options.type || '').toLowerCase() !== constants_1.POLYLINE || this.connection.pointsEditable() === false) {
            return;
        }
    ...
    _applySnap(p, handlePointIndex) {
        ...
        const snapThreshold = this.options.snap !== undefined ? this.options.snap : constants_1.CONNECTION_POINTS_EDITING_SNAP;
        const all = this.connection.allPoints();
        let prevPoint = null;
        let nextPoint = null;
        if (handlePoint.vertex) {
        ...
        return new math_1.Point(snappedX !== null ? snappedX : p.x, snappedY !== null ? snappedY : p.y);
    }
    stop(_p) {
        if (!this.activeHandle) {
            return undefined;
...
exports.PolylineConnectionResizeAdorner = PolylineConnectionResizeAdorner;
