...
exports.pruneRedundantLocks = pruneRedundantLocks;
...
function buildRenderPoints(buildOpts, locks) {
    const route = (0, CascadingRouting_1.buildConnection)({ ...buildOpts, locks });
    const full = [buildOpts.source, ...route.points, buildOpts.target];
    return (0, CascadingRouting_1.simplifyOrthogonalPoints)(full);
}
