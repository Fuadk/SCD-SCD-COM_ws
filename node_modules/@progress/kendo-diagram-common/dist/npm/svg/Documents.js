...
class MultipleDocuments extends Document {
     ...
     */
    _initPath() {
        this.drawingElement = new kendo_drawing_1.drawing.Group({ id: this.options.id });
        this._fill();
        this._drawPath();
    }
    /**
