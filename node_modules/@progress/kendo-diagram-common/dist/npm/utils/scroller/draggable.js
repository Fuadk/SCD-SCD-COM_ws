...
exports.Movable = exports.Pane = exports.PaneAxis = exports.PaneDimensions = exports.PaneDimension = exports.TapCapture = void 0;
const kendo_drawing_1 = require("@progress/kendo-drawing");
const event_map_1 = require("./event-map");
const Observable_1 = require("../Observable");
const constants_1 = require("./../../constants");
const utils_1 = require("./utils");
const elementOffset = kendo_drawing_1.drawing.util.elementOffset;
const translate = function (x, y, scale) {
    return 'translate3d(' + x + 'px,' + y + 'px,0) scale(' + scale + ')';
};
class TapCapture extends Observable_1.Observable {
    constructor(element, options) {
        ...
        event_map_1.eventMap.down.split(' ').forEach((event) => {
            domElement.addEventListener(event, this._pressHandler, true);
        });
        event_map_1.eventMap.up.split(' ').forEach((event) => {
...
exports.TapCapture = TapCapture;
class PaneDimension extends Observable_1.Observable {
    constructor(options) {
        super();
    ...
    update(silent) {
        ...
        if (!silent) {
            this.trigger(constants_1.CHANGE, this);
        }
    }
}
exports.PaneDimension = PaneDimension;
class PaneDimensions extends Observable_1.Observable {
    constructor(options) {
        super();
        this.x = new PaneDimension((0, utils_1.extend)({
            horizontal: true
        }, options));
        this.y = new PaneDimension((0, utils_1.extend)({
            horizontal: false
        }, options));
        this.container = options.container;
        this.forcedMinScale = options.minScale;
        this.maxScale = options.maxScale || 100;
        this.bind(constants_1.CHANGE, options);
    }
    rescale(newScale) {
...
exports.PaneDimensions = PaneDimensions;
class PaneAxis extends Observable_1.Observable {
    constructor(options) {
        super();
        (0, utils_1.extend)(this, options);
    }
...
exports.Pane = Pane;
class Movable extends Observable_1.Observable {
    constructor(element) {
        super();
    ...
    moveTo(coordinates, silent = false) {
        (0, utils_1.extend)(this, coordinates);
        this.refresh(silent);
    }
