...
import { type RouteResult } from './../services/routing/RouteResult';
import { type ConnectionBuildOptions, type PreviewSideState } from '../services/routing/CascadingRouting';
/** @hidden */
export interface ConnectorResolution {
    _resolvedSourceConnector?: Connector;
    _resolvedTargetConnector?: Connector;
}
export type RoutingMode = 'auto' | 'manual';
/**
 * The visual link between two Shapes through the intermediate of Connectors.
 */
export declare class Connection extends DiagramElement {
    ...
    definers: PathDefiner[];
    /** @hidden */
    _sourceDefiner: PathDefiner;
    /** @hidden */
    _targetDefiner: PathDefiner;
    /** @hidden */
    diagram: Diagram;
    /** @hidden */
    _bounds: Rect;
    /** @hidden */
    _router: CascadingRouter | PolylineRouter;
     ...
     */
    updateModel(syncChanges?: any): void;
    /**
     ...
     */
    source(source?: any, undoable?: any): Point | Connector;
    /** @hidden */
    _setFromOptions(from: any, fromPoint?: any): void;
    /**
     ...
     */
    sourceDefiner(value: any): PathDefiner;
    /**
     ...
     */
    target(target?: any, undoable?: any): Point | Connector;
    /** @hidden */
    _setToOptions(to: any, toPoint?: any): void;
    /**
     ...
     */
    targetDefiner(value: any): PathDefiner;
    /** @hidden */
    _updateConnectors(): void;
    /** @hidden */
    _updateConnector(instance: any, name: any): void;
    /**
    ...
    /** @hidden */
    _createContentVisual(options: any): any;
    /** @hidden */
    _updateContentVisual(options: any): void;
    /** @hidden */
    _alignContent(): void;
    /**
    ...
    refresh(): void;
    /** @hidden */
    _resolveConnectors(destination?: ConnectorResolution): void;
    /** @hidden */
    _resolveAutoConnectors(sourceConnectors: any, targetConnectors: any, destination?: ConnectorResolution): void;
    /** @hidden */
    _hasPolylineEditedPoints(): boolean;
    /** @hidden */
    _resolveAutoConnectorsWithLocks(sourceConnectors: any, targetConnectors: any, destination?: ConnectorResolution): void;
    /** @hidden */
    _calculateRouteLength(sourcePoint: any, targetPoint: any, sourceConnector: any, targetConnector: any): number;
    /** @hidden */
    _testRoutePoints(sourcePoint: any, targetPoint: any, sourceConnector: any, targetConnector: any): boolean;
    /** @hidden */
    _getRouteExclude(sourcePoint: any, targetPoint: any, sourceShape: any, targetShape: any): any[];
    /** @hidden */
    _isPointInsideShape(point: any, shape: any): boolean;
    /**
     ...
     * @private
     */
    _hitTest(value: any): this;
    /** @hidden */
    _hover(value: any): void;
    /** @hidden */
    _refreshPath(): void;
    /** @hidden */
    _drawPath(): void;
    /** @hidden */
    _clearSourceConnector(): void;
    /** @hidden */
    _clearTargetConnector(): void;
    /** @hidden */
    _removeFromSourceConnector(): void;
    /** @hidden */
    _removeFromTargetConnector(): void;
    /**
