...
import { FlowchartShapeType } from './utils';
import { DiagramElement } from './DiagramElement';
import { type Diagram } from './../Diagram';
import { ShapeType } from './../types';
export declare class Shape extends DiagramElement {
    /** @hidden */
    diagram: Diagram;
    ...
    _bounds: Rect;
    /** @hidden */
    _rotationOffset: Point;
    /** @hidden - Original width specified by user, before stroke inflation */
    _originalWidth: number;
    /** @hidden - Original height specified by user, before stroke inflation */
    _originalHeight: number;
    /** Indicates whether this shape can contain other shapes.
     * @hidden
    */
    isContainer: boolean;
    /** @hidden */
     ...
     */
    constructor(options: any, diagram: any);
    /** @hidden */
     ...
     */
    updateOptionsFromModel(model?: any, field?: any): void;
    /** @hidden */
    _redrawVisual(): void;
    /**
     ...
     */
    bounds(value?: any): any;
    /** @hidden */
    _setBounds(rect: any): void;
    /**
     ...
     */
    rotate(angle?: any, center?: any, undoable?: any): any;
    /**
     ...
     */
    getConnector(nameOrPoint: any): any;
    /**
    ...
    /** @hidden */
    _diffNumericOptions(options: any, fields: any): any;
    /** @hidden */
    _visualOptions(options: any): {
        accessibility: any;
        cornerRadius: any;
        data: any;
        source: any;
    ...
    /** @hidden */
    _triggerBoundsChange(): void;
    /** @hidden */
    _transformPoint(point: any): any;
    /** @hidden */
    ...
    /** @hidden */
    _getMaxConnectorOffset(): number;
    /** @hidden */
    _hitTest(value: any): any;
    /**
