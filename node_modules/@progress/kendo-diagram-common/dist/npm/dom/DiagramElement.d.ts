import { TextBlock, RichTextBlock } from './../svg';
import { Observable } from './../utils/Observable';
/** @hidden */
export declare const getTextElementType: (options: any) => typeof TextBlock | typeof RichTextBlock;
/** @hidden */
export declare class DiagramElement extends Observable {
     ...
     */
    visible(value?: any): boolean | void;
    /**
    ...
    serialize(): any;
    /** @hidden */
    _content(content?: any): any;
    /** @hidden */
    _createContentVisual(options: any): void;
    /** @hidden */
    _updateContentVisual(options: any): void;
    /** @hidden */
    _hitTest(point: any): any;
    /** @hidden */
    _template(): void;
    /** @hidden */
    _canSelect(): boolean;
