...
import { CHANGE, DEFAULT_CANVAS_HEIGHT, DEFAULT_CANVAS_WIDTH, MAX_VALUE, MIN_VALUE, MOBILE_PAN_DISTANCE, MOBILE_ZOOM_RATE, MOUSE_ENTER, MOUSE_LEAVE, OBJECT, PAN, ROTATED, SELECT, SHAPE, TOOLTIP_HIDE, TOOLTIP_SHOW, TRANSFORMED, ZOOM_END, ZOOM_START } from './constants';
...
export class Diagram extends Observable {
    ...
    _interactionDefaults() {
        ...
        if (pannable === true) {
            options.pannable = { ...defaultOptions.pannable };
        }
    ...
    _mouseDown(e) {
        ...
        if (e.button === 1 && this.options.pannable !== false && !this.toolService.hoveredItem) {
            ...
            const meta = deepExtend(this._meta(e), { middleButton: true });
    ...
    disablePan() {
        ...
        this._currentPannable = typeof pannable === OBJECT ? { ...pannable } : pannable;
