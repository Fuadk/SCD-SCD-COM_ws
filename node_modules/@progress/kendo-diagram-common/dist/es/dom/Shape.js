...
import { ABSOLUTE, HEIGHT, ITEMBOUNDSCHANGE, ITEMROTATE, NO_WRAP, ROTATED, TRANSFORMED, WIDTH, X, Y, FOCUS_CLASS, CLASS_NAME, EMPTY, SHAPE } from './../constants';
...
export class Shape extends DiagramElement {
    ...
    _alignContent() {
        ...
        const pad = typeof contentVisual.padding === 'function' ? contentVisual.padding() : { left: 0, top: 0, right: 0, bottom: 0 };
        const paddedClipRect = new g.Rect([
        ...
        if (contentVisual.alignable === false) {
            ...
            if (!richBounds) {
                setDrawingClip(contentVisual.drawingContainer(), d.Path.fromRect(paddedClipRect));
                return;
            }
            setDrawingClip(contentVisual.drawingContainer(), d.Path.fromRect(paddedClipRect));
            return;
