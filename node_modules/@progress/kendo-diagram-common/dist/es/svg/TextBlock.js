...
import { EMPTY, PX, SPACE, CENTER, START, END } from '../constants';
...
export function calculatePadding(options) {
    ...
    const curPadding = getSpacing((padding !== undefined ? padding : defaultTextOptions.padding), 0);
    const curRelativePadding = getContentSpacing(shapeSize, (relativePadding !== undefined ? relativePadding : defaultTextOptions.relativePadding));
    return {
 ...
 */
export class TextBlock extends VisualBase {
    /**
    ...
    _initText() {
        ...
        this.drawingElement = new d.Text(defined(options.text) ? options.text : EMPTY, new g.Point(), {
            font: options.font
        });
