 ...
 * - `"exponentialTrendline"`&mdash;Shows an exponential [trendline]({% slug trendlines_chart_charts %}#toc-exponential-trendline) for the specified parent series.
 ...
 * - `"linearTrendline"`&mdash;Shows a linear [trendline]({% slug trendlines_chart_charts %}#toc-linear-trendline) for the specified parent series.
 * - `"logarithmicTrendline"`&mdash;Shows a logarithmic [trendline]({% slug trendlines_chart_charts %}#toc-logarithmic-trendline) for the specified parent series.
 * - `"movingAverageTrendline"`&mdash;Shows a moving average [trendline]({% slug trendlines_chart_charts %}#toc-moving-average-trendline) for the specified parent series.
 ...
 * - `"polynomialTrendline"`&mdash;Shows a polynomial [trendline]({% slug trendlines_chart_charts %}#toc-polynomial-trendline) for the specified parent series.
 * - `"powerTrendline"`&mdash;Shows a power [trendline]({% slug trendlines_chart_charts %}#toc-power-trendline) for the specified parent series.
