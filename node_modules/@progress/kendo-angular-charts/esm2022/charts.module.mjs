...
import { KENDO_CHARTS } from './directives';
...
import * as i94 from "./sparkline.component";
import * as i95 from "./stock-chart.component";
import * as i96 from "./stock-chart/navigator.component";
import * as i97 from "./stock-chart/navigator/category-axis.component";
import * as i98 from "./stock-chart/navigator/category-axis/crosshair.component";
import * as i99 from "./stock-chart/navigator/category-axis/crosshair.tooltip.component";
import * as i100 from "./stock-chart/navigator/category-axis/labels.component";
import * as i101 from "./stock-chart/navigator/category-axis/notes.component";
import * as i102 from "./stock-chart/navigator/category-axis/notes.icon.component";
import * as i103 from "./stock-chart/navigator/category-axis/notes.label.component";
import * as i104 from "./stock-chart/navigator/category-axis/select.component";
import * as i105 from "./stock-chart/navigator/category-axis/title.component";
import * as i106 from "./stock-chart/navigator/hint.component";
import * as i107 from "./stock-chart/navigator/pane.component";
import * as i108 from "./stock-chart/navigator/pane/title.component";
import * as i109 from "./stock-chart/navigator/select.component";
import * as i110 from "./stock-chart/navigator/series.component";
import * as i111 from "./stock-chart/navigator/series-item.component";
import * as i112 from "./stock-chart/navigator/series-item/error-bars.component";
import * as i113 from "./stock-chart/navigator/series-item/extremes.component";
import * as i114 from "./stock-chart/navigator/series-item/highlight.component";
import * as i115 from "./stock-chart/navigator/series-item/labels.component";
import * as i116 from "./stock-chart/navigator/series-item/labels.from.component";
import * as i117 from "./stock-chart/navigator/series-item/labels.to.component";
import * as i118 from "./stock-chart/navigator/series-item/markers.component";
import * as i119 from "./stock-chart/navigator/series-item/notes.component";
import * as i120 from "./stock-chart/navigator/series-item/notes.icon.component";
import * as i121 from "./stock-chart/navigator/series-item/notes.label.component";
import * as i122 from "./stock-chart/navigator/series-item/outliers.component";
import * as i123 from "./stock-chart/navigator/series-item/tooltip.component";
import * as i124 from "./sankey.component";
import * as i125 from "./sankey/tooltip/tooltip-popup.component";
import * as i126 from "./sankey/tooltip/link-tooltip-template.directive";
import * as i127 from "./sankey/tooltip/node-tooltip-template.directive";
import * as i128 from "./sankey/localization/custom-messages.component";
import * as i129 from "./sankey/localization/localized-messages.directive";
import * as i130 from "./sankey/title.component";
import * as i131 from "./sankey/legend.component";
import * as i132 from "./sankey/tooltip.component";
import * as i133 from "./sankey/links.component";
import * as i134 from "./sankey/nodes.component";
import * as i135 from "./sankey/labels.component";
import * as i136 from "./sankey/data-binding/flat-binding.directive";
