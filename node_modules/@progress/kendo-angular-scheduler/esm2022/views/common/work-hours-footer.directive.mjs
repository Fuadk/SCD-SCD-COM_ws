...
export class WorkHoursFooterDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.14", ngImport: i0, type: WorkHoursFooterDirective, deps: [{ token: i1.ViewFooterComponent }, { token: i2.LocalizationService }], target: i0.ɵɵFactoryTarget.Directive });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "18.2.14", ngImport: i0, type: WorkHoursFooterDirective, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1.ViewFooterComponent }, { type: i2.LocalizationService }], propDecorators: { showWorkHours: [{
                type: Input
            }] } });
