...
!function(e2) {
  ...
  [e.BLAZOR]: "Telerik UI for Blazor",
  [e.DPL]: "Telerik Document Processing",
  [e.JM]: "Telerik JustMock",
  [e.KENDOUIANGULAR]: "Kendo UI for Angular",
  [e.KENDOUICOMPLETE]: "Kendo UI for jQuery",
  [e.KENDOUIMVC]: "Telerik UI for ASP.NET MVC",
  [e.KENDOUIREACT]: "KendoReact",
  [e.KENDOUIVUE]: "Kendo UI for Vue",
  [e.MAUI]: "Telerik UI for .NET MAUI",
  [e.RCAJAX]: "Telerik UI for ASP.NET AJAX",
  [e.RCWF]: "Telerik UI for WinForms",
  [e.RCWPF]: "Telerik UI for WPF",
  [e.REPORTING]: "Telerik Reporting",
  [e.REPORTSERVER]: "Telerik Report Server",
  [e.UIASPCORE]: "Telerik UI for ASP.NET Core",
  [e.UIXAM]: "Telerik UI for Xamarin",
  [e.WINUI]: "Telerik UI for WinUI"
});
function t(e2) {
...
function a(e2, t2) {
  ...
  }(e3)) : e2.products?.length > 0 && (o2 = e2.products.map((t3) => ({
    type: t3.trial ? "trial" : "perpetual",
    code: t3.code,
    expiration: t3.licenseExpirationDate,
    licenseId: null,
    userId: e2.userId
  }))), function(e3, t3) {
...
var f = class {
  constructor(e2, t2, n2, i2) {
    this.productName = e2, this.severity = "WARN", this.code = "TKL201", this.notificationIcon = p, this.message = "No Telerik and Kendo UI License found.\n  To download a license key file, visit https://prgress.co/3PwQMKZ", this.notificationMessage = `License key missing for ${e2} v${n2}.  A license key is required for both paid and trial usage. Learn <a href="${i2}">how to set up a license key</a>.`, this.notificationTitle = `License key missing for ${e2} v${n2}.`, this.notificationBody = "A license key is required for both paid and trial usage.", this.callToAction = {
      link: `https://www.telerik.com/download?utm_source=no_license_watermark&utm_campaign=${t2.toLowerCase()}&utm_content=no_license_key_found`,
...
var C = class {
  ...
  Learn more about ${e2} licensing at ${i2}`, this.notificationMessage = `No license found for ${e2} v${n2}.  Access to the latest updates and support requires a <a href="${i2}">valid license</a>.`, this.notificationTitle = `No license found for ${e2} v${n2}`, this.notificationBody = "To use this product and access updates and support you need to buy and install a valid license.", this.callToAction = {
      link: `https://www.telerik.com/purchase.aspx?utm_source=no_license_watermark&utm_campaign=${t2.toLowerCase()}&utm_content=no_license_key_current_product`,
      message: "Buy Now"
    };
  }
};
var L = class {
  ...
  To continue using our product, consider upgrading to a commercial license: https://prgress.co/3C9mr1M`, this.notificationMessage = `Your trial license for ${e2} v${n2} has expired ${i2} ago. To continue using our product, consider upgrading to a commercial license. Learn more about <a href="https://prgress.co/3PwQMdX">${e2} licensing</a>.`, this.notificationTitle = `Your trial license for ${e2} has expired.`, this.notificationBody = "To continue using the product you need to buy a subscription.", this.callToAction = {
      link: `https://www.telerik.com/purchase.aspx?utm_source=no_license_watermark&utm_campaign=${t2.toLowerCase()}&utm_content=trial_expired`,
      message: "Buy Now"
    };
  }
};
var m = class {
  ...
  Renew your license at https://prgress.co/3Px9m5F`, this.notificationMessage = `Your license is not valid for ${e2} v${i2}. To continue using the product, install a <a href="${r2}">valid license</a>. Renew <a href="https://prgress.co/3PwQNi1">your license</a> and download a new license key.`, this.notificationTitle = `Your license doesn't cover ${e2} v${i2}`, this.notificationBody = "To access the latest version and updates you need to renew your license.", this.callToAction = {
      link: `https://www.telerik.com/account/your-licenses?utm_source=no_license_watermark&utm_campaign=${t2.toLowerCase()}&utm_content=perpertual_newer_version`,
      message: "Renew Now"
    };
  }
};
var g = class {
  constructor(e2, t2, n2) {
    this.productName = e2, this.severity = "WARN", this.code = "TKL204", this.notificationIcon = h, this.message = `Your ${e2} subscription has expired on ${n2.toLocaleDateString()}. To continue using the product, please renew your subscription at https://prgress.co/3Px9m5F and download a new license key.`, this.notificationMessage = `Your ${e2} subscription has expired. To continue using the product, please <a href="https://prgress.co/3PwQMut">renew your subscription</a> and download a new license key.`, this.notificationTitle = `Your ${e2} subscription has expired.`, this.notificationBody = "To continue using the product you need to renew your subscription.", this.callToAction = {
      link: `https://www.telerik.com/account/your-licenses?utm_source=no_license_watermark&utm_campaign=${t2.toLowerCase()}&utm_content=subscription_expired`,
      message: "Renew Now"
    };
  }
};
var w = class {
  ...
  To acquire a commercial license, visit https://prgress.co/3PyHIoH`, this.notificationTitle = `Active trial for ${e2} v${n2}`, this.notificationBody = `Your trial will expire in ${-i2} day(s).`, this.callToAction = {
      link: `https://www.telerik.com/purchase.aspx?utm_source=no_license_watermark&utm_campaign=${t2.toLowerCase()}&utm_content=active_trial`,
      message: "Buy now"
    };
  }
};
function y(e2, t2) {
  return __async(this, null, function* () {
    ...
    const n2 = crypto.subtle, [i2, s2, c2] = e2.split("."), a2 = r(c2), l2 = new TextEncoder(), u = new TextDecoder(), p2 = l2.encode(`${i2}.${s2}`), d2 = u.decode(r(i2));
    ...
    const h2 = yield function(e3) {
      ...
      return crypto.subtle.importKey("spki", t3, {
...
//# sourceMappingURL=chunk-RWPIEFVW.js.map
