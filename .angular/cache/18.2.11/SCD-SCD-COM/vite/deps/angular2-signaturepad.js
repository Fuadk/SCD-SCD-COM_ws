...
SignaturePad2.ɵfac = function SignaturePad_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SignaturePad2)(ɵɵdirectiveInject(ElementRef));
};
SignaturePad2.ɵcmp = ɵɵdefineComponent({
  type: SignaturePad2,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SignaturePad2, [{
    type: Component,
    args: [{
...
var SignaturePadModule = class {
};
SignaturePadModule.ɵfac = function SignaturePadModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SignaturePadModule)();
};
SignaturePadModule.ɵmod = ɵɵdefineNgModule({
  type: SignaturePadModule,
  declarations: [SignaturePad2],
  exports: [SignaturePad2]
});
SignaturePadModule.ɵinj = ɵɵdefineInjector({
  imports: [[]]
});
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SignaturePadModule, [{
    type: NgModule,
    args: [{
      declarations: [SignaturePad2],
      imports: [],
