...
function KeyboardMove(config, keyboard, canvas) {
  ...
  function arrowsListener(context) {
    ...
    if (keyboard.isKey(["ArrowLeft", "Left", "ArrowUp", "Up", "ArrowDown", "Down", "ArrowRight", "Right"], event2)) {
...
NavigatedViewer.prototype._navigationModules = [keyboard_move_default, movecanvas_default, zoomscroll_default];
...
var context_pad_default = {
  __depends__: [interaction_events_default, scheduler_default, overlays_default],
...
function $(n3, l3, u3) {
  ...
  for (n3.__k = [], t4 = 0; t4 < e4; t4++) null != (i3 = l3[t4]) && "boolean" != typeof i3 && "function" != typeof i3 ? (r4 = t4 + a3, (i3 = n3.__k[t4] = "string" == typeof i3 || "number" == typeof i3 || "bigint" == typeof i3 || i3.constructor == String ? g(null, i3, null, null, null) : y(i3) ? g(b, {
    children: i3
  }, null, null, null) : void 0 === i3.constructor && i3.__b > 0 ? g(i3.type, i3.props, i3.key, i3.ref ? i3.ref : null, i3.__v) : i3).__ = n3, i3.__b = n3.__b + 1, o3 = null, -1 !== (f3 = i3.__i = L(i3, u3, r4, s3)) && (s3--, (o3 = u3[f3]) && (o3.__u |= 131072)), null == o3 || null === o3.__v ? (-1 == f3 && a3--, "function" != typeof i3.type && (i3.__u |= 65536)) : f3 !== r4 && (f3 == r4 - 1 ? a3-- : f3 == r4 + 1 ? a3++ : (f3 > r4 ? a3-- : a3++, i3.__u |= 65536))) : i3 = n3.__k[t4] = null;
...
function A(n3, l3, u3, t4, i3) {
  var o3;
  n: if ("style" === l3) {
    if ("string" == typeof u3) n3.style.cssText = u3;
    else {
        ...
        <ul key=${group.id} class="djs-popup-header-group" data-header-group=${group.id}>
          ...
          ${group.entries.map((entry) => m`
            <li key=${entry.id}>
              ...
              >
                ${entry.imageUrl && m`<img class="djs-popup-entry-icon" src=${entry.imageUrl} alt="" />` || entry.imageHtml && m`<div class="djs-popup-entry-icon" dangerouslySetInnerHTML=${{
...
function getHeaderClasses(entry, selected) {
  return clsx_default("entry", entry.className, entry.active ? "active" : "", entry.disabled ? "disabled" : "", selected ? "selected" : "");
}
...
function groupEntries2(entries) {
  ...
  entries.forEach((entry) => {
    ...
    if (!containsGroup(group)) {
      groups.push(__spreadProps(__spreadValues({}, group), {
        entries: [entry]
      }));
    } else {
...
function PopupMenuComponent(props) {
  ...
  const filterEntries = q2((originalEntries2, value2) => {
    ...
    const filter2 = (entry) => {
      ...
      const searchableFields = [entry.description || "", entry.label || "", entry.search || ""].map((string) => string.toLowerCase());
...
PopupMenu.prototype._render = function() {
  ...
  const entriesArray = Object.entries(entries).map(([key, value]) => __spreadValues({
    id: key
  }, value));
  const headerEntriesArray = Object.entries(headerEntries).map(([key, value]) => __spreadValues({
    id: key
  }, value));
...
PopupMenu.prototype.refresh = function() {
  ...
  this._current = __spreadProps(__spreadValues({}, this._current), {
    entries,
    headerEntries,
    emptyPlaceholder
  });
...
PopupMenu.prototype._getEmptyPlaceholder = function(providers) {
  const provider = providers.find((provider2) => isFunction(provider2.getEmptyPlaceholder));
...
var align_elements_default2 = {
  __depends__: [align_elements_default, context_pad_default, popup_menu_default],
...
function Dragging(eventBus, canvas, selection, elementRegistry) {
  ...
  function fire(type, dragContext) {
    ...
    var event2 = eventBus.createEvent(assign({}, dragContext.payload, dragContext.data, {
...
function circlePath(center2, r4) {
  ...
  return [["M", x3, y3], ["m", 0, -r4], ["a", r4, r4, 0, 1, 1, 0, 2 * r4], ["a", r4, r4, 0, 1, 1, 0, -2 * r4], ["z"]];
}
...
function BendpointMovePreview(bendpointMove, injector, eventBus, canvas) {
  ...
  eventBus.on(["bendpoint.move.out", "bendpoint.move.cleanup"], HIGH_PRIORITY2, function(event2) {
  ...
  eventBus.on("bendpoint.move.move", function(event2) {
    var context = event2.context, allowed = context.allowed, bendpointIndex = context.bendpointIndex, draggerGfx = context.draggerGfx, hover = context.hover, type = context.type, connection = context.connection, source = connection.source, target = connection.target, newWaypoints = connection.waypoints.slice(), bendpoint = {
      x: event2.x,
      y: event2.y
...
function ConnectionSegmentMove(injector, eventBus, canvas, dragging, graphicsFactory, modeling) {
  ...
  eventBus.on(["connectionSegment.move.out", "connectionSegment.move.cleanup"], function(event2) {
  ...
  eventBus.on(["connectionSegment.move.cancel", "connectionSegment.move.end"], function(event2) {
    var context = event2.context, connection = context.connection;
...
function BendpointSnapping(eventBus) {
  ...
  eventBus.on(["connect.hover", "connect.move", "connect.end"], 1500, function(event2) {
...
var bendpoints_default = {
  __depends__: [dragging_default, rules_default],
...
function ConnectPreview(injector, eventBus, canvas) {
  ...
  eventBus.on(["connect.out", "connect.cleanup"], HIGH_PRIORITY3, function(event2) {
...
var connect_default = {
  __depends__: [selection_default, rules_default, dragging_default],
...
function AdaptiveLabelPositioningBehavior(eventBus, modeling) {
  CommandInterceptor.call(this, eventBus);
  this.postExecuted(["connection.create", "connection.layout", "connection.updateWaypoints"], function(event2) {
  ...
  this.postExecuted(["label.create"], function(event2) {
...
function getTakenConnectionAlignments(element) {
  ...
  var takenAlignments = [].concat(element.incoming.map(function(c3) {
...
function CompensateBoundaryEventBehavior(eventBus, modeling, bpmnRules) {
  ...
  function handleReplacement(context) {
    ...
    if (isCompensationBoundaryEvent(context.oldShape) && newData.eventDefinitionType !== "bpmn:CompensateEventDefinition" || newData.type !== "bpmn:BoundaryEvent") {
      ...
      const targetConnection = oldShape.outgoing.find(({
        target
      }) => isForCompensationAllowed(target));
      if (targetConnection && targetConnection.target) {
        context._connectionTarget = targetConnection.target;
      }
...
function CreateParticipantBehavior(canvas, eventBus, modeling) {
  CommandInterceptor.call(this, eventBus);
  eventBus.on(["create.start", "shape.move.start"], HIGH_PRIORITY4, function(event2) {
...
function collectLanes(shape, collectedShapes) {
  ...
  shape.children.filter(function(s3) {
    if (is(s3, "bpmn:Lane")) {
      collectLanes(s3, collectedShapes);
      collectedShapes.push(s3);
    }
  });
  return collectedShapes;
}
function getChildLanes(shape) {
  return shape.children.filter(function(c3) {
    return is(c3, "bpmn:Lane");
  });
}
...
function computeLanesResize(shape, newBounds) {
  ...
  allLanes.forEach(function(other) {
    ...
    if (trblResize.left) {
      if (abs3(otherTrbl.right - shapeTrbl.left) < 10) {
        rightResize = shapeNewTrbl.left - otherTrbl.right;
      }
      if (abs3(otherTrbl.left - shapeTrbl.left) < 5) {
    ...
    if (trblResize.right) {
      if (abs3(otherTrbl.left - shapeTrbl.right) < 10) {
        leftResize = shapeNewTrbl.right - otherTrbl.left;
      }
      if (abs3(otherTrbl.right - shapeTrbl.right) < 5) {
...
function FixHoverBehavior(elementRegistry, eventBus, canvas) {
  eventBus.on(["create.hover", "create.move", "create.out", "create.end", "shape.move.hover", "shape.move.move", "shape.move.out", "shape.move.end"], HIGH_PRIORITY5, function(event2) {
  ...
  eventBus.on(["connect.hover", "connect.out", "connect.end", "connect.cleanup", "global-connect.hover", "global-connect.out", "global-connect.end", "global-connect.cleanup"], HIGH_PRIORITY5, function(event2) {
    var hover = event2.hover;
  ...
  eventBus.on(["bendpoint.move.hover"], HIGH_PRIORITY5, function(event2) {
  ...
  eventBus.on(["connect.start"], HIGH_PRIORITY5, function(event2) {
...
function fenced(n3, rangeStart, rangeEnd) {
  return n3 >= min2(rangeStart, rangeEnd) - EQUAL_THRESHOLD && n3 <= max3(rangeStart, rangeEnd) + EQUAL_THRESHOLD;
}
...
function LabelBehavior(eventBus, modeling, bpmnFactory, textRenderer) {
  ...
  this.postExecute(["connection.layout", "connection.updateWaypoints"], function(event2) {
...
function LayoutConnectionBehavior(eventBus, modeling) {
  ...
  this.postExecute(["connection.move"], function(event2) {
    var context = event2.context;
...
function getNewWaypoints(inWaypoints, outWaypoints) {
  ...
  if (intersection2) {
    ...
    return [getDocking2(inWaypoints[0]), getDocking2(outWaypoints[outWaypoints.length - 1])];
  }
}
...
function getParticipantResizeConstraints(laneShape, resizeDirection, balanced) {
  ...
  allLanes.forEach(function(other) {
    ...
    if (/e/.test(resizeDirection)) {
      if (balanced && abs5(laneTrbl.right - otherTrbl.left) < 10) {
        addMin(maxTrbl, "right", otherTrbl.right - minDimensions.width);
      }
      if (abs5(laneTrbl.right - otherTrbl.right) < 5) {
    ...
    if (/w/.test(resizeDirection)) {
      if (balanced && abs5(laneTrbl.left - otherTrbl.right) < 10) {
        addMax(maxTrbl, "left", otherTrbl.left + minDimensions.width);
      }
      if (abs5(laneTrbl.left - otherTrbl.left) < 5) {
...
function UpdateFlowNodeRefsBehavior(eventBus, modeling) {
  ...
  this.preExecute(["shape.create", "shape.move", "shape.delete", "shape.resize"], function(event2) {
...
function isConnectedToCompensationBoundaryEvent(element) {
  const compensationAssociations = element.incoming.filter((connection) => isCompensationBoundaryEvent2(connection.source));
...
var create_default = {
  __depends__: [dragging_default, preview_support_default, rules_default, selection_default],
...
var copy_paste_default = {
  __depends__: [clipboard_default, create_default, mouse_default, rules_default],
  __init__: ["copyPaste"],
...
var copy_paste_default2 = {
  __depends__: [copy_paste_default],
...
function BpmnReplace(bpmnFactory, elementFactory, moddleCopy, modeling, replace, rules) {
  function replaceElement(element, targetElement, hints) {
    ...
    copyProperties2(element.di, newElement.di, ["fill", "stroke", "background-color", "border-color", "color"]);
    ...
    return replace.replaceElement(element, newElement, __spreadProps(__spreadValues({}, hints), {
      targetElement
    }));
  }
...
var replace_default2 = {
  __depends__: [copy_paste_default2, replace_default, selection_default],
...
var space_tool_default = {
  ...
  __depends__: [dragging_default, rules_default, tool_manager_default, preview_support_default, mouse_default],
...
function LabelSupport(injector, eventBus, modeling) {
  ...
  this.preExecute(["connection.delete", "shape.delete"], function(e4) {
...
function BpmnUpdater(eventBus, bpmnFactory, connectionDocking) {
  ...
  function updateBPMNLabel(event2) {
    const {
      element
    } = event2.context, label = getLabel(element);
...
DeleteConnectionHandler.prototype.preExecute = function(context) {
  ...
  saveClear(connection.incoming, function(connection2) {
    modeling.removeConnection(connection2, {
      nested: true
    });
  });
...
MoveConnectionHandler.prototype.execute = function(context) {
  ...
  forEach(connection.waypoints, function(p3) {
    ...
    p3.y += delta2.y;
    if (p3.original) {
      p3.original.x += delta2.x;
      p3.original.y += delta2.y;
    }
  });
  return connection;
};
...
AddLaneHandler.prototype.preExecute = function(context) {
  ...
  spaceTool.makeSpace(adjustments.movingShapes, adjustments.resizingShapes, delta2, direction, spacePos);
...
Modeling2.$inject = ["eventBus", "elementFactory", "commandStack", "bpmnRules"];
...
var modeling_default = {
  ...
  __depends__: [behavior_default, rules_default2, di_ordering_default, ordering_default, replace_default2, command_default, label_support_default, attach_support_default, selection_default, change_support_default, space_tool_default2],
...
var append_preview_default = {
  __depends__: [auto_place_default2, complex_preview_default, modeling_default],
...
TextBox.prototype.resizable = function() {
  ...
  if (!resizeHandle) {
    ...
    var onMouseMove = function(e4) {
      preventDefault2(e4);
      stopPropagation2(e4);
      var newWidth = min4(max7(startWidth + e4.clientX - startX, minWidth), maxWidth);
      var newHeight = min4(max7(startHeight + e4.clientY - startY, minHeight), maxHeight);
...
DirectEditing.prototype._fire = function(event2, context) {
  this._eventBus.fire("directEditing." + event2, context || {
    active: this._active
  });
};
...
ReplaceMenuProvider.prototype.getPopupMenuHeaderEntries = function(target) {
  ...
  if (is(target, "bpmn:Activity") && !isEventSubProcess(target)) {
    headerEntries = __spreadValues(__spreadValues({}, headerEntries), this._getLoopCharacteristicsHeaderEntries(target));
  }
  if (is(target, "bpmn:DataObjectReference")) {
    headerEntries = __spreadValues(__spreadValues({}, headerEntries), this._getCollectionHeaderEntries(target));
  }
  if (is(target, "bpmn:Participant")) {
    headerEntries = __spreadValues(__spreadValues({}, headerEntries), this._getParticipantMultiplicityHeaderEntries(target));
  }
  if (is(target, "bpmn:SubProcess") && !is(target, "bpmn:Transaction") && !isEventSubProcess(target)) {
    headerEntries = __spreadValues(__spreadValues({}, headerEntries), this._getAdHocHeaderEntries(target));
  }
  if (canBeNonInterrupting(target)) {
    headerEntries = __spreadValues(__spreadValues({}, headerEntries), this._getNonInterruptingHeaderEntries(target));
  }
    ...
    switch (replaceOption.actionName) {
      case "replace-with-default-flow":
        if (businessObject.sourceRef.default !== businessObject && (is(businessObject.sourceRef, "bpmn:ExclusiveGateway") || is(businessObject.sourceRef, "bpmn:InclusiveGateway") || is(businessObject.sourceRef, "bpmn:ComplexGateway") || is(businessObject.sourceRef, "bpmn:Activity"))) {
          entries = __spreadProps(__spreadValues({}, entries), {
...
ReplaceMenuProvider.prototype._getLoopCharacteristicsHeaderEntries = function(target) {
  ...
  function toggleLoopEntry(event2, entry) {
    if (entry.active) {
      self2._modeling.updateProperties(target, {
...
ReplaceMenuProvider.prototype._getCollectionHeaderEntries = function(target) {
  ...
  function toggleIsCollection(event2, entry) {
    self2._modeling.updateModdleProperties(target, dataObject, {
...
var popup_menu_default2 = {
  __depends__: [popup_menu_default, replace_default2, auto_place_default2],
...
ContextPadProvider.prototype.getContextPadEntries = function(element) {
  ...
  if (is(businessObject, "bpmn:FlowNode")) {
    if (is(businessObject, "bpmn:EventBasedGateway")) {
      assign(actions, {
        "append.receive-task": appendAction("bpmn:ReceiveTask", "bpmn-icon-receive-task", translate2("Append receive task")),
        "append.message-intermediate-event": appendAction("bpmn:IntermediateCatchEvent", "bpmn-icon-intermediate-event-catch-message", translate2("Append message intermediate catch event"), {
          eventDefinitionType: "bpmn:MessageEventDefinition"
        }),
        "append.timer-intermediate-event": appendAction("bpmn:IntermediateCatchEvent", "bpmn-icon-intermediate-event-catch-timer", translate2("Append timer intermediate catch event"), {
          eventDefinitionType: "bpmn:TimerEventDefinition"
        }),
        "append.condition-intermediate-event": appendAction("bpmn:IntermediateCatchEvent", "bpmn-icon-intermediate-event-catch-condition", translate2("Append conditional intermediate catch event"), {
          eventDefinitionType: "bpmn:ConditionalEventDefinition"
        }),
        "append.signal-intermediate-event": appendAction("bpmn:IntermediateCatchEvent", "bpmn-icon-intermediate-event-catch-signal", translate2("Append signal intermediate catch event"), {
          eventDefinitionType: "bpmn:SignalEventDefinition"
        })
      });
      ...
      assign(actions, {
        "append.end-event": appendAction("bpmn:EndEvent", "bpmn-icon-end-event-none", translate2("Append end event")),
  ...
  if (is(businessObject, "bpmn:SequenceFlow")) {
    assign(actions, {
      "append.text-annotation": appendAction("bpmn:TextAnnotation", "bpmn-icon-text-annotation", translate2("Add text annotation"))
    });
  }
...
var context_pad_default2 = {
  __depends__: [append_preview_default, lib_default, context_pad_default, selection_default, connect_default, create_default, popup_menu_default2],
...
var distribute_elements_default2 = {
  __depends__: [popup_menu_default, distribute_elements_default],
...
function GridSnapping(elementRegistry, eventBus, config) {
  ...
  eventBus.on(["create.move", "create.end", "bendpoint.move.move", "bendpoint.move.end", "connect.move", "connect.end", "connectionSegment.move.move", "connectionSegment.move.end", "resize.move", "resize.end", "shape.move.move", "shape.move.end"], LOWER_PRIORITY2, function(event2) {
    var originalEvent = event2.originalEvent;
...
ResizeBehavior2.$inject = ["eventBus", "gridSnapping", "modeling"];
...
function SpaceToolBehavior2(eventBus, gridSnapping) {
  eventBus.on(["spaceTool.move", "spaceTool.end"], HIGH_PRIORITY14, function(event2) {
    var context = event2.context;
    if (!context.initialized) {
      return;
    }
...
SpaceToolBehavior2.$inject = ["eventBus", "gridSnapping"];
...
function GridSnappingParticipantBehavior(canvas, eventBus, gridSnapping) {
  eventBus.on(["create.start", "shape.move.start"], HIGHER_PRIORITY, function(event2) {
    var context = event2.context, shape = context.shape, rootElement = canvas.getRootElement();
    if (!is(shape, "bpmn:Participant") || !is(rootElement, "bpmn:Process") || !rootElement.children.length) {
      return;
    }
...
function GridSnappingLayoutConnectionBehavior(eventBus, gridSnapping, modeling) {
  ...
  this._gridSnapping = gridSnapping;
  var self2 = this;
  this.postExecuted(["connection.create", "connection.layout"], HIGH_PRIORITY16, function(event2) {
...
var grid_snapping_default2 = {
  __depends__: [grid_snapping_default, behavior_default3],
...
var keyboard_move_selection_default = {
  __depends__: [keyboard_default, selection_default],
...
var resize_default = {
  __depends__: [rules_default, dragging_default, preview_support_default],
...
function LabelEditingProvider(eventBus, bpmnFactory, canvas, directEditing, modeling, resizeHandles, textRenderer) {
  ...
  eventBus.on(["shape.remove", "connection.remove"], HIGH_PRIORITY17, function(event2) {
...
var label_editing_default = {
  __depends__: [change_support_default, resize_default, lib_default],
...
function MoveEvents(eventBus, dragging, modeling, selection, rules) {
  ...
  eventBus.on("shape.move.move", LOW_PRIORITY21, function(event2) {
    var context = event2.context, validatedShapes = context.validatedShapes, hover = event2.hover, delta2 = {
      x: event2.dx,
      y: event2.dy
    }, position = {
      x: event2.x,
...
function MovePreview(eventBus, canvas, styles, previewSupport) {
  ...
  eventBus.on("shape.move.start", LOW_PRIORITY22, function(event2) {
...
var move_default = {
  __depends__: [interaction_events_default, selection_default, outline_default, rules_default, dragging_default, preview_support_default],
...
var lasso_tool_default = {
  __depends__: [tool_manager_default, mouse_default],
  __init__: ["lassoTool"],
...
function HandTool(eventBus, canvas, dragging, injector, toolManager, mouse) {
  ...
  eventBus.on("hand.end", function(event2) {
    ...
    eventBus.once("hand.ended", function() {
      self2.activateMove(event2.originalEvent, {
        reactivate: true
      });
    });
  });
...
var global_connect_default = {
  __depends__: [connect_default, rules_default, dragging_default, tool_manager_default, mouse_default],
...
PaletteProvider.prototype.getPaletteEntries = function() {
  ...
  assign(actions, {
    ...
    "create.start-event": createAction("bpmn:StartEvent", "event", "bpmn-icon-start-event-none", translate2("Create start event")),
    ...
    "create.end-event": createAction("bpmn:EndEvent", "event", "bpmn-icon-end-event-none", translate2("Create end event")),
    ...
    "create.data-object": createAction("bpmn:DataObjectReference", "data-object", "bpmn-icon-data-object", translate2("Create data object reference")),
    "create.data-store": createAction("bpmn:DataStoreReference", "data-store", "bpmn-icon-data-store", translate2("Create data store reference")),
...
var palette_default2 = {
  __depends__: [palette_default, create_default, space_tool_default2, lasso_tool_default, hand_tool_default, global_connect_default, translate_default],
...
function BpmnConnectSnapping(eventBus) {
  eventBus.on(["connect.hover", "connect.move", "connect.end"], HIGHER_PRIORITY3, function(event2) {
...
function CreateMoveSnapping(elementRegistry, eventBus, snapping) {
  ...
  eventBus.on(["create.move", "create.end", "shape.move.move", "shape.move.end"], HIGHER_PRIORITY4, function(event2) {
...
function BpmnCreateMoveSnapping(eventBus, injector) {
  ...
  eventBus.on(["create.move", "create.end", "shape.move.move", "shape.move.end"], HIGH_PRIORITY20, function(event2) {
...
function ResizeSnapping(eventBus, snapping) {
  ...
  eventBus.on(["resize.move", "resize.end"], HIGHER_PRIORITY5, function(event2) {
...
var search_pad_default = {
  __depends__: [translate_default, overlays_default, selection_default],
...
var search_default = {
  __depends__: [search_pad_default],
  __init__: ["bpmnSearch"],
