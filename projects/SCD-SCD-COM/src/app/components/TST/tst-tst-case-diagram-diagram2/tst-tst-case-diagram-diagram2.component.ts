...
import { tstcaseDiagramTstTstCaseDiagramDiagram2 , componentConfigDef} from '@modeldir/model';
...
import {TstTestidComponent} from '../tst-testid/tst-testid.component';
...
@Component({
  selector: 'app-tst-tst-case-diagram-diagram2',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './tst-tst-case-diagram-diagram2.component.html',
  styleUrls: ['./tst-tst-case-diagram-diagram2.component.scss'],
  standalone: false
})
...
export class TstCaseDiagramTstTstCaseDiagramDiagram2DiagramComponent {
  ...
  public routineName = "TstCaseDiagramTstTstCaseDiagramDiagram2Diagram";
  ...
  public compSelector = 'app-tst-tst-case-diagram-diagram2';
...
public disableDIAGRAM_ID = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new tstcaseDiagramTstTstCaseDiagramDiagram2();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input TstCaseDiagramTstTstCaseDiagramDiagram2Diagram form.TST_DIAGRAM_ID :' + form.TST_DIAGRAM_ID);
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("TstCaseDiagramTstTstCaseDiagramDiagram2Diagram ComponentConfig:", {...ComponentConfig});
