...
const createFormGroup = (dataItem:any) => new FormGroup({
  ...
  'PAGE_ORDER': new FormControl(dataItem.PAGE_ORDER, Validators.required),
  'PAGE_TYPE': new FormControl(dataItem.PAGE_TYPE, Validators.required),
  ...
  @Input() public set executeQueryInput(form: any) {
    ...
    if ((typeof form != "undefined") && form.type == "page" && (typeof form.data.FORM_NAME != "undefined") && (form.data.FORM_NAME != "")) {
      ...
      this.currentPage = JSON.parse(JSON.stringify(form.data))
       this.form.setValue(form.data);
      //this.form.updateValueAndValidity(); 
      if (this.paramConfig.DEBUG_FLAG) console.log ("this.form:form.data):", this.form.invalid, form.data,this.form)
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    if (typeof ComponentConfig !== "undefined") {
      ...
      if (ComponentConfig.masterParams != null) {
        ...
        this.formInitialValues.PAGE_NO = ComponentConfig.masterParams.maxPageNo+1;
        this.formInitialValues.PAGE_ORDER = ComponentConfig.masterParams.maxPageORder+1;
