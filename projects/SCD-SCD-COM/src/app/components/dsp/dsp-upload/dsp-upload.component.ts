...
public removeEventHandler_not_used(e: SelectEvent): void {
  ...
  getTempAttField(data,field_id){
    ...
    console.log("getTempAttField:field_id:", field_id, " attachments:", attachments);
    if (typeof attachments !== "undefined" && (attachments != null) && (attachments.trim() != "")) {
      console.log("getTempAttField:attachments:", attachments);
      try {
  ...
  public InsertImage(field_id){
   ...
   console.log("InsertImage:field_id:", field_id, this.myFiles);
    ...
    console.log("this.myFiles[]:", this.myFiles)
      ...
      this.myFiles["accountImg"]=this.accountImg;
      let masterParams={
