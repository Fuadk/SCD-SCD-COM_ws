...
private Body:any =[];
  ...
  this.starServices.fetchLookups(this, this.lookupArrDef);
   ...
   this.DSP_ORDERSGridConfig.updateable = false;
   this.DSP_ORDERSGridConfig.showDiagram = false;
   this.DSP_ORDERSGridConfig.showHideGridFlag = false;
   ...
   this.DSP_WORK_ORDERSGridConfig.updateable = false;
   //this.DSP_WORK_ORDERSGridConfig.showToolBar = false;
   if (this.paramConfig.defaultModule == "FLOW" || this.paramConfig.defaultModule == "APPS"){
    this.showAll = false;
