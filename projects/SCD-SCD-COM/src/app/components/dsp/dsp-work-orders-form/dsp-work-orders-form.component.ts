...
export class DspWorkOrdersFormComponent {
  ...
  public compSelector = 'app-dsp-work-orders-form';
  public children = ["any"];
...
private Body:any =[];
  ...
  constructor(public router: Router,public responsive: BreakpointObserver ,public starServices: starServices, private starNotify: StarNotifyService) {  
...
public templateFields;
  ...
  public showMultiStepFormScreen(formVal, FIELDS, formname){
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("test:this.fieldsData:", this.fieldsData, "this.templateInfo:", this.templateInfo);
