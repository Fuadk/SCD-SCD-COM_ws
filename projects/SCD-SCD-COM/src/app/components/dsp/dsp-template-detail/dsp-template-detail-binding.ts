...
@Directive({
    selector: '[templateDetailBinding]'
})
export class templateDetailDirective extends DataBindingDirective implements OnInit, OnDestroy {
    private serviceSubscription: Subscription;

    constructor(public responsive: BreakpointObserver ,public starServices: starServices, grid: GridComponent) {
        super(grid);
    }
