...
public compSelector = 'app-log-trans-grid';
...
private Body =[];
  ...
  @Output() saveCompletedOutput: EventEmitter<any> = new EventEmitter();
    ...
    constructor(public intl: IntlService,  private starNotify: StarNotifyService,  private starlib1: Starlib1, public responsive: BreakpointObserver ,public starServices: starServices, private renderer: Renderer2) {
