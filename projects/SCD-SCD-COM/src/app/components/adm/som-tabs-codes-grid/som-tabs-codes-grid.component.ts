...
private Body = [];
  ...
  constructor(public responsive: BreakpointObserver ,public starServices: starServices, private renderer: Renderer2 , private starlib1: Starlib1,) {
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    if (this.paramConfig.DEBUG_FLAG) console.log("SomTabsCodesGridComponent componentConfig:",ComponentConfig);
