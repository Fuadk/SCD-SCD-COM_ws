...
import { scdshapeDisplayGeneralScdSdgShapeDisplayGeneral , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-sdg-shape-display-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-sdg-shape-display-general.component.html',
  styleUrls: ['./scd-sdg-shape-display-general.component.scss'],
  standalone: false
})


export class ScdShapeDisplayGeneralScdSdgShapeDisplayGeneralFormdivsComponent {
  public title =  this.starServices.getNLS([],"SCD_SDG_SHAPE_DISPLAY_GENERAL.scdshapeDisplayGeneralScdSdgShapeDisplayGeneral.component_title","Shape Display General");
  public compTitleMsg =  "SCD_SDG_SHAPE_DISPLAY_GENERAL.scdshapeDisplayGeneralScdSdgShapeDisplayGeneral";
  public routineName = "ScdShapeDisplayGeneralScdSdgShapeDisplayGeneralFormdivs";
  ...
  public compSelector = 'app-scd-sdg-shape-display-general';
  public PK_AUTO = 'SHAPE_DISPLAY_GENERAL_ID';
  public customerFacing = false;
  public FormStepsArr = [{"CODE":"","CODETEXT_LANG":"","visible":true},{"CODE":"1","CODETEXT_LANG":"Expression","visible":true},{"CODE":"2","CODETEXT_LANG":"Numeric","visible":true},{"CODE":"3","CODETEXT_LANG":"Justification","visible":true},{"CODE":"4","CODETEXT_LANG":"Leading Character","visible":true},{"CODE":"5","CODETEXT_LANG":"Dimensions","visible":true}] ;
...
public disableHEIGHT = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdshapeDisplayGeneralScdSdgShapeDisplayGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdShapeDisplayGeneralScdSdgShapeDisplayGeneralFormdivs form.SHAPE_ID :' + form.SHAPE_ID);
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdShapeDisplayGeneralScdSdgShapeDisplayGeneralFormdivs ComponentConfig:", {...ComponentConfig});
 ...
 async ON_CLICK(formGroup){
  ...
  async  POST_QUERY(formGroup){
    if (formGroup.DECIMAL_PLACES == "FIXED"){
    this.visibleDYNAMIC_DECIMAL_PLACES = false;
    this.visibleFIXED_DECIMAL_PLACES = true;
}
if (formGroup.DECIMAL_PLACES == "DYNAMIC"){
    this.visibleDYNAMIC_DECIMAL_PLACES = true;
    this.visibleFIXED_DECIMAL_PLACES = false;
}
