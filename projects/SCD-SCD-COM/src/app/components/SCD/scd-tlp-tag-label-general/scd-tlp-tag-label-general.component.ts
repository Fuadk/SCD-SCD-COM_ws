...
import { scdtagLabelGeneralScdTlpTagLabelGeneral , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-tlp-tag-label-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-tlp-tag-label-general.component.html',
  styleUrls: ['./scd-tlp-tag-label-general.component.scss'],
  standalone: false
})


export class ScdTagLabelGeneralScdTlpTagLabelGeneralFormComponent {
  public title =  this.starServices.getNLS([],"SCD_TLP_TAG_LABEL_GENERAL.scdtagLabelGeneralScdTlpTagLabelGeneral.component_title","Tag Label General");
  public compTitleMsg =  "SCD_TLP_TAG_LABEL_GENERAL.scdtagLabelGeneralScdTlpTagLabelGeneral";
  public routineName = "ScdTagLabelGeneralScdTlpTagLabelGeneralForm";
  ...
  public compSelector = 'app-scd-tlp-tag-label-general';
...
public visibleJUSTIFICATION = false;
...
public disableJUSTIFICATION = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdtagLabelGeneralScdTlpTagLabelGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdTagLabelGeneralScdTlpTagLabelGeneralForm form.SHAPE_ID :' + form.SHAPE_ID);
...
this.form.get('TAG_PRIORITY').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdTagLabelGeneralScdTlpTagLabelGeneralForm ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_JUSTIFICATION(value) {
 ...
 async onChange_TAG_PRIORITY(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
