...
import {   scddiagramMenusScdScdDiagramMenusGrid , componentConfigDef } from '@modeldir/model';
...
@Component({
  selector: 'app-scd-scd-diagram-menus-grid',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-scd-diagram-menus-grid.component.html',
  standalone: false,
  styleUrls: ['./scd-scd-diagram-menus-grid.component.scss'
],
...
export class ScdDiagramMenusScdScdDiagramMenusGridGridComponent implements OnInit,OnDestroy {
 ...
 public showToolBar = true;
  ...
  private insertCMD = "INSERT_SCD_DIAGRAM_MENUS";
  private updateCMD = "UPDATE_SCD_DIAGRAM_MENUS";
  private deleteCMD =   "DELETE_SCD_DIAGRAM_MENUS";
  private getCMD = "GET_SCD_DIAGRAM_MENUS_QUERY";
...
public compSelector = 'app-scd-scd-diagram-menus-grid';
  ...
  @Output() formValidationChangedOutput: EventEmitter<boolean> = new EventEmitter();
    ...
    constructor(public router: Router,public intl: IntlService, public responsive: BreakpointObserver, private starNotify: StarNotifyService,   public starServices: starServices, private renderer: Renderer2) {
      ...
      this.title = this.componentConfig.title ? this.componentConfig.title :this.starServices.getNLS([],"SCD_SCD_DIAGRAM_MENUS_GRID.scddiagramMenusScdScdDiagramMenusGrid.component_title","SCD DIAGRAM MENUS GRID");
  }
...
//Next part for filtering
  ...
  private gridInitialValues:any = new scddiagramMenusScdScdDiagramMenusGrid();   
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ScdDiagramMenusScdScdDiagramMenusGridGrid ComponentConfig:", ComponentConfig);
