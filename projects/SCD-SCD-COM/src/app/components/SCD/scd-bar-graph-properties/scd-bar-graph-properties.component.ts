...
import {  scdshapeScdTpCommonScreen  ,scdgraphGeneralScdGgGraphGeneral  ,scdshapeConnectionScdScShapeConnections  , componentConfigDef} from '@modeldir/model';
...
@Component({
  ...
  selector: 'app-scd-bar-graph-properties',
  templateUrl: './scd-bar-graph-properties.component.html',
  styleUrls: ['./scd-bar-graph-properties.component.scss'],
  standalone: false
})
export class ScdBarGraphPropertiesComponent implements OnInit {
  ...
  public routineName = "scd_bar_graph_properties";
  ...
  public compSelector = 'app-scd-bar-graph-properties';
 ...
 if ( key != '') { 
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("ComponentConfig:ScdBarGraphPropertiesComponent:",ComponentConfig);
