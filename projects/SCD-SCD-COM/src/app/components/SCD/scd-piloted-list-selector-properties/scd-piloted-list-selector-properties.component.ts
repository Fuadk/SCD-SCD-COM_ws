...
import {  scdshapeScdTpCommonScreen  ,scdlistIndicatorGeneralScdLigListIndicatorGeneral  ,scdalarmScdListIndicatorStatesProperties  ,scdshapeConnectionScdScShapeConnections  , componentConfigDef} from '@modeldir/model';
...
@Component({
  ...
  selector: 'app-scd-piloted-list-selector-properties',
  templateUrl: './scd-piloted-list-selector-properties.component.html',
  styleUrls: ['./scd-piloted-list-selector-properties.component.scss'],
  standalone: false
})
export class ScdPilotedListSelectorPropertiesComponent implements OnInit {
  ...
  constructor(public router: Router,public responsive: BreakpointObserver, private starNotify: StarNotifyService, public starServices: starServices, public starlib1: Starlib1) {
   this.router = router;
  this.title =  this.starServices.getNLS([],"scd_piloted_list_selector_properties.scd_piloted_list_selector_properties.component_title","");
  ...
  public routineName = "scd_piloted_list_selector_properties";
  ...
  public routineAuth = "ScdPilotedListSelectorProperties";

  public ngAfterViewInit() {
    this.starServices.setRTL();
  }
  private componentConfigChangeEvent!: Subscription;
  public compSelector = 'app-scd-piloted-list-selector-properties';
  ...
  async initComponents(){
   ...
   this.SCD_SHAPEForm_0Config.title = this.starServices.getNLS([],"scd_piloted_list_selector_properties.scd_piloted_list_selector_properties.compsTitleID1","Common");
   ...
   this.SCD_LIST_INDICATOR_GENERALFormdivs_1Config.title = this.starServices.getNLS([],"scd_piloted_list_selector_properties.scd_piloted_list_selector_properties.compsTitleID2","General");
   this.SCD_LIST_INDICATOR_GENERALFormdivs_1Config.isChild = true;
   this.SCD_LIST_INDICATOR_GENERALFormdivs_1Config.masterSelector = 'app-scd-piloted-list-selector-properties';
   if (typeof this['steps']  !== 'undefined') {
   ...
   this.SCD_ALARMFormtabs_2Config.title = this.starServices.getNLS([],"scd_piloted_list_selector_properties.scd_piloted_list_selector_properties.compsTitleID3","States");
   this.SCD_ALARMFormtabs_2Config.isChild = true;
   this.SCD_ALARMFormtabs_2Config.masterSelector = 'app-scd-piloted-list-selector-properties';
   if (typeof this['steps']  !== 'undefined') {
   ...
   this.SCD_SHAPE_CONNECTIONGrid_3Config.title = this.starServices.getNLS([],"scd_piloted_list_selector_properties.scd_piloted_list_selector_properties.compsTitleID4","Connections");
   this.SCD_SHAPE_CONNECTIONGrid_3Config.isChild = true;
   this.SCD_SHAPE_CONNECTIONGrid_3Config.masterSelector = 'app-scd-piloted-list-selector-properties';
   if (typeof this['steps']  !== 'undefined') {
 ...
 if ( key != '') { 
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("ComponentConfig:ScdPilotedListSelectorPropertiesComponent:",ComponentConfig);
