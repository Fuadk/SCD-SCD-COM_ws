...
import {   scdshapeConnectionScdScShapeConnections , componentConfigDef } from '@modeldir/model';
...
'SHAPE_CONNECTION_ID' : new FormControl(dataItem.SHAPE_CONNECTION_ID  , ) ,
'SHAPE_ID' : new FormControl(dataItem.SHAPE_ID  ,   Validators.required ) ,
'CONNECTION_ID' : new FormControl(dataItem.CONNECTION_ID  , ) ,
'CONNECTION_NAME' : new FormControl(dataItem.CONNECTION_NAME  , ) ,
'CONNECTION_ICON' : new FormControl(dataItem.CONNECTION_ICON  , ) ,
'CONNECTION_TAG_EXPRESSION' : new FormControl(dataItem.CONNECTION_TAG_EXPRESSION  , ) 
});
...
@Component({
  selector: 'app-scd-sc-shape-connections',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-sc-shape-connections.component.html',
  standalone: false,
  styleUrls: ['./scd-sc-shape-connections.component.scss'
],
...
export class ScdShapeConnectionScdScShapeConnectionsGridComponent implements OnInit,OnDestroy {
 ...
 public showToolBar = true;
  ...
  public isMaster: boolean = false;
  		...
  		public  isSHAPE_CONNECTION_IDEnable : boolean = true; 
public  isSHAPE_IDEnable : boolean = true; 
  ...
  private insertCMD = "INSERT_SCD_SHAPE_CONNECTION";
  private updateCMD = "UPDATE_SCD_SHAPE_CONNECTION";
  private deleteCMD =   "DELETE_SCD_SHAPE_CONNECTION";
  private getCMD = "GET_SCD_SHAPE_CONNECTION_QUERY";

  public  executeQueryresult:any;
  public title =  this.starServices.getNLS([],"SCD_SC_SHAPE_CONNECTIONS.scdshapeConnectionScdScShapeConnections.component_title","Shape Connections");
  public PDFfileName = this.title + ".PDF";
  public ExcelfileName = this.title + ".xlsx";
  public componentConfig: componentConfigDef;
  public componentConfig_output: componentConfigDef;
  public compTitleMsg =  "SCD_SC_SHAPE_CONNECTIONS.scdshapeConnectionScdScShapeConnections";
  ...
  public primarKeyReadOnlyArr = {isSHAPE_CONNECTION_IDreadOnly : false , isSHAPE_IDreadOnly : false};  
  public paramConfig;
...
public visibleSHAPE_CONNECTION_ID = false;
public visibleSHAPE_ID = false;
public visibleCONNECTION_ID = false;
public visibleCONNECTION_NAME = true;
public visibleCONNECTION_ICON = true;
public visibleCONNECTION_TAG_EXPRESSION = true;
public visibleTAG_CONNECTION = true;
public visibleEXPRESSION_CONNECTION = true;

public compSelector = 'app-scd-sc-shape-connections';
  ...
  @Output() setComponentConfig_Output: EventEmitter<any> = new EventEmitter();
    ...
    constructor(public router: Router,public intl: IntlService, public responsive: BreakpointObserver, private starNotify: StarNotifyService,   public starServices: starServices, private renderer: Renderer2) {
      ...
      this.title = this.componentConfig.title ? this.componentConfig.title :this.starServices.getNLS([],"SCD_SC_SHAPE_CONNECTIONS.scdshapeConnectionScdScShapeConnections.component_title","Shape Connections");
  }
...
//Next part for filtering
  ...
  private gridInitialValues:any = new scdshapeConnectionScdScShapeConnections();   
  ...
  public commonCallStarNotify(data:any) {
    ...
    let masterParams = {
      data: this.masterKeyArr
       ...
       let masterKeyArr = [data['SHAPE_ID'],data['SHAPE_CONNECTION_ID']];
      let masterKeyNameArr = ['SHAPE_ID','SHAPE_CONNECTION_ID'];
      //for (let i = 0; i < masterKeyNameArr.length; i++) {
      //  componentConfig.[masterKeyNameArr[i]] = masterKeyArr[i];
      //}
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ScdShapeConnectionScdScShapeConnectionsGrid ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_SHAPE_CONNECTION_ID(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['SHAPE_CONNECTION_ID'] != "undefined" ) 
      this.formGroup.controls['SHAPE_CONNECTION_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['SHAPE_CONNECTION_ID'] != "undefined" ) 
     this.formGroup.get('SHAPE_CONNECTION_ID').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_SHAPE_CONNECTION_ID(event){
...
async WHEN_VALIDATE_ITEM_CONNECTION_ID(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['CONNECTION_ID'] != "undefined" ) 
      this.formGroup.controls['CONNECTION_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['CONNECTION_ID'] != "undefined" ) 
     this.formGroup.get('CONNECTION_ID').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_CONNECTION_ID(event){

}

async WHEN_VALIDATE_ITEM_CONNECTION_NAME(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['CONNECTION_NAME'] != "undefined" ) 
      this.formGroup.controls['CONNECTION_NAME'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['CONNECTION_NAME'] != "undefined" ) 
     this.formGroup.get('CONNECTION_NAME').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_CONNECTION_NAME(event){

}

async WHEN_VALIDATE_ITEM_CONNECTION_ICON(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['CONNECTION_ICON'] != "undefined" ) 
      this.formGroup.controls['CONNECTION_ICON'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['CONNECTION_ICON'] != "undefined" ) 
     this.formGroup.get('CONNECTION_ICON').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_CONNECTION_ICON(event){

}

async WHEN_VALIDATE_ITEM_CONNECTION_TAG_EXPRESSION(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['CONNECTION_TAG_EXPRESSION'] != "undefined" ) 
      this.formGroup.controls['CONNECTION_TAG_EXPRESSION'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['CONNECTION_TAG_EXPRESSION'] != "undefined" ) 
     this.formGroup.get('CONNECTION_TAG_EXPRESSION').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_CONNECTION_TAG_EXPRESSION(event){

}

async WHEN_VALIDATE_ITEM_TAG_CONNECTION(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['TAG_CONNECTION'] != "undefined" ) 
      this.formGroup.controls['TAG_CONNECTION'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['TAG_CONNECTION'] != "undefined" ) 
     this.formGroup.get('TAG_CONNECTION').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_TAG_CONNECTION(event){

}

async WHEN_VALIDATE_ITEM_EXPRESSION_CONNECTION(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['EXPRESSION_CONNECTION'] != "undefined" ) 
      this.formGroup.controls['EXPRESSION_CONNECTION'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['EXPRESSION_CONNECTION'] != "undefined" ) 
     this.formGroup.get('EXPRESSION_CONNECTION').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_EXPRESSION_CONNECTION(event){

}
 
 async onBlur_SHAPE_CONNECTION_ID() { 
  await this.WHEN_VALIDATE_ITEM_SHAPE_CONNECTION_ID(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 ...
 async onBlur_CONNECTION_ID() { 
  await this.WHEN_VALIDATE_ITEM_CONNECTION_ID(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_CONNECTION_NAME() { 
  await this.WHEN_VALIDATE_ITEM_CONNECTION_NAME(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async valueChangeCONNECTION_ICON(value: any) { 
 await this.WHEN_VALIDATE_ITEM_CONNECTION_ICON(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_CONNECTION_TAG_EXPRESSION() { 
  await this.WHEN_VALIDATE_ITEM_CONNECTION_TAG_EXPRESSION(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async valueChangeTAG_CONNECTION(value: any) { 
 await this.WHEN_VALIDATE_ITEM_TAG_CONNECTION(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async valueChangeEXPRESSION_CONNECTION(value: any) { 
 await this.WHEN_VALIDATE_ITEM_EXPRESSION_CONNECTION(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 }
