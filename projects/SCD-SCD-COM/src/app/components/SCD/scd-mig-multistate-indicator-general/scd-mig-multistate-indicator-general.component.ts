...
import { scdmultistateIndicatorGeneralScdMigMultistateIndicatorGeneral , componentConfigDef} from '@modeldir/model';


 const createFormGroup = (dataItem:any) => new FormGroup({
'MULTISTATE_INDICATOR_GENERAL_ID' : new FormControl(dataItem.MULTISTATE_INDICATOR_GENERAL_ID  , ) ,
...
@Component({
  selector: 'app-scd-mig-multistate-indicator-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-mig-multistate-indicator-general.component.html',
  styleUrls: ['./scd-mig-multistate-indicator-general.component.scss'],
  standalone: false
})


export class ScdMultistateIndicatorGeneralScdMigMultistateIndicatorGeneralFormComponent {
  public title =  this.starServices.getNLS([],"SCD_MIG_MULTISTATE_INDICATOR_GENERAL.scdmultistateIndicatorGeneralScdMigMultistateIndicatorGeneral.component_title","Multistate Indicator General");
  public compTitleMsg =  "SCD_MIG_MULTISTATE_INDICATOR_GENERAL.scdmultistateIndicatorGeneralScdMigMultistateIndicatorGeneral";
  public routineName = "ScdMultistateIndicatorGeneralScdMigMultistateIndicatorGeneralForm";
  private insertCMD = "INSERT_SCD_MULTISTATE_INDICATOR_GENERAL";
  private updateCMD = "UPDATE_SCD_MULTISTATE_INDICATOR_GENERAL";
  private deleteCMD =   "DELETE_SCD_MULTISTATE_INDICATOR_GENERAL";
  private getCMD = "GET_SCD_MULTISTATE_INDICATOR_GENERAL_QUERY";
  ...
  public primarKeyReadOnlyArr = {isMULTISTATE_INDICATOR_GENERAL_IDreadOnly : false , isSHAPE_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-mig-multistate-indicator-general';
  public PK_AUTO = 'MULTISTATE_INDICATOR_GENERAL_ID';
  public customerFacing = false;
  public FormStepsArr = [] ;
public labelMULTISTATE_INDICATOR_GENERAL_IDTop=false;
public labelMULTISTATE_INDICATOR_GENERAL_IDVisible=true;
...
public visibleMULTISTATE_INDICATOR_GENERAL_ID = false;
...
public disableMULTISTATE_INDICATOR_GENERAL_ID = false;
...
public disableTRIGGER_TYPE = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdmultistateIndicatorGeneralScdMigMultistateIndicatorGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdMultistateIndicatorGeneralScdMigMultistateIndicatorGeneralForm form.SHAPE_ID :' + form.SHAPE_ID);
  ...
  async  enterQuery (form : any){
    ...
    async callBackPost_Insert(NewVal:any) {
      ...
      this.Comp_Config.masterKeyArr =  [NewVal['MULTISTATE_INDICATOR_GENERAL_ID']];
      this.Comp_Config.masterKeyNameArr =  ["MULTISTATE_INDICATOR_GENERAL_ID"];
...
onChanges(): void {
this.form.get('MULTISTATE_INDICATOR_GENERAL_ID').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdMultistateIndicatorGeneralScdMigMultistateIndicatorGeneralForm ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_MULTISTATE_INDICATOR_GENERAL_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['MULTISTATE_INDICATOR_GENERAL_ID'] != "undefined" ) 
      this.form.controls['MULTISTATE_INDICATOR_GENERAL_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['MULTISTATE_INDICATOR_GENERAL_ID'] != "undefined" ) 
     this.form.get('MULTISTATE_INDICATOR_GENERAL_ID').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_MULTISTATE_INDICATOR_GENERAL_ID(event){
...
async WHEN_VALIDATE_ITEM_TRIGGER_TYPE(value) {
 ...
 async onChange_MULTISTATE_INDICATOR_GENERAL_ID(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_MULTISTATE_INDICATOR_GENERAL_ID(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
