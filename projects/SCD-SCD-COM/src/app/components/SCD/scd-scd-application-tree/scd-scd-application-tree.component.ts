...
@Component({
  selector: 'app-scd-scd-application-tree',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-scd-application-tree.component.html',
  styleUrls: ['./scd-scd-application-tree.component.scss'],
  standalone: false
})
...
export class ScdApplicationScdScdApplicationTreeTreeComponent {
  ...
  public compSelector = 'app-scd-scd-application-tree';
...
public disableAPP_LANGUAGE = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdapplicationScdScdApplicationTree();   
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdApplicationScdScdApplicationTreeTree ComponentConfig:", {...ComponentConfig});
...
public mapperFrom = {"Id":"APPLICATION_ID","Menu":"DESCRIPTION","Item":"APPLICATION_NAME"};
