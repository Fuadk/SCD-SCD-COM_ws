...
import { scdarrowButtonGeneralScdAbgArrowButtonGeneral , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-abg-arrow-button-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-abg-arrow-button-general.component.html',
  styleUrls: ['./scd-abg-arrow-button-general.component.scss'],
  standalone: false
})


export class ScdArrowButtonGeneralScdAbgArrowButtonGeneralFormdivsComponent {
  public title =  this.starServices.getNLS([],"SCD_ABG_ARROW_BUTTON_GENERAL.scdarrowButtonGeneralScdAbgArrowButtonGeneral.component_title","Arrow Button General");
  public compTitleMsg =  "SCD_ABG_ARROW_BUTTON_GENERAL.scdarrowButtonGeneralScdAbgArrowButtonGeneral";
  public routineName = "ScdArrowButtonGeneralScdAbgArrowButtonGeneralFormdivs";
  ...
  public compSelector = 'app-scd-abg-arrow-button-general';
  public PK_AUTO = 'ARROW_BUTTON_GENERAL_ID';
  public customerFacing = false;
  public FormStepsArr = [{"CODE":"","CODETEXT_LANG":"","visible":true},{"CODE":"1","CODETEXT_LANG":"Appearance","visible":true},{"CODE":"2","CODETEXT_LANG":"Touch Margins","visible":true},{"CODE":"3","CODETEXT_LANG":"Other","visible":true}] ;
public labelARROW_BUTTON_GENERAL_IDTop=true;
...
public labelHORIZONTAL_MARGINTop=true;
public labelHORIZONTAL_MARGINVisible=true;
public labelVERTICAL_MARGINTop=true;
public labelVERTICAL_MARGINVisible=true;
public labelAUDIOTop=true;
public labelAUDIOVisible=true;
public labelSEND_PRESS_TOTop=true;
public labelSEND_PRESS_TOVisible=true;
public labelOBJECT_BROWSERTop=true;
public labelOBJECT_BROWSERVisible=true;
...
public visibleSEND_PRESS_TO = true;
public visibleOBJECT_BROWSER = false;
...
public disableOBJECT_BROWSER = false;
public disableLINKED_OBJECT = false;

public variableOBJECT_BROWSER;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdarrowButtonGeneralScdAbgArrowButtonGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdArrowButtonGeneralScdAbgArrowButtonGeneralFormdivs form.SHAPE_ID :' + form.SHAPE_ID);
...
this.lookupArrDef =[	{"statment":"SELECT SHAPE_ID CODE, NAME CODETEXT_LANG  FROM SCD_SHAPE  order by CODETEXT_LANG ",
	...
	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"SEND_PRESS_TO\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
			"lkpArrName":"lkpArrSEND_PRESS_TO"}];
...
public lkpArrGetSEND_PRESS_TO(CODE: any): any {
var rec = this.lkpArrSEND_PRESS_TO.find((x:any) => x.CODE === CODE);
return rec;
}
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdArrowButtonGeneralScdAbgArrowButtonGeneralFormdivs ComponentConfig:", {...ComponentConfig});
  ...
  async WHEN_NOTIFY(ComponentConfig){
    ...
    if (masterSelector.includes("enter")){
        this.generalMode = "ENTER";
         //alert(this.generalMode);
    }
       
    switch (this.generalMode) {
        case 'ENTER':
            this.visibleLINKED_OBJECT = true
            this.visibleOBJECT_BROWSER = true;
            //alert(this.generalMode);
            break;
        default:
            break;
...
async WHEN_VALIDATE_ITEM_OBJECT_BROWSER(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['OBJECT_BROWSER'] != "undefined" ) 
      this.form.controls['OBJECT_BROWSER'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['OBJECT_BROWSER'] != "undefined" ) 
     this.form.get('OBJECT_BROWSER').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_OBJECT_BROWSER(event){
...
async WHEN_VALIDATE_ITEM_LINKED_OBJECT(value) {
 ...
 async onValueChange_SEND_PRESS_TO(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 await this.WHEN_VALIDATE_ITEM_SEND_PRESS_TO(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
  
  } 
 async onValueChange_OBJECT_BROWSER(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 await this.WHEN_VALIDATE_ITEM_OBJECT_BROWSER(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
