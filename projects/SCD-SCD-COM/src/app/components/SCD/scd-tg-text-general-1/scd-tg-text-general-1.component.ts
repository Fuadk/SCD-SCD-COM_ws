...
import { scdtextGeneralScdTgTextGeneral1 , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-tg-text-general-1',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-tg-text-general-1.component.html',
  styleUrls: ['./scd-tg-text-general-1.component.scss'],
  standalone: false
})


export class ScdTextGeneralScdTgTextGeneral1FormComponent {
  public title =  this.starServices.getNLS([],"SCD_TG_TEXT_GENERAL_1.scdtextGeneralScdTgTextGeneral1.component_title","Text General");
  public compTitleMsg =  "SCD_TG_TEXT_GENERAL_1.scdtextGeneralScdTgTextGeneral1";
  public routineName = "ScdTextGeneralScdTgTextGeneral1Form";
  ...
  public compSelector = 'app-scd-tg-text-general-1';
...
public visibleSIZE_TO_FIT = false;
...
public disableBACK_STYLE = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdtextGeneralScdTgTextGeneral1();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdTextGeneralScdTgTextGeneral1Form form.SHAPE_ID :' + form.SHAPE_ID);
...
this.form.get('SIZE_TO_FIT').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdTextGeneralScdTgTextGeneral1Form ComponentConfig:", {...ComponentConfig});
