...
import {   scddisplayKeyScdDksKeysList , componentConfigDef } from '@modeldir/model';
...
@Component({
  selector: 'app-scd-dks-keys-list',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-dks-keys-list.component.html',
  standalone: false,
  styleUrls: ['./scd-dks-keys-list.component.scss'
],
...
export class ScdDisplayKeyScdDksKeysListGridComponent implements OnInit,OnDestroy {
 ...
 public showToolBar = true;
  ...
  public isMaster: boolean = false;
  	...
  	public  isDISPLAY_KEY_IDEnable : boolean = true; 
  ...
  public title =  this.starServices.getNLS([],"SCD_DKS_KEYS_LIST.scddisplayKeyScdDksKeysList.component_title","Keys List");
  public PDFfileName = this.title + ".PDF";
  public ExcelfileName = this.title + ".xlsx";
  public componentConfig
  public compTitleMsg =  "SCD_DKS_KEYS_LIST.scddisplayKeyScdDksKeysList";
  ...
  public primarKeyReadOnlyArr = {isDISPLAY_KEY_IDreadOnly : false};  
  public paramConfig;
...
public visiblePRESS_ACTION = false;
public visibleREPEAT_ACTION = false;
public visibleRELEASE_ACTION = false;

public compSelector = 'app-scd-dks-keys-list';
  ...
  @Output() formValidationChangedOutput: EventEmitter<boolean> = new EventEmitter();
    ...
    constructor(public router: Router,public intl: IntlService, public responsive: BreakpointObserver, private starNotify: StarNotifyService,   public starServices: starServices, private renderer: Renderer2) {
      ...
      this.title = this.componentConfig.title ? this.componentConfig.title :this.starServices.getNLS([],"SCD_DKS_KEYS_LIST.scddisplayKeyScdDksKeysList.component_title","Keys List");
  }
...
//Next part for filtering
  ...
  private gridInitialValues:any = new scddisplayKeyScdDksKeysList();   
  ...
  public commonCallStarNotify(data:any) {
    ...
    let masterParams = {
      data: this.masterKeyArr
       ...
       let masterKeyArr = [data['DISPLAY_KEY_ID']];
      let masterKeyNameArr = ['DISPLAY_KEY_ID'];
      //for (let i = 0; i < masterKeyNameArr.length; i++) {
      //  componentConfig.[masterKeyNameArr[i]] = masterKeyArr[i];
      //}
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ScdDisplayKeyScdDksKeysListGrid ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_DISPLAY_KEY_ID(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['DISPLAY_KEY_ID'] != "undefined" ) 
      this.formGroup.controls['DISPLAY_KEY_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['DISPLAY_KEY_ID'] != "undefined" ) 
     this.formGroup.get('DISPLAY_KEY_ID').updateValueAndValidity();
...
async WHEN_VALIDATE_ITEM_KEY_LABEL(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['KEY_LABEL'] != "undefined" ) 
      this.formGroup.controls['KEY_LABEL'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['KEY_LABEL'] != "undefined" ) 
     this.formGroup.get('KEY_LABEL').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_PRESS_ACTION(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['PRESS_ACTION'] != "undefined" ) 
      this.formGroup.controls['PRESS_ACTION'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['PRESS_ACTION'] != "undefined" ) 
     this.formGroup.get('PRESS_ACTION').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_REPEAT_ACTION(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['REPEAT_ACTION'] != "undefined" ) 
      this.formGroup.controls['REPEAT_ACTION'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['REPEAT_ACTION'] != "undefined" ) 
     this.formGroup.get('REPEAT_ACTION').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_RELEASE_ACTION(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['RELEASE_ACTION'] != "undefined" ) 
      this.formGroup.controls['RELEASE_ACTION'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['RELEASE_ACTION'] != "undefined" ) 
     this.formGroup.get('RELEASE_ACTION').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
 ...
 async onBlur_DISPLAY_KEY_ID() { 
  await this.WHEN_VALIDATE_ITEM_DISPLAY_KEY_ID(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 ...
 async onBlur_KEY_LABEL() { 
  await this.WHEN_VALIDATE_ITEM_KEY_LABEL(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_PRESS_ACTION() { 
  await this.WHEN_VALIDATE_ITEM_PRESS_ACTION(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_REPEAT_ACTION() { 
  await this.WHEN_VALIDATE_ITEM_REPEAT_ACTION(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_RELEASE_ACTION() { 
  await this.WHEN_VALIDATE_ITEM_RELEASE_ACTION(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 }
