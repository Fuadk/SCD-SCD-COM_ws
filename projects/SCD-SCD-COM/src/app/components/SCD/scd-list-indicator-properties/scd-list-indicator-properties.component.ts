...
@Component({
  ...
  selector: 'app-scd-list-indicator-properties',
  templateUrl: './scd-list-indicator-properties.component.html',
  styleUrls: ['./scd-list-indicator-properties.component.scss'],
  standalone: false
})
export class ScdListIndicatorPropertiesComponent implements OnInit {
  ...
  constructor(public router: Router,public responsive: BreakpointObserver, private starNotify: StarNotifyService, public starServices: starServices, public starlib1: Starlib1) {
   this.router = router;
  this.title =  this.starServices.getNLS([],"scd_list_indicator_properties.scd_list_indicator_properties.component_title","");
  ...
  public routineName = "scd_list_indicator_properties";
  ...
  public routineAuth = "ScdListIndicatorProperties";

  public ngAfterViewInit() {
    this.starServices.setRTL();
  }
  private componentConfigChangeEvent!: Subscription;
  public compSelector = 'app-scd-list-indicator-properties';
  ...
  async initComponents(){
   ...
   this.SCD_SHAPEForm_0Config.title = this.starServices.getNLS([],"scd_list_indicator_properties.scd_list_indicator_properties.compsTitleID1","Common");
   ...
   this.SCD_LIST_INDICATOR_GENERALFormdivs_1Config.title = this.starServices.getNLS([],"scd_list_indicator_properties.scd_list_indicator_properties.compsTitleID2","General");
   this.SCD_LIST_INDICATOR_GENERALFormdivs_1Config.isChild = true;
   this.SCD_LIST_INDICATOR_GENERALFormdivs_1Config.masterSelector = 'app-scd-list-indicator-properties';
   if (typeof this['steps']  !== 'undefined') {
   ...
   this.SCD_ALARMFormtabs_2Config.title = this.starServices.getNLS([],"scd_list_indicator_properties.scd_list_indicator_properties.compsTitleID3","States");
   this.SCD_ALARMFormtabs_2Config.isChild = true;
   this.SCD_ALARMFormtabs_2Config.masterSelector = 'app-scd-list-indicator-properties';
   if (typeof this['steps']  !== 'undefined') {
   ...
   this.SCD_SHAPE_CONNECTIONGrid_3Config.title = this.starServices.getNLS([],"scd_list_indicator_properties.scd_list_indicator_properties.compsTitleID4","Connections");
   this.SCD_SHAPE_CONNECTIONGrid_3Config.isChild = true;
   this.SCD_SHAPE_CONNECTIONGrid_3Config.masterSelector = 'app-scd-list-indicator-properties';
   if (typeof this['steps']  !== 'undefined') {
 ...
 if ( key != '') { 
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("ComponentConfig:ScdListIndicatorPropertiesComponent:",ComponentConfig);
