...
import { scdalarmScdAaAlarmFilter , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-aa-alarm-filter',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-aa-alarm-filter.component.html',
  styleUrls: ['./scd-aa-alarm-filter.component.scss'],
  standalone: false
})


export class ScdAlarmScdAaAlarmFilterFormComponent {
  public title =  this.starServices.getNLS([],"SCD_AA_ALARM_FILTER.scdalarmScdAaAlarmFilter.component_title","Alarm Filter");
  public compTitleMsg =  "SCD_AA_ALARM_FILTER.scdalarmScdAaAlarmFilter";
  public routineName = "ScdAlarmScdAaAlarmFilterForm";
  ...
  public compSelector = 'app-scd-aa-alarm-filter';
...
public disableINPUT_TAG = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdalarmScdAaAlarmFilter();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdAlarmScdAaAlarmFilterForm form.APPLICATION_ID :' + form.APPLICATION_ID);
...
this.lookupArrDef =[	{"statment":"SELECT APPLICATION_ID CODE, APPLICATION_NAME CODETEXT_LANG  FROM SCD_APPLICATION  order by CODETEXT_LANG ",
	...
	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"TYPE\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
...
public lkpArrGetTYPE(CODE: any): any {
var rec = this.lkpArrTYPE.find((x:any) => x.CODE === CODE);
return rec;
}
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdAlarmScdAaAlarmFilterForm ComponentConfig:", {...ComponentConfig});
