...
import {  scdshapeScdTpCommonScreen  ,scdtagLabelGeneralScdTlgTagLabelGeneral  , componentConfigDef} from '@modeldir/model';
...
@Component({
  ...
  selector: 'app-scd-tag-label-properties',
  templateUrl: './scd-tag-label-properties.component.html',
  styleUrls: ['./scd-tag-label-properties.component.scss'],
  standalone: false
})
export class ScdTagLabelPropertiesComponent implements OnInit {
  ...
  constructor(public router: Router,public responsive: BreakpointObserver, private starNotify: StarNotifyService, public starServices: starServices, public starlib1: Starlib1) {
   this.router = router;
  this.title =  this.starServices.getNLS([],"scd_tag_label_properties.scd_tag_label_properties.component_title","");
  ...
  public routineName = "scd_tag_label_properties";
  ...
  public formdivs_1_SCD_TAG_LABEL_GENERAL : scdtagLabelGeneralScdTlgTagLabelGeneral;
  public  SCD_SHAPEForm_0Config : componentConfigDef;
  public  hide_comp_1 = false
  public  SCD_TAG_LABEL_GENERALFormdivs_1Config : componentConfigDef;
  public  hide_comp_2 = false
  public PDFfileName = this.title + ".PDF";
  public routineAuth = "ScdTagLabelProperties";

  public ngAfterViewInit() {
    this.starServices.setRTL();
  }
  private componentConfigChangeEvent!: Subscription;
  public compSelector = 'app-scd-tag-label-properties';
  ...
  async initComponents(){
   ...
   this.SCD_SHAPEForm_0Config.title = this.starServices.getNLS([],"scd_tag_label_properties.scd_tag_label_properties.compsTitleID1","Common");
   ...
   this.SCD_TAG_LABEL_GENERALFormdivs_1Config = new componentConfigDef();
   this.SCD_TAG_LABEL_GENERALFormdivs_1Config.title = this.starServices.getNLS([],"scd_tag_label_properties.scd_tag_label_properties.compsTitleID2","General");
   this.SCD_TAG_LABEL_GENERALFormdivs_1Config.isChild = true;
   this.SCD_TAG_LABEL_GENERALFormdivs_1Config.masterSelector = 'app-scd-tag-label-properties';
   this.SCD_TAG_LABEL_GENERALFormdivs_1Config.showToolBar = !this.visibleOK_BTNS; 
   if (typeof this['steps']  !== 'undefined') {
     this.SCD_TAG_LABEL_GENERALFormdivs_1Config.navigable = false;
     //this.SCD_TAG_LABEL_GENERALFormdivs_1Config.insertable = true;
     //this.SCD_TAG_LABEL_GENERALFormdivs_1Config.removeable = true;
   }
  }
  ...
  public readCompletedHandler( form_SCD_SHAPE) {
    ...
    let masterKeyNameArr = ["SHAPE_ID","DISPLAY_ID"];
     if (this.isSearchScreen == true) 
	  {
    	this.SCD_TAG_LABEL_GENERALFormdivs_1Config = new componentConfigDef();
    	this.SCD_TAG_LABEL_GENERALFormdivs_1Config.formattedWhere  = form_SCD_SHAPE;
    	return;
	  }
    //this.formdivs_1_SCD_TAG_LABEL_GENERAL = new scdtagLabelGeneralScdTlgTagLabelGeneral();
    //for (let i = 0; i< masterKeyNameArr.length; i++){
    //   this.formdivs_1_SCD_TAG_LABEL_GENERAL[masterKeyNameArr[i]] = masterKeyArr[i];
    //}
    this.SCD_TAG_LABEL_GENERALFormdivs_1Config = new componentConfigDef();
    this.SCD_TAG_LABEL_GENERALFormdivs_1Config.masterKeyArr =  [form_SCD_SHAPE.SHAPE_ID,form_SCD_SHAPE.DISPLAY_ID];
    this.SCD_TAG_LABEL_GENERALFormdivs_1Config.masterKeyNameArr =  ["SHAPE_ID","DISPLAY_ID"];
    this.SCD_TAG_LABEL_GENERALFormdivs_1Config.masterReadCompleted = true;
   if (typeof this['steps'] !== 'undefined') {
     this.SCD_TAG_LABEL_GENERALFormdivs_1Config.queryable = false;
     //this.SCD_TAG_LABEL_GENERALFormdivs_1Config.removeable = true;
     //this.SCD_TAG_LABEL_GENERALFormdivs_1Config.updateable = true;
   }
  }
  ...
  public sendToChildren(componentConfig, pageNo){ 
   if ( (pageNo + 1) == 2){
  	this.SCD_TAG_LABEL_GENERALFormdivs_1Config = new componentConfigDef(); 
  	this.SCD_TAG_LABEL_GENERALFormdivs_1Config = componentConfig; 
   }
 } 
 ...
 if ( key != '') { 
    this.SCD_TAG_LABEL_GENERALFormdivs_1Config = new componentConfigDef();
    this.SCD_TAG_LABEL_GENERALFormdivs_1Config.masterSaved = form_SCD_SHAPE;
    this.SCD_TAG_LABEL_GENERALFormdivs_1Config.masterKeyArr =  [form_SCD_SHAPE.SHAPE_ID,form_SCD_SHAPE.DISPLAY_ID];
    this.SCD_TAG_LABEL_GENERALFormdivs_1Config.masterKeyNameArr =  ["SHAPE_ID","DISPLAY_ID"];
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("ComponentConfig:ScdTagLabelPropertiesComponent:",ComponentConfig);
    if (typeof ComponentConfig !== "undefined"){
       ...
       if (ComponentConfig.languageChanged != null) { 
           setTimeout(() => {
             ...
             this.SCD_SHAPEForm_0Config.title = this.starServices.getNLS([],"scd_tag_label_properties.scd_tag_label_properties.compsTitleID1","Common");
             this.SCD_TAG_LABEL_GENERALFormdivs_1Config = new componentConfigDef();
             this.SCD_TAG_LABEL_GENERALFormdivs_1Config.languageChanged = ComponentConfig.languageChanged;
             this.SCD_TAG_LABEL_GENERALFormdivs_1Config.title = this.starServices.getNLS([],"scd_tag_label_properties.scd_tag_label_properties.compsTitleID2","General");
           this.setSteps(this);
           }, 500);
       }
       ...
       if (ComponentConfig.masterParams != null) {
              ...
              this.SCD_TAG_LABEL_GENERALFormdivs_1Config.masterParams = ComponentConfig.masterParams;
   		
       }
       if (ComponentConfig.showToolBar != null) {
              this.SCD_SHAPEForm_0Config.showToolBar = ComponentConfig.showToolBar;
              this.SCD_TAG_LABEL_GENERALFormdivs_1Config.showToolBar = ComponentConfig.showToolBar;
       }
      ...
      if (ComponentConfig.newRec != null)
      {
       ...
       this.SCD_TAG_LABEL_GENERALFormdivs_1Config.newRec = ComponentConfig.newRec;
      }
      if (ComponentConfig.clearScreen != null)
      {
       this.SCD_SHAPEForm_0Config.clearScreen = ComponentConfig.clearScreen;
       this.SCD_TAG_LABEL_GENERALFormdivs_1Config.clearScreen = ComponentConfig.clearScreen;
	   }
      if ((ComponentConfig.masterKeyArr != null) && (ComponentConfig.masterKeyNameArr != null) )
      {
       if ((ComponentConfig.masterKeyArr.length != 0) && (ComponentConfig.masterKeyNameArr.length != 0) )
       {
         ...
         this.SCD_TAG_LABEL_GENERALFormdivs_1Config.masterKeyArr = ComponentConfig.masterKeyArr;
         this.SCD_TAG_LABEL_GENERALFormdivs_1Config.masterKeyNameArr = ComponentConfig.masterKeyNameArr;
         if (ComponentConfig.masterReadCompleted != null) 
         {
             this.SCD_TAG_LABEL_GENERALFormdivs_1Config.masterReadCompleted = ComponentConfig.masterReadCompleted;
          }
       }
      }
    }
  }
   public formdivs_1_SCD_TAG_LABEL_GENERALOpened = false;
  public  formdivs_1_SCD_TAG_LABEL_GENERALClose() { 
    this.formdivs_1_SCD_TAG_LABEL_GENERALOpened = false;  
  }
  public  formdivs_1_SCD_TAG_LABEL_GENERALOpen() { 
    this.formdivs_1_SCD_TAG_LABEL_GENERALOpened = true;  
  }
