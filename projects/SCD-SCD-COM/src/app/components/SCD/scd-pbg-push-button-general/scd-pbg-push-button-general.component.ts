...
import { scdbuttonPushGeneralScdPbgPushButtonGeneral , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-pbg-push-button-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-pbg-push-button-general.component.html',
  styleUrls: ['./scd-pbg-push-button-general.component.scss'],
  standalone: false
})


export class ScdButtonPushGeneralScdPbgPushButtonGeneralFormdivsComponent {
  public title =  this.starServices.getNLS([],"SCD_PBG_PUSH_BUTTON_GENERAL.scdbuttonPushGeneralScdPbgPushButtonGeneral.component_title","Push Button General");
  public compTitleMsg =  "SCD_PBG_PUSH_BUTTON_GENERAL.scdbuttonPushGeneralScdPbgPushButtonGeneral";
  public routineName = "ScdButtonPushGeneralScdPbgPushButtonGeneralFormdivs";
  ...
  public compSelector = 'app-scd-pbg-push-button-general';
  public PK_AUTO = 'BUTTON_PUSH_GENERAL_ID';
  public customerFacing = false;
  public FormStepsArr = [{"CODE":"","CODETEXT_LANG":"","visible":true},{"CODE":"1","CODETEXT_LANG":"Button Appearance","visible":true},{"CODE":"2","CODETEXT_LANG":"Button Settings","visible":true},{"CODE":"3","CODETEXT_LANG":"State Settings","visible":true},{"CODE":"4","CODETEXT_LANG":"Touch Margins","visible":true},{"CODE":"5","CODETEXT_LANG":"Other","visible":true}] ;
...
public visibleBUTTON_ACTION = true;
public visibleHOLD_TIME = true;
public visibleUSE_VARIABLE_LOWER_UPPER_LIMIT = true;
public visibleUSE_VARIABLE_RAMP_VALUE = true;
public visibleRAMP_UP_DOWN = true;
public visibleUPPER_LIMIT = true;
public visibleRAMP_VALUE = true;
public visibleBUTTON_VALUE = true;
public visibleLATCH_RESET_TYPE = true;
public visibleNUMBER_OF_STATES = true;
public visibleNEXT_STATE_BASED_ON = true;
public visibleLOWER_LIMIT = true;
public visibleHORIZONTAL_MARGIN = true;
public visibleVERTICAL_MARGIN = true;
public visibleAUDIO = true;
...
public disableAUDIO = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdbuttonPushGeneralScdPbgPushButtonGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdButtonPushGeneralScdPbgPushButtonGeneralFormdivs form.SHAPE_ID :' + form.SHAPE_ID);
...
this.lookupArrDef =[	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"BORDER_STYLE\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
	...
	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"SHAPE_TYPE\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
			"lkpArrName":"lkpArrSHAPE_TYPE"},
	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"NAVIGATION_ACTION\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
			"lkpArrName":"lkpArrNAVIGATION_ACTION"},
	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"BUTTON_ACTION\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
			"lkpArrName":"lkpArrBUTTON_ACTION"},
	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"HOLD_TIME\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
			"lkpArrName":"lkpArrHOLD_TIME"},
	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"RAMP_UP_DOWN\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
...
public lkpArrSHAPE_TYPE = [];

public lkpArrNAVIGATION_ACTION = [];

public lkpArrBUTTON_ACTION = [];

public lkpArrHOLD_TIME = [];

public lkpArrRAMP_UP_DOWN = [];

public lkpArrLATCH_RESET_TYPE = [];

public lkpArrNUMBER_OF_STATES = [];

public lkpArrNEXT_STATE_BASED_ON = [];
...
public lkpArrGetSHAPE_TYPE(CODE: any): any {
var rec = this.lkpArrSHAPE_TYPE.find((x:any) => x.CODE === CODE);
return rec;
}

public lkpArrGetNAVIGATION_ACTION(CODE: any): any {
var rec = this.lkpArrNAVIGATION_ACTION.find((x:any) => x.CODE === CODE);
return rec;
}

public lkpArrGetBUTTON_ACTION(CODE: any): any {
var rec = this.lkpArrBUTTON_ACTION.find((x:any) => x.CODE === CODE);
return rec;
}

public lkpArrGetHOLD_TIME(CODE: any): any {
var rec = this.lkpArrHOLD_TIME.find((x:any) => x.CODE === CODE);
return rec;
}

public lkpArrGetRAMP_UP_DOWN(CODE: any): any {
var rec = this.lkpArrRAMP_UP_DOWN.find((x:any) => x.CODE === CODE);
return rec;
}

public lkpArrGetLATCH_RESET_TYPE(CODE: any): any {
var rec = this.lkpArrLATCH_RESET_TYPE.find((x:any) => x.CODE === CODE);
return rec;
}

public lkpArrGetNUMBER_OF_STATES(CODE: any): any {
var rec = this.lkpArrNUMBER_OF_STATES.find((x:any) => x.CODE === CODE);
return rec;
}

public lkpArrGetNEXT_STATE_BASED_ON(CODE: any): any {
var rec = this.lkpArrNEXT_STATE_BASED_ON.find((x:any) => x.CODE === CODE);
return rec;
}
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdButtonPushGeneralScdPbgPushButtonGeneralFormdivs ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_AUDIO(value) {
 ...
 async onValueChange_HOLD_TIME(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
