...
import { scdsymbolGeneralScdSgSymbolGeneral , componentConfigDef} from '@modeldir/model';


 const createFormGroup = (dataItem:any) => new FormGroup({
'SYMBOL_GENERAL_ID' : new FormControl(dataItem.SYMBOL_GENERAL_ID  , ) ,
...
@Component({
  selector: 'app-scd-sg-symbol-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-sg-symbol-general.component.html',
  styleUrls: ['./scd-sg-symbol-general.component.scss'],
  standalone: false
})


export class ScdSymbolGeneralScdSgSymbolGeneralFormdivsComponent {
  public title =  this.starServices.getNLS([],"SCD_SG_SYMBOL_GENERAL.scdsymbolGeneralScdSgSymbolGeneral.component_title","Symbol General");
  public compTitleMsg =  "SCD_SG_SYMBOL_GENERAL.scdsymbolGeneralScdSgSymbolGeneral";
  public routineName = "ScdSymbolGeneralScdSgSymbolGeneralFormdivs";
  private insertCMD = "INSERT_SCD_SYMBOL_GENERAL";
  private updateCMD = "UPDATE_SCD_SYMBOL_GENERAL";
  private deleteCMD =   "DELETE_SCD_SYMBOL_GENERAL";
  private getCMD = "GET_SCD_SYMBOL_GENERAL_QUERY";
  ...
  public primarKeyReadOnlyArr = {isSYMBOL_GENERAL_IDreadOnly : false , isSHAPE_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-sg-symbol-general';
  public PK_AUTO = 'SYMBOL_GENERAL_ID';
  public customerFacing = false;
  public FormStepsArr = [{"CODE":"","CODETEXT_LANG":"","visible":true},{"CODE":"1","CODETEXT_LANG":"Appearance","visible":true},{"CODE":"2","CODETEXT_LANG":"Symbol Settings","visible":true}] ;
public labelSYMBOL_GENERAL_IDTop=true;
public labelSYMBOL_GENERAL_IDVisible=true;
...
public labelNUMBER_OF_STATESTop=true;
public labelNUMBER_OF_STATESVisible=true;
public labelTRIGGER_TYPETop=true;
public labelTRIGGER_TYPEVisible=true;
public labelIMAGE_NAMETop=true;
public labelIMAGE_NAMEVisible=true;
public labelIMAGE_SELECT_SYMBOLTop=true;
public labelIMAGE_SELECT_SYMBOLVisible=true;

public visibleSYMBOL_GENERAL_ID = false;
...
public visibleTRIGGER_TYPE = true;
public visibleIMAGE_NAME = true;
public visibleIMAGE_SELECT_SYMBOL = true;

public disableSYMBOL_GENERAL_ID = false;
...
public disableIMAGE_SELECT_SYMBOL = false;

public variableIMAGE_SELECT_SYMBOL;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdsymbolGeneralScdSgSymbolGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdSymbolGeneralScdSgSymbolGeneralFormdivs form.SHAPE_ID :' + form.SHAPE_ID);
  ...
  async  enterQuery (form : any){
    ...
    async callBackPost_Insert(NewVal:any) {
      ...
      this.Comp_Config.masterKeyArr =  [NewVal['SYMBOL_GENERAL_ID']];
      this.Comp_Config.masterKeyNameArr =  ["SYMBOL_GENERAL_ID"];
...
public lkpArrGetTRIGGER_TYPE(CODE: any): any {
var rec = this.lkpArrTRIGGER_TYPE.find((x:any) => x.CODE === CODE);
return rec;
}

onChanges(): void {
this.form.get('SYMBOL_GENERAL_ID').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdSymbolGeneralScdSgSymbolGeneralFormdivs ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_SYMBOL_GENERAL_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['SYMBOL_GENERAL_ID'] != "undefined" ) 
      this.form.controls['SYMBOL_GENERAL_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['SYMBOL_GENERAL_ID'] != "undefined" ) 
     this.form.get('SYMBOL_GENERAL_ID').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_SYMBOL_GENERAL_ID(event){
...
async WHEN_VALIDATE_ITEM_IMAGE_SELECT_SYMBOL(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['IMAGE_SELECT_SYMBOL'] != "undefined" ) 
      this.form.controls['IMAGE_SELECT_SYMBOL'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['IMAGE_SELECT_SYMBOL'] != "undefined" ) 
     this.form.get('IMAGE_SELECT_SYMBOL').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_IMAGE_SELECT_SYMBOL(event){

}
 
 async onChange_SYMBOL_GENERAL_ID(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_SYMBOL_GENERAL_ID(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onValueChange_TRIGGER_TYPE(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 ...
 async onValueChange_IMAGE_SELECT_SYMBOL(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 await this.WHEN_VALIDATE_ITEM_IMAGE_SELECT_SYMBOL(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
