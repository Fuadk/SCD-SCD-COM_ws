...
import { scdbrowserGeneralScdBgBrowserGeneral , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-bg-browser-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-bg-browser-general.component.html',
  styleUrls: ['./scd-bg-browser-general.component.scss'],
  standalone: false
})


export class ScdBrowserGeneralScdBgBrowserGeneralFormComponent {
  public title =  this.starServices.getNLS([],"SCD_BG_BROWSER_GENERAL.scdbrowserGeneralScdBgBrowserGeneral.component_title","Browser General");
  public compTitleMsg =  "SCD_BG_BROWSER_GENERAL.scdbrowserGeneralScdBgBrowserGeneral";
  public routineName = "ScdBrowserGeneralScdBgBrowserGeneralForm";
  ...
  public compSelector = 'app-scd-bg-browser-general';
...
public visibleUSE_PARAMETER_PLACEHOLDER = true;
...
public disableUSE_PARAMETER_PLACEHOLDER = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdbrowserGeneralScdBgBrowserGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdBrowserGeneralScdBgBrowserGeneralForm form.SHAPE_ID :' + form.SHAPE_ID);
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdBrowserGeneralScdBgBrowserGeneralForm ComponentConfig:", {...ComponentConfig});
