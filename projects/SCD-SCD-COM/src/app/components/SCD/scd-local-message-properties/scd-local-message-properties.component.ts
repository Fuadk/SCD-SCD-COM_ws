...
@Component({
  ...
  selector: 'app-scd-local-message-properties',
  templateUrl: './scd-local-message-properties.component.html',
  styleUrls: ['./scd-local-message-properties.component.scss'],
  standalone: false
})
export class ScdLocalMessagePropertiesComponent implements OnInit {
  ...
  constructor(public router: Router,public responsive: BreakpointObserver, private starNotify: StarNotifyService, public starServices: starServices, public starlib1: Starlib1) {
   this.router = router;
  this.title =  this.starServices.getNLS([],"scd_local_message_properties.scd_local_message_properties.component_title","");
  ...
  public routineName = "scd_local_message_properties";
  ...
  public routineAuth = "ScdLocalMessageProperties";

  public ngAfterViewInit() {
    this.starServices.setRTL();
  }
  private componentConfigChangeEvent!: Subscription;
  public compSelector = 'app-scd-local-message-properties';
  ...
  async initComponents(){
   ...
   this.SCD_SHAPEForm_0Config.title = this.starServices.getNLS([],"scd_local_message_properties.scd_local_message_properties.compsTitleID1","Common");
   ...
   this.SCD_MESSAGE_GENERALFormdivs_1Config.title = this.starServices.getNLS([],"scd_local_message_properties.scd_local_message_properties.compsTitleID2","General");
   this.SCD_MESSAGE_GENERALFormdivs_1Config.isChild = true;
   this.SCD_MESSAGE_GENERALFormdivs_1Config.masterSelector = 'app-scd-local-message-properties';
   ...
   this.SCD_SHAPE_CONNECTIONGrid_2Config.title = this.starServices.getNLS([],"scd_local_message_properties.scd_local_message_properties.compsTitleID3","Connections");
   this.SCD_SHAPE_CONNECTIONGrid_2Config.isChild = true;
   this.SCD_SHAPE_CONNECTIONGrid_2Config.masterSelector = 'app-scd-local-message-properties';
 ...
 if ( key != '') { 
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("ComponentConfig:ScdLocalMessagePropertiesComponent:",ComponentConfig);
    if (typeof ComponentConfig !== "undefined"){
