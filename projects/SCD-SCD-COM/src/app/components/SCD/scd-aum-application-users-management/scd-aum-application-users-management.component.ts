...
import { scduserScdAumApplicationUsersManagement , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-aum-application-users-management',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-aum-application-users-management.component.html',
  styleUrls: ['./scd-aum-application-users-management.component.scss'],
  standalone: false
})


export class ScdUserScdAumApplicationUsersManagementFormtabsComponent {
  public title =  this.starServices.getNLS([],"SCD_AUM_APPLICATION_USERS_MANAGEMENT.scduserScdAumApplicationUsersManagement.component_title","Application Users Management");
  public compTitleMsg =  "SCD_AUM_APPLICATION_USERS_MANAGEMENT.scduserScdAumApplicationUsersManagement";
  public routineName = "ScdUserScdAumApplicationUsersManagementFormtabs";
  ...
  public compSelector = 'app-scd-aum-application-users-management';
  public PK_AUTO = 'USER_ID';
  public customerFacing = false;
  public FormStepsArr = [{"CODE":"","CODETEXT_LANG":""},{"CODE":"1","CODETEXT_LANG":"Application Users"},{"CODE":"2","CODETEXT_LANG":"Group Membership"}] ;
...
public disablePHOTO = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scduserScdAumApplicationUsersManagement();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdUserScdAumApplicationUsersManagementFormtabs form.APPLICATION_ID :' + form.APPLICATION_ID);
...
this.form.get('USER_MUST_CHANGE_PASSWORD_AT_NEXT_LOGON').valueChanges.subscribe(val => {
});
this.form.get('USER_CAN_NOT_CHANGE_PASSWORD').valueChanges.subscribe(val => {
});
this.form.get('PASSWORD_NEVER_EXPIRES').valueChanges.subscribe(val => {
});
this.form.get('ACCOUNT_IS_DISABLED').valueChanges.subscribe(val => {
});
this.form.get('ACCOUNT_IS_LOCKED').valueChanges.subscribe(val => {
});
}
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdUserScdAumApplicationUsersManagementFormtabs ComponentConfig:", {...ComponentConfig});
