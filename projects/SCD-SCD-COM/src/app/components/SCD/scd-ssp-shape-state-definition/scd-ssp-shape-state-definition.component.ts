...
import { scdshapeStateScdSspShapeStateDefinition , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-ssp-shape-state-definition',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-ssp-shape-state-definition.component.html',
  styleUrls: ['./scd-ssp-shape-state-definition.component.scss'],
  standalone: false
})


export class ScdShapeStateScdSspShapeStateDefinitionFormComponent {
  public title =  this.starServices.getNLS([],"SCD_SSP_SHAPE_STATE_DEFINITION.scdshapeStateScdSspShapeStateDefinition.component_title","Shape State Definition");
  public compTitleMsg =  "SCD_SSP_SHAPE_STATE_DEFINITION.scdshapeStateScdSspShapeStateDefinition";
  public routineName = "ScdShapeStateScdSspShapeStateDefinitionForm";
  ...
  public compSelector = 'app-scd-ssp-shape-state-definition';
...
public disableIMAGE_ALIGNMENT = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdshapeStateScdSspShapeStateDefinition();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdShapeStateScdSspShapeStateDefinitionForm form.SHAPE_ID :' + form.SHAPE_ID);
...
this.form.get('CAPTION_WORD_WRAP').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdShapeStateScdSspShapeStateDefinitionForm ComponentConfig:", {...ComponentConfig});
