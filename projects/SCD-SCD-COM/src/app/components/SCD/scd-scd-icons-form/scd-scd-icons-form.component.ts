...
import { scdiconsScdScdIconsForm , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-scd-icons-form',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-scd-icons-form.component.html',
  styleUrls: ['./scd-scd-icons-form.component.scss'],
  standalone: false
})


export class ScdIconsScdScdIconsFormFormComponent {
  public title =  this.starServices.getNLS([],"SCD_SCD_ICONS_FORM.scdiconsScdScdIconsForm.component_title","SCD ICONS FORM");
  public compTitleMsg =  "SCD_SCD_ICONS_FORM.scdiconsScdScdIconsForm";
  public routineName = "ScdIconsScdScdIconsFormForm";
  ...
  public compSelector = 'app-scd-scd-icons-form';
  public PK_AUTO = 'id';
...
public variableCOPY_BUT;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdiconsScdScdIconsForm();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdIconsScdScdIconsFormForm form.category :' + form.category);
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdIconsScdScdIconsFormForm ComponentConfig:", {...ComponentConfig});
...
console.log("kendoui_content:",this.form.value)
let copiedShape = {
    kendoui_content : this.form.value.kendoui_content,
    id : this.form.value.icon_type + this.form.value.id,
    type : this.form.value.icon_type
};
...
console.log ("kendoui_content:0:",this.starServices.sessionParams['COPIED_SHAPE']);
 ...
 async onValueChange_svg_content(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
