...
import {   scdmessageScdMMessages , componentConfigDef } from '@modeldir/model';
...
'MESSAGE_ID' : new FormControl(dataItem.MESSAGE_ID  , ) ,
'APPLICATION_ID' : new FormControl(dataItem.APPLICATION_ID  ,   Validators.required ) ,
'MESSAGES' : new FormControl(dataItem.MESSAGES  , ) ,
'USAGE' : new FormControl(dataItem.USAGE  , ) 
});
...
@Component({
  selector: 'app-scd-m-messages',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-m-messages.component.html',
  standalone: false,
  styleUrls: ['./scd-m-messages.component.scss'
],
...
export class ScdMessageScdMMessagesGridComponent implements OnInit,OnDestroy {
 ...
 public showToolBar = true;
  ...
  public isMaster: boolean = false;
  		...
  		public  isMESSAGE_IDEnable : boolean = true; 
public  isAPPLICATION_IDEnable : boolean = true; 
  ...
  private insertCMD = "INSERT_SCD_MESSAGE";
  private updateCMD = "UPDATE_SCD_MESSAGE";
  private deleteCMD =   "DELETE_SCD_MESSAGE";
  private getCMD = "GET_SCD_MESSAGE_QUERY";

  public  executeQueryresult:any;
  public title =  this.starServices.getNLS([],"SCD_M_MESSAGES.scdmessageScdMMessages.component_title","Messages");
  public PDFfileName = this.title + ".PDF";
  public ExcelfileName = this.title + ".xlsx";
  public componentConfig
  public compTitleMsg =  "SCD_M_MESSAGES.scdmessageScdMMessages";
  ...
  public primarKeyReadOnlyArr = {isMESSAGE_IDreadOnly : false , isAPPLICATION_IDreadOnly : false};  
  public paramConfig;
...
public visibleMESSAGE_ID = true;
public visibleAPPLICATION_ID = false;
public visibleMESSAGES = true;
public visibleUSAGE = true;

public compSelector = 'app-scd-m-messages';
  ...
  @Output() formValidationChangedOutput: EventEmitter<boolean> = new EventEmitter();
    ...
    constructor(public router: Router,public intl: IntlService, public responsive: BreakpointObserver, private starNotify: StarNotifyService,   public starServices: starServices, private renderer: Renderer2) {
      ...
      this.title = this.componentConfig.title ? this.componentConfig.title :this.starServices.getNLS([],"SCD_M_MESSAGES.scdmessageScdMMessages.component_title","Messages");
  }
...
//Next part for filtering
  ...
  private gridInitialValues:any = new scdmessageScdMMessages();   
  ...
  public commonCallStarNotify(data:any) {
    ...
    let masterParams = {
      data: this.masterKeyArr
       ...
       let masterKeyArr = [data['APPLICATION_ID'],data['MESSAGE_ID']];
      let masterKeyNameArr = ['APPLICATION_ID','MESSAGE_ID'];
      //for (let i = 0; i < masterKeyNameArr.length; i++) {
      //  componentConfig.[masterKeyNameArr[i]] = masterKeyArr[i];
      //}
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ScdMessageScdMMessagesGrid ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_MESSAGE_ID(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['MESSAGE_ID'] != "undefined" ) 
      this.formGroup.controls['MESSAGE_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['MESSAGE_ID'] != "undefined" ) 
     this.formGroup.get('MESSAGE_ID').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_MESSAGE_ID(event){
...
async WHEN_VALIDATE_ITEM_MESSAGES(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['MESSAGES'] != "undefined" ) 
      this.formGroup.controls['MESSAGES'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['MESSAGES'] != "undefined" ) 
     this.formGroup.get('MESSAGES').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_MESSAGES(event){

}

async WHEN_VALIDATE_ITEM_USAGE(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['USAGE'] != "undefined" ) 
      this.formGroup.controls['USAGE'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['USAGE'] != "undefined" ) 
     this.formGroup.get('USAGE').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_USAGE(event){

}
 
 async onBlur_MESSAGE_ID() { 
  await this.WHEN_VALIDATE_ITEM_MESSAGE_ID(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 ...
 async onBlur_MESSAGES() { 
  await this.WHEN_VALIDATE_ITEM_MESSAGES(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_USAGE() { 
  await this.WHEN_VALIDATE_ITEM_USAGE(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 }
