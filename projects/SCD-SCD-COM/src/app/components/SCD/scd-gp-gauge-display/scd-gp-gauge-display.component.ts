...
import { scdgaugeDisplayScdGpGaugeDisplay , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-gp-gauge-display',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-gp-gauge-display.component.html',
  styleUrls: ['./scd-gp-gauge-display.component.scss'],
  standalone: false
})


export class ScdGaugeDisplayScdGpGaugeDisplayFormComponent {
  public title =  this.starServices.getNLS([],"SCD_GP_GAUGE_DISPLAY.scdgaugeDisplayScdGpGaugeDisplay.component_title","Gauge Display");
  public compTitleMsg =  "SCD_GP_GAUGE_DISPLAY.scdgaugeDisplayScdGpGaugeDisplay";
  public routineName = "ScdGaugeDisplayScdGpGaugeDisplayForm";
...
public labelFILL_COLOR_1Top=false;
...
public disableBLINK_2 = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdgaugeDisplayScdGpGaugeDisplay();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdGaugeDisplayScdGpGaugeDisplayForm form.SHAPE_ID :' + form.SHAPE_ID);
...
this.form.get('SHOW_LEGEND').valueChanges.subscribe(val => {
});
this.form.get('DIGITS_AFTER_DECIMAL').valueChanges.subscribe(val => {
});
this.form.get('LEGEND_COLOR').valueChanges.subscribe(val => {
});
...
this.form.get('FILL_COLOR_1').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdGaugeDisplayScdGpGaugeDisplayForm ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_BLINK_2(value) {
 ...
 async onChange_DIGITS_AFTER_DECIMAL(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 ...
 async onChange_LEGEND_COLOR(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 ...
 async onChange_FILL_COLOR_1(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
