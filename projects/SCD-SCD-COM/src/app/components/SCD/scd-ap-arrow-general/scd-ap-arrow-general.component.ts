...
@Component({
  selector: 'app-scd-ap-arrow-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-ap-arrow-general.component.html',
  styleUrls: ['./scd-ap-arrow-general.component.scss'],
  standalone: false
})


export class ScdArrowGeneralScdApArrowGeneralFormComponent {
  public title =  this.starServices.getNLS([],"SCD_AP_ARROW_GENERAL.scdarrowGeneralScdApArrowGeneral.component_title","Arrow General");
  public compTitleMsg =  "SCD_AP_ARROW_GENERAL.scdarrowGeneralScdApArrowGeneral";
  public routineName = "ScdArrowGeneralScdApArrowGeneralForm";
  ...
  public compSelector = 'app-scd-ap-arrow-general';
...
public visibleEXPRESSION_DATA = false;
public visibleSPECIFY = false;
public visibleMIN = false;
public visibleMAX = false;
...
public disableDIRECTION = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdarrowGeneralScdApArrowGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdArrowGeneralScdApArrowGeneralForm form.SHAPE_ID :' + form.SHAPE_ID);
...
this.form.get('EXPRESSION_DATA').valueChanges.subscribe(val => {
});
this.form.get('SPECIFY').valueChanges.subscribe(val => {
});
this.form.get('MIN').valueChanges.subscribe(val => {
});
this.form.get('MAX').valueChanges.subscribe(val => {
});
this.form.get('DIRECTION').valueChanges.subscribe(val => {
});
}
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdArrowGeneralScdApArrowGeneralForm ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_DIRECTION(value) {
 ...
 async onChange_EXPRESSION_DATA(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
