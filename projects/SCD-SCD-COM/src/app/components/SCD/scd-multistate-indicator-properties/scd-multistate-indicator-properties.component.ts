...
import {  scdshapeScdTpCommonScreen  ,scdmultistateIndicatorGeneralScdMigMultistateIndicatorGeneral  ,scdalarmScdShapeStatesProperties  ,scdshapeConnectionScdScShapeConnections  , componentConfigDef} from '@modeldir/model';
...
@Component({
  ...
  selector: 'app-scd-multistate-indicator-properties',
  templateUrl: './scd-multistate-indicator-properties.component.html',
  styleUrls: ['./scd-multistate-indicator-properties.component.scss'],
  standalone: false
})
export class ScdMultistateIndicatorPropertiesComponent implements OnInit {
  ...
  constructor(public router: Router,public responsive: BreakpointObserver, private starNotify: StarNotifyService, public starServices: starServices, public starlib1: Starlib1) {
   this.router = router;
  this.title =  this.starServices.getNLS([],"scd_multistate_indicator_properties.scd_multistate_indicator_properties.component_title","");
  ...
  public routineName = "scd_multistate_indicator_properties";
  ...
  public form_1_SCD_MULTISTATE_INDICATOR_GENERAL : scdmultistateIndicatorGeneralScdMigMultistateIndicatorGeneral;
  ...
  public  SCD_MULTISTATE_INDICATOR_GENERALForm_1Config : componentConfigDef;
  ...
  public routineAuth = "ScdMultistateIndicatorProperties";

  public ngAfterViewInit() {
    this.starServices.setRTL();
  }
  private componentConfigChangeEvent!: Subscription;
  public compSelector = 'app-scd-multistate-indicator-properties';
  ...
  async initComponents(){
   ...
   this.SCD_SHAPEForm_0Config.title = this.starServices.getNLS([],"scd_multistate_indicator_properties.scd_multistate_indicator_properties.compsTitleID1","Common");
   ...
   this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config = new componentConfigDef();
   this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.title = this.starServices.getNLS([],"scd_multistate_indicator_properties.scd_multistate_indicator_properties.compsTitleID2","General");
   this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.isChild = true;
   this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.masterSelector = 'app-scd-multistate-indicator-properties';
   this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.showToolBar = !this.visibleOK_BTNS; 
   if (typeof this['steps']  !== 'undefined') {
     this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.navigable = false;
     //this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.insertable = true;
     //this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.removeable = true;
   }
   this.SCD_ALARMFormtabs_2Config = new componentConfigDef();
   this.SCD_ALARMFormtabs_2Config.title = this.starServices.getNLS([],"scd_multistate_indicator_properties.scd_multistate_indicator_properties.compsTitleID3","States");
   this.SCD_ALARMFormtabs_2Config.isChild = true;
   this.SCD_ALARMFormtabs_2Config.masterSelector = 'app-scd-multistate-indicator-properties';
   ...
   this.SCD_SHAPE_CONNECTIONGrid_3Config.title = this.starServices.getNLS([],"scd_multistate_indicator_properties.scd_multistate_indicator_properties.compsTitleID4","Connections");
   this.SCD_SHAPE_CONNECTIONGrid_3Config.isChild = true;
   this.SCD_SHAPE_CONNECTIONGrid_3Config.masterSelector = 'app-scd-multistate-indicator-properties';
   this.SCD_SHAPE_CONNECTIONGrid_3Config.showToolBar = !this.visibleOK_BTNS; 
   if (typeof this['steps']  !== 'undefined') {
  ...
  public readCompletedHandler( form_SCD_SHAPE) {
    ...
    let masterKeyNameArr = ["SHAPE_ID","DISPLAY_ID"];
     if (this.isSearchScreen == true) 
	  {
    	this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config = new componentConfigDef();
    	this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.formattedWhere  = form_SCD_SHAPE;
    	this.SCD_ALARMFormtabs_2Config = new componentConfigDef();
    ...
    //this.form_1_SCD_MULTISTATE_INDICATOR_GENERAL = new scdmultistateIndicatorGeneralScdMigMultistateIndicatorGeneral();
    //for (let i = 0; i< masterKeyNameArr.length; i++){
    //   this.form_1_SCD_MULTISTATE_INDICATOR_GENERAL[masterKeyNameArr[i]] = masterKeyArr[i];
    //}
    this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config = new componentConfigDef();
    this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.masterKeyArr =  [form_SCD_SHAPE.SHAPE_ID,form_SCD_SHAPE.DISPLAY_ID];
    this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.masterKeyNameArr =  ["SHAPE_ID","DISPLAY_ID"];
    this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.masterReadCompleted = true;
   if (typeof this['steps'] !== 'undefined') {
     this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.queryable = false;
     //this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.removeable = true;
     //this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.updateable = true;
   }
  ...
  public sendToChildren(componentConfig, pageNo){ 
   if ( (pageNo + 1) == 2){
  	this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config = new componentConfigDef(); 
  	this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config = componentConfig; 
   }
   if ( (pageNo + 1) == 3){
  	this.SCD_ALARMFormtabs_2Config = new componentConfigDef(); 
 ...
 if ( key != '') { 
    this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config = new componentConfigDef();
    this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.masterSaved = form_SCD_SHAPE;
    this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.masterKeyArr =  [form_SCD_SHAPE.SHAPE_ID,form_SCD_SHAPE.DISPLAY_ID];
    this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.masterKeyNameArr =  ["SHAPE_ID","DISPLAY_ID"];
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("ComponentConfig:ScdMultistateIndicatorPropertiesComponent:",ComponentConfig);
    if (typeof ComponentConfig !== "undefined"){
       ...
       if (ComponentConfig.languageChanged != null) { 
           setTimeout(() => {
             ...
             this.SCD_SHAPEForm_0Config.title = this.starServices.getNLS([],"scd_multistate_indicator_properties.scd_multistate_indicator_properties.compsTitleID1","Common");
             this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config = new componentConfigDef();
             this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.languageChanged = ComponentConfig.languageChanged;
             this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.title = this.starServices.getNLS([],"scd_multistate_indicator_properties.scd_multistate_indicator_properties.compsTitleID2","General");
             this.SCD_ALARMFormtabs_2Config = new componentConfigDef();
       ...
       if (ComponentConfig.masterParams != null) {
              ...
              this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.masterParams = ComponentConfig.masterParams;
              this.SCD_ALARMFormtabs_2Config.masterParams = ComponentConfig.masterParams;
              this.SCD_SHAPE_CONNECTIONGrid_3Config.masterParams = ComponentConfig.masterParams;
   		
       }
       if (ComponentConfig.showToolBar != null) {
              this.SCD_SHAPEForm_0Config.showToolBar = ComponentConfig.showToolBar;
              this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.showToolBar = ComponentConfig.showToolBar;
              this.SCD_ALARMFormtabs_2Config.showToolBar = ComponentConfig.showToolBar;
              this.SCD_SHAPE_CONNECTIONGrid_3Config.showToolBar = ComponentConfig.showToolBar;
       }
      ...
      if (ComponentConfig.newRec != null)
      {
       ...
       this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.newRec = ComponentConfig.newRec;
      ...
      if (ComponentConfig.clearScreen != null)
      {
       ...
       this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.clearScreen = ComponentConfig.clearScreen;
      ...
      if ((ComponentConfig.masterKeyArr != null) && (ComponentConfig.masterKeyNameArr != null) )
      {
       if ((ComponentConfig.masterKeyArr.length != 0) && (ComponentConfig.masterKeyNameArr.length != 0) )
       {
         ...
         this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.masterKeyArr = ComponentConfig.masterKeyArr;
         this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.masterKeyNameArr = ComponentConfig.masterKeyNameArr;
         if (ComponentConfig.masterReadCompleted != null) 
         {
             this.SCD_MULTISTATE_INDICATOR_GENERALForm_1Config.masterReadCompleted = ComponentConfig.masterReadCompleted;
          }
   ...
   public form_1_SCD_MULTISTATE_INDICATOR_GENERALOpened = false;
  public  form_1_SCD_MULTISTATE_INDICATOR_GENERALClose() { 
    this.form_1_SCD_MULTISTATE_INDICATOR_GENERALOpened = false;  
  }
  public  form_1_SCD_MULTISTATE_INDICATOR_GENERALOpen() { 
    this.form_1_SCD_MULTISTATE_INDICATOR_GENERALOpened = true;  
  }
