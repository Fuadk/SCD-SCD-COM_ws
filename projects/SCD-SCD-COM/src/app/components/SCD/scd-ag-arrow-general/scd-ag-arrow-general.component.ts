...
import { scdarrowGeneralScdAgArrowGeneral , componentConfigDef} from '@modeldir/model';


 const createFormGroup = (dataItem:any) => new FormGroup({
'ARROW_GENERAL_ID' : new FormControl(dataItem.ARROW_GENERAL_ID  , ) ,
'SHAPE_ID' : new FormControl(dataItem.SHAPE_ID  ,   Validators.required ) ,
'EXPRESSION_DATA' : new FormControl(dataItem.EXPRESSION_DATA  , ) ,
'SPECIFY' : new FormControl(dataItem.SPECIFY  , ) ,
'MIN' : new FormControl(dataItem.MIN  , ) ,
'MAX' : new FormControl(dataItem.MAX  , ) ,
'DIRECTION' : new FormControl(dataItem.DIRECTION  , ) 
});

declare function getParamConfig():any;
@Component({
  selector: 'app-scd-ag-arrow-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-ag-arrow-general.component.html',
  styleUrls: ['./scd-ag-arrow-general.component.scss'],
  standalone: false
})


export class ScdArrowGeneralScdAgArrowGeneralFormdivsComponent {
  public title =  this.starServices.getNLS([],"SCD_AG_ARROW_GENERAL.scdarrowGeneralScdAgArrowGeneral.component_title","Arrow General");
  public compTitleMsg =  "SCD_AG_ARROW_GENERAL.scdarrowGeneralScdAgArrowGeneral";
  public routineName = "ScdArrowGeneralScdAgArrowGeneralFormdivs";
  private insertCMD = "INSERT_SCD_ARROW_GENERAL";
  private updateCMD = "UPDATE_SCD_ARROW_GENERAL";
  private deleteCMD =   "DELETE_SCD_ARROW_GENERAL";
  private getCMD = "GET_SCD_ARROW_GENERAL_QUERY";
  ...
  public primarKeyReadOnlyArr = {isARROW_GENERAL_IDreadOnly : false , isSHAPE_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-ag-arrow-general';
  public PK_AUTO = 'ARROW_GENERAL_ID';
  public customerFacing = false;
  public FormStepsArr = [{"CODE":"","CODETEXT_LANG":"","visible":true},{"CODE":"1","CODETEXT_LANG":"Expression","visible":true},{"CODE":"2","CODETEXT_LANG":"Range","visible":true},{"CODE":"3","CODETEXT_LANG":"Direction","visible":true}] ;
public labelARROW_GENERAL_IDTop=false;
public labelARROW_GENERAL_IDVisible=true;
...
public labelSPECIFYTop=false;
public labelSPECIFYVisible=true;
public labelMINTop=false;
public labelMINVisible=true;
public labelMAXTop=false;
public labelMAXVisible=true;
public labelDIRECTIONTop=false;
public labelDIRECTIONVisible=true;

public visibleARROW_GENERAL_ID = false;
public visibleSHAPE_ID = false;
public visibleEXPRESSION_DATA = true;
public visibleSPECIFY = true;
public visibleMIN = true;
public visibleMAX = true;
public visibleDIRECTION = true;

public disableARROW_GENERAL_ID = false;
public disableSHAPE_ID = false;
public disableEXPRESSION_DATA = false;
public disableSPECIFY = false;
public disableMIN = false;
public disableMAX = false;
public disableDIRECTION = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdarrowGeneralScdAgArrowGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdArrowGeneralScdAgArrowGeneralFormdivs form.SHAPE_ID :' + form.SHAPE_ID);
  ...
  async  enterQuery (form : any){
    ...
    async callBackPost_Insert(NewVal:any) {
      ...
      this.Comp_Config.masterKeyArr =  [NewVal['ARROW_GENERAL_ID']];
      this.Comp_Config.masterKeyNameArr =  ["ARROW_GENERAL_ID"];
...
this.lookupArrDef =[	{"statment":"SELECT SHAPE_ID CODE, NAME CODETEXT_LANG  FROM SCD_SHAPE  order by CODETEXT_LANG ",
	...
	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"DIRECTION\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
			"lkpArrName":"lkpArrDIRECTION"}];
...
public lkpArrGetDIRECTION(CODE: any): any {
var rec = this.lkpArrDIRECTION.find((x:any) => x.CODE === CODE);
return rec;
}

onChanges(): void {
this.form.get('ARROW_GENERAL_ID').valueChanges.subscribe(val => {
});
this.form.get('MIN').valueChanges.subscribe(val => {
});
this.form.get('MAX').valueChanges.subscribe(val => {
});
}
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdArrowGeneralScdAgArrowGeneralFormdivs ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_ARROW_GENERAL_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['ARROW_GENERAL_ID'] != "undefined" ) 
      this.form.controls['ARROW_GENERAL_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['ARROW_GENERAL_ID'] != "undefined" ) 
     this.form.get('ARROW_GENERAL_ID').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_ARROW_GENERAL_ID(event){
...
async WHEN_VALIDATE_ITEM_EXPRESSION_DATA(value) {
 ...
 if (typeof this.form.controls['EXPRESSION_DATA'] != "undefined" ) 
     this.form.get('EXPRESSION_DATA').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_EXPRESSION_DATA(event){

}

async WHEN_VALIDATE_ITEM_SPECIFY(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['SPECIFY'] != "undefined" ) 
      this.form.controls['SPECIFY'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['SPECIFY'] != "undefined" ) 
     this.form.get('SPECIFY').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_SPECIFY(event){

}

async WHEN_VALIDATE_ITEM_MIN(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['MIN'] != "undefined" ) 
      this.form.controls['MIN'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 async ON_CLICK_MIN(event){

}

async WHEN_VALIDATE_ITEM_MAX(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['MAX'] != "undefined" ) 
 ...
 async ON_CLICK_MAX(event){

}

async WHEN_VALIDATE_ITEM_DIRECTION(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['DIRECTION'] != "undefined" ) 
      this.form.controls['DIRECTION'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 async ON_CLICK_DIRECTION(event){

}
 
 async onChange_ARROW_GENERAL_ID(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_ARROW_GENERAL_ID(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onChange_SPECIFY(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_SPECIFY(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
  
 } 
 async onChange_MIN(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_MIN(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
  
 } 
 async onChange_MAX(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_MAX(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
  
 } 
 async onChange_DIRECTION(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_DIRECTION(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
