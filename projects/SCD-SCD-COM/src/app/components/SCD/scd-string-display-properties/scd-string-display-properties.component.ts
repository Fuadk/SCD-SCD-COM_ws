...
@Component({
  ...
  selector: 'app-scd-string-display-properties',
  templateUrl: './scd-string-display-properties.component.html',
  styleUrls: ['./scd-string-display-properties.component.scss'],
  standalone: false
})
export class ScdStringDisplayPropertiesComponent implements OnInit {
  ...
  constructor(public router: Router,public responsive: BreakpointObserver, private starNotify: StarNotifyService, public starServices: starServices, public starlib1: Starlib1) {
   this.router = router;
  this.title =  this.starServices.getNLS([],"scd_string_display_properties.scd_string_display_properties.component_title","");
  ...
  public routineName = "scd_string_display_properties";
  ...
  public routineAuth = "ScdStringDisplayProperties";

  public ngAfterViewInit() {
    this.starServices.setRTL();
  }
  private componentConfigChangeEvent!: Subscription;
  public compSelector = 'app-scd-string-display-properties';
  ...
  async initComponents(){
   ...
   this.SCD_SHAPEForm_0Config.title = this.starServices.getNLS([],"scd_string_display_properties.scd_string_display_properties.compsTitleID1","Common");
   ...
   this.SCD_SHAPE_DISPLAY_GENERALFormdivs_1Config.title = this.starServices.getNLS([],"scd_string_display_properties.scd_string_display_properties.compsTitleID2","General");
   this.SCD_SHAPE_DISPLAY_GENERALFormdivs_1Config.isChild = true;
   this.SCD_SHAPE_DISPLAY_GENERALFormdivs_1Config.masterSelector = 'app-scd-string-display-properties';
 ...
 if ( key != '') { 
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("ComponentConfig:ScdStringDisplayPropertiesComponent:",ComponentConfig);
    if (typeof ComponentConfig !== "undefined"){
       ...
       if (ComponentConfig.masterParams != null) {
              ...
              this.SCD_SHAPE_DISPLAY_GENERALFormdivs_1Config.masterParams = ComponentConfig.masterParams;
   		
       }
       if (ComponentConfig.showToolBar != null) {
              this.SCD_SHAPEForm_0Config.showToolBar = ComponentConfig.showToolBar;
              this.SCD_SHAPE_DISPLAY_GENERALFormdivs_1Config.showToolBar = ComponentConfig.showToolBar;
       }
