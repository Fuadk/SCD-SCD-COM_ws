...
import { scdtextGeneralScdTgTextGeneral , componentConfigDef} from '@modeldir/model';
...
'SIZE_TO_FIT' : new FormControl(dataItem.SIZE_TO_FIT  , ) ,
...
@Component({
  selector: 'app-scd-tg-text-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-tg-text-general.component.html',
  styleUrls: ['./scd-tg-text-general.component.scss'],
  standalone: false
})


export class ScdTextGeneralScdTgTextGeneralFormComponent {
  public title =  this.starServices.getNLS([],"SCD_TG_TEXT_GENERAL.scdtextGeneralScdTgTextGeneral.component_title","Text General");
  public compTitleMsg =  "SCD_TG_TEXT_GENERAL.scdtextGeneralScdTgTextGeneral";
  public routineName = "ScdTextGeneralScdTgTextGeneralForm";
  private insertCMD = "INSERT_SCD_TEXT_GENERAL";
  private updateCMD = "UPDATE_SCD_TEXT_GENERAL";
  private deleteCMD =   "DELETE_SCD_TEXT_GENERAL";
  private getCMD = "GET_SCD_TEXT_GENERAL_QUERY";
  ...
  public primarKeyReadOnlyArr = {isTEXT_GENERAL_IDreadOnly : false , isSHAPE_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-tg-text-general';
...
public visibleSIZE_TO_FIT = true;
...
public disableSIZE_TO_FIT = false;
...
public disableALIGNMENT = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdtextGeneralScdTgTextGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdTextGeneralScdTgTextGeneralForm form.SHAPE_ID :' + form.SHAPE_ID);
  ...
  async  enterQuery (form : any){
    ...
    async callBackPost_Insert(NewVal:any) {
      ...
      this.Comp_Config.masterKeyArr =  [NewVal['TEXT_GENERAL_ID']];
      this.Comp_Config.masterKeyNameArr =  ["TEXT_GENERAL_ID"];
...
onChanges(): void {
this.form.get('TEXT_GENERAL_ID').valueChanges.subscribe(val => {
});
this.form.get('TEXT_FIELD').valueChanges.subscribe(val => {
});
}
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdTextGeneralScdTgTextGeneralForm ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_TEXT_GENERAL_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['TEXT_GENERAL_ID'] != "undefined" ) 
      this.form.controls['TEXT_GENERAL_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['TEXT_GENERAL_ID'] != "undefined" ) 
     this.form.get('TEXT_GENERAL_ID').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_TEXT_GENERAL_ID(event){
...
async WHEN_VALIDATE_ITEM_TEXT_FIELD(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['TEXT_FIELD'] != "undefined" ) 
      this.form.controls['TEXT_FIELD'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['TEXT_FIELD'] != "undefined" ) 
     this.form.get('TEXT_FIELD').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_SIZE_TO_FIT(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['SIZE_TO_FIT'] != "undefined" ) 
      this.form.controls['SIZE_TO_FIT'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['SIZE_TO_FIT'] != "undefined" ) 
     this.form.get('SIZE_TO_FIT').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_SIZE_TO_FIT(event){
...
async WHEN_VALIDATE_ITEM_ALIGNMENT(value) {
 ...
 async onChange_TEXT_GENERAL_ID(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_TEXT_GENERAL_ID(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onChange_SIZE_TO_FIT(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_SIZE_TO_FIT(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
