...
import {  scdshapeScdTpCommonScreen  ,scdmessageGeneralScdMgMessageGeneral  , componentConfigDef} from '@modeldir/model';
...
@Component({
  ...
  selector: 'app-scd-message-date-properties',
  templateUrl: './scd-message-date-properties.component.html',
  styleUrls: ['./scd-message-date-properties.component.scss'],
  standalone: false
})
export class ScdMessageDatePropertiesComponent implements OnInit {
  ...
  constructor(public router: Router,public responsive: BreakpointObserver, private starNotify: StarNotifyService, public starServices: starServices, public starlib1: Starlib1) {
   this.router = router;
  this.title =  this.starServices.getNLS([],"scd_message_date_properties.scd_message_date_properties.component_title","");
  ...
  public routineName = "scd_message_date_properties";
  ...
  public routineAuth = "ScdMessageDateProperties";

  public ngAfterViewInit() {
    this.starServices.setRTL();
  }
  private componentConfigChangeEvent!: Subscription;
  public compSelector = 'app-scd-message-date-properties';
  ...
  async initComponents(){
   ...
   this.SCD_SHAPEForm_0Config.title = this.starServices.getNLS([],"scd_message_date_properties.scd_message_date_properties.compsTitleID1","Common");
   ...
   this.SCD_MESSAGE_GENERALFormdivs_1Config.title = this.starServices.getNLS([],"scd_message_date_properties.scd_message_date_properties.compsTitleID2","General");
   this.SCD_MESSAGE_GENERALFormdivs_1Config.isChild = true;
   this.SCD_MESSAGE_GENERALFormdivs_1Config.masterSelector = 'app-scd-message-date-properties';
   if (typeof this['steps']  !== 'undefined') {
 ...
 if ( key != '') { 
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("ComponentConfig:ScdMessageDatePropertiesComponent:",ComponentConfig);
    if (typeof ComponentConfig !== "undefined"){
      ...
      if (ComponentConfig.masterSaved != null)
      {
       ...
       this.SCD_MESSAGE_GENERALFormdivs_1Config.masterSaved = ComponentConfig.masterSaved;
      }
