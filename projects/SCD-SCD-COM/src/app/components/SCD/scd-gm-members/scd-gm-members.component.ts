...
import {   scdgroupMembershipScdGmMembers , componentConfigDef } from '@modeldir/model';
...
@Component({
  selector: 'app-scd-gm-members',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-gm-members.component.html',
  standalone: false,
  styleUrls: ['./scd-gm-members.component.scss'
],
...
export class ScdGroupMembershipScdGmMembersGridComponent implements OnInit,OnDestroy {
 ...
 public showToolBar = true;
  ...
  public isMaster: boolean = false;
  	...
  	public  isGROUP_MEMBERSHIP_IDEnable : boolean = true; 
  ...
  public primarKeyReadOnlyArr = {isGROUP_MEMBERSHIP_IDreadOnly : false};  
  public paramConfig;
...
public visibleFULL_NAME = false;
public visibleUSER_NAME = true;

public compSelector = 'app-scd-gm-members';
  ...
  @Output() formValidationChangedOutput: EventEmitter<boolean> = new EventEmitter();
    ...
    constructor(public router: Router,public intl: IntlService, public responsive: BreakpointObserver, private starNotify: StarNotifyService,   public starServices: starServices, private renderer: Renderer2) {
      ...
      this.title = this.componentConfig.title ? this.componentConfig.title :this.starServices.getNLS([],"SCD_GM_MEMBERS.scdgroupMembershipScdGmMembers.component_title","Members");
  }
...
//Next part for filtering
  ...
  private gridInitialValues:any = new scdgroupMembershipScdGmMembers();   
  ...
  public commonCallStarNotify(data:any) {
    ...
    let masterParams = {
      data: this.masterKeyArr
       ...
       let masterKeyArr = [data['GROUP_MEMBERSHIP_ID']];
      let masterKeyNameArr = ['GROUP_MEMBERSHIP_ID'];
      //for (let i = 0; i < masterKeyNameArr.length; i++) {
      //  componentConfig.[masterKeyNameArr[i]] = masterKeyArr[i];
      //}
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ScdGroupMembershipScdGmMembersGrid ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_GROUP_MEMBERSHIP_ID(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['GROUP_MEMBERSHIP_ID'] != "undefined" ) 
      this.formGroup.controls['GROUP_MEMBERSHIP_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['GROUP_MEMBERSHIP_ID'] != "undefined" ) 
     this.formGroup.get('GROUP_MEMBERSHIP_ID').updateValueAndValidity();
...
async WHEN_VALIDATE_ITEM_GROUP_ID(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['GROUP_ID'] != "undefined" ) 
      this.formGroup.controls['GROUP_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['GROUP_ID'] != "undefined" ) 
     this.formGroup.get('GROUP_ID').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_FULL_NAME(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['FULL_NAME'] != "undefined" ) 
      this.formGroup.controls['FULL_NAME'].setErrors({invalid: true}); 
 // Code goes here 
...
async WHEN_VALIDATE_ITEM_USER_NAME(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['USER_NAME'] != "undefined" ) 
      this.formGroup.controls['USER_NAME'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['USER_NAME'] != "undefined" ) 
     this.formGroup.get('USER_NAME').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
 ...
 async onBlur_GROUP_MEMBERSHIP_ID() { 
  await this.WHEN_VALIDATE_ITEM_GROUP_MEMBERSHIP_ID(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 ...
 async onBlur_GROUP_ID() { 
  await this.WHEN_VALIDATE_ITEM_GROUP_ID(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_FULL_NAME() { 
  await this.WHEN_VALIDATE_ITEM_FULL_NAME(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_USER_NAME() { 
  await this.WHEN_VALIDATE_ITEM_USER_NAME(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 }
