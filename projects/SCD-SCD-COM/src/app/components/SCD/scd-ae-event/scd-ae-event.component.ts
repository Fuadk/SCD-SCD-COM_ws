...
import { scdeventScdAeEvent , componentConfigDef} from '@modeldir/model';
...
'ACTION_NAME' : new FormControl(dataItem.ACTION_NAME  , ) ,
'ENABLED' : new FormControl(dataItem.ENABLED  , ) ,
'DESCRIPTION' : new FormControl(dataItem.DESCRIPTION  , ) ,
'AI_EXPRESSION' : new FormControl(dataItem.AI_EXPRESSION  , ) ,
'EXPRESSION_EDITOR' : new FormControl(dataItem.EXPRESSION_EDITOR  , ) ,
'ERROR_MSG' : new FormControl(dataItem.ERROR_MSG  , ) 
});

declare function getParamConfig():any;
@Component({
  selector: 'app-scd-ae-event',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-ae-event.component.html',
  styleUrls: ['./scd-ae-event.component.scss'],
  standalone: false
})


export class ScdEventScdAeEventFormComponent {
  public title =  this.starServices.getNLS([],"SCD_AE_EVENT.scdeventScdAeEvent.component_title","Event");
  public compTitleMsg =  "SCD_AE_EVENT.scdeventScdAeEvent";
  public routineName = "ScdEventScdAeEventForm";
  private insertCMD = "INSERT_SCD_EVENT";
  private updateCMD = "UPDATE_SCD_EVENT";
  private deleteCMD =   "DELETE_SCD_EVENT";
  private getCMD = "GET_SCD_EVENT_QUERY";
  ...
  public primarKeyReadOnlyArr = {isEVENT_IDreadOnly : false , isAPPLICATION_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-ae-event';
...
public labelACTION_NAMETop=false;
public labelACTION_NAMEVisible=true;
public labelSELECT_TAG_EVENTTop=false;
public labelSELECT_TAG_EVENTVisible=true;
public labelENABLEDTop=false;
public labelENABLEDVisible=true;
...
public labelEXPRESSION_EDITORTop=false;
public labelEXPRESSION_EDITORVisible=true;
public labelERROR_MSGTop=false;
public labelERROR_MSGVisible=true;

public visibleEVENT_ID = false;
public visibleAPPLICATION_ID = false;
public visibleACTION_NAME = true;
public visibleSELECT_TAG_EVENT = true;
public visibleENABLED = true;
public visibleDESCRIPTION = true;
public visibleAI_EXPRESSION = false;
public visibleEXPRESSION_EDITOR = true;
public visibleERROR_MSG = false;

public disableEVENT_ID = false;
public disableAPPLICATION_ID = false;
public disableACTION_NAME = false;
public disableSELECT_TAG_EVENT = false;
public disableENABLED = false;
public disableDESCRIPTION = false;
public disableAI_EXPRESSION = false;
public disableEXPRESSION_EDITOR = false;
public disableERROR_MSG = false;

public variableSELECT_TAG_EVENT;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdeventScdAeEvent();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdEventScdAeEventForm form.APPLICATION_ID :' + form.APPLICATION_ID);
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdEventScdAeEventForm ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_ACTION_NAME(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['ACTION_NAME'] != "undefined" ) 
      this.form.controls['ACTION_NAME'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['ACTION_NAME'] != "undefined" ) 
     this.form.get('ACTION_NAME').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_ACTION_NAME(event){

}

async WHEN_VALIDATE_ITEM_SELECT_TAG_EVENT(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['SELECT_TAG_EVENT'] != "undefined" ) 
      this.form.controls['SELECT_TAG_EVENT'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['SELECT_TAG_EVENT'] != "undefined" ) 
     this.form.get('SELECT_TAG_EVENT').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_SELECT_TAG_EVENT(event){

}

async WHEN_VALIDATE_ITEM_ENABLED(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['ENABLED'] != "undefined" ) 
      this.form.controls['ENABLED'].setErrors({invalid: true}); 
 // Code goes here 
...
async WHEN_VALIDATE_ITEM_EXPRESSION_EDITOR(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['EXPRESSION_EDITOR'] != "undefined" ) 
      this.form.controls['EXPRESSION_EDITOR'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['EXPRESSION_EDITOR'] != "undefined" ) 
     this.form.get('EXPRESSION_EDITOR').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_EXPRESSION_EDITOR(event){

}

async WHEN_VALIDATE_ITEM_ERROR_MSG(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['ERROR_MSG'] != "undefined" ) 
      this.form.controls['ERROR_MSG'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['ERROR_MSG'] != "undefined" ) 
     this.form.get('ERROR_MSG').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_ERROR_MSG(event){
 ...
 async onChange_ACTION_NAME(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_ACTION_NAME(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
  
 } 
 async onValueChange_SELECT_TAG_EVENT(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 await this.WHEN_VALIDATE_ITEM_SELECT_TAG_EVENT(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
  
  } 
 async onChange_ENABLED(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_ENABLED(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onChange_AI_EXPRESSION(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 ...
 async onValueChange_EXPRESSION_EDITOR(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 await this.WHEN_VALIDATE_ITEM_EXPRESSION_EDITOR(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
  
  } 
 async onValueChange_ERROR_MSG(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 await this.WHEN_VALIDATE_ITEM_ERROR_MSG(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
