...
import {  scdshapeScdTpCommonScreen  ,scdshapeInputGeneralScdSigShapeInputGeneral  ,scdshapeInputAppearanceScdSiaShapeInputAppearance  ,scdshapeConnectionScdScShapeConnections  , componentConfigDef} from '@modeldir/model';
...
@Component({
  ...
  selector: 'app-scd-numeric-input-properties',
  templateUrl: './scd-numeric-input-properties.component.html',
  styleUrls: ['./scd-numeric-input-properties.component.scss'],
  standalone: false
})
export class ScdNumericInputPropertiesComponent implements OnInit {
  ...
  constructor(public router: Router,public responsive: BreakpointObserver, private starNotify: StarNotifyService, public starServices: starServices, public starlib1: Starlib1) {
   this.router = router;
  this.title =  this.starServices.getNLS([],"scd_numeric_input_properties.scd_numeric_input_properties.component_title","");
  ...
  public routineName = "scd_numeric_input_properties";
  ...
  public routineAuth = "ScdNumericInputProperties";

  public ngAfterViewInit() {
    this.starServices.setRTL();
  }
  private componentConfigChangeEvent!: Subscription;
  public compSelector = 'app-scd-numeric-input-properties';
  ...
  async initComponents(){
   ...
   this.SCD_SHAPEForm_0Config.title = this.starServices.getNLS([],"scd_numeric_input_properties.scd_numeric_input_properties.compsTitleID1","Common");
   ...
   this.SCD_SHAPE_INPUT_GENERALFormdivs_1Config.title = this.starServices.getNLS([],"scd_numeric_input_properties.scd_numeric_input_properties.compsTitleID2","General");
   this.SCD_SHAPE_INPUT_GENERALFormdivs_1Config.isChild = true;
   this.SCD_SHAPE_INPUT_GENERALFormdivs_1Config.masterSelector = 'app-scd-numeric-input-properties';
   ...
   this.SCD_SHAPE_INPUT_APPEARANCEFormdivs_2Config.title = this.starServices.getNLS([],"scd_numeric_input_properties.scd_numeric_input_properties.compsTitleID3","Appearance");
   this.SCD_SHAPE_INPUT_APPEARANCEFormdivs_2Config.isChild = true;
   this.SCD_SHAPE_INPUT_APPEARANCEFormdivs_2Config.masterSelector = 'app-scd-numeric-input-properties';
   ...
   this.SCD_SHAPE_CONNECTIONGrid_3Config.title = this.starServices.getNLS([],"scd_numeric_input_properties.scd_numeric_input_properties.compsTitleID4","Connections");
   this.SCD_SHAPE_CONNECTIONGrid_3Config.isChild = true;
   this.SCD_SHAPE_CONNECTIONGrid_3Config.masterSelector = 'app-scd-numeric-input-properties';
 ...
 if ( key != '') { 
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("ComponentConfig:ScdNumericInputPropertiesComponent:",ComponentConfig);
    if (typeof ComponentConfig !== "undefined"){
