  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (typeof ComponentConfig !== "undefined"){
      ...
      if (ComponentConfig.masterSaved != null)
      {
       ...
       this.SCD_SHAPE_INPUT_GENERALFormdivs_1Config.masterSaved = ComponentConfig.masterSaved;
       this.SCD_SHAPE_INPUT_APPEARANCEFormdivs_2Config.masterSaved = ComponentConfig.masterSaved;
