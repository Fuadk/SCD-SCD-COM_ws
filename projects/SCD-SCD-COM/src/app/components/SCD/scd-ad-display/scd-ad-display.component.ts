...
import { scddisplayScdAdDisplay , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-ad-display',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-ad-display.component.html',
  styleUrls: ['./scd-ad-display.component.scss'],
  standalone: false
})


export class ScdDisplayScdAdDisplayFormComponent {
  public title =  this.starServices.getNLS([],"SCD_AD_DISPLAY.scddisplayScdAdDisplay.component_title","Display");
  public compTitleMsg =  "SCD_AD_DISPLAY.scddisplayScdAdDisplay";
  public routineName = "ScdDisplayScdAdDisplayForm";
  ...
  public compSelector = 'app-scd-ad-display';
...
public disableDISPLAY_NAME = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scddisplayScdAdDisplay();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdDisplayScdAdDisplayForm form.APPLICATION_ID :' + form.APPLICATION_ID);
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdDisplayScdAdDisplayForm ComponentConfig:", {...ComponentConfig});
