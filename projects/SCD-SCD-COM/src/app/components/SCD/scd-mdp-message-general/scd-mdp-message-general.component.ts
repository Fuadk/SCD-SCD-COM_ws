...
import { scdmessageGeneralScdMdpMessageGeneral , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-mdp-message-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-mdp-message-general.component.html',
  styleUrls: ['./scd-mdp-message-general.component.scss'],
  standalone: false
})


export class ScdMessageGeneralScdMdpMessageGeneralFormComponent {
  public title =  this.starServices.getNLS([],"SCD_MDP_MESSAGE_GENERAL.scdmessageGeneralScdMdpMessageGeneral.component_title","Message General");
  public compTitleMsg =  "SCD_MDP_MESSAGE_GENERAL.scdmessageGeneralScdMdpMessageGeneral";
  public routineName = "ScdMessageGeneralScdMdpMessageGeneralForm";
  ...
  public compSelector = 'app-scd-mdp-message-general';
...
public visibleALIGNMENT = false;
public visibleWORD_WRAP = false;
public visibleMESSAGE_FILE = false;
public visibleUSE_VARIABLE_AS_MESSAGE_FILE = false;
public visibleUSE_ECHO_MESSAGE = false;
public visibleTIME_AND_DATE_FORMAT = false;
...
public disableTIME_AND_DATE_FORMAT = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdmessageGeneralScdMdpMessageGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdMessageGeneralScdMdpMessageGeneralForm form.SHAPE_ID :' + form.SHAPE_ID);
...
this.form.get('ALIGNMENT').valueChanges.subscribe(val => {
});
this.form.get('WORD_WRAP').valueChanges.subscribe(val => {
});
this.form.get('MESSAGE_FILE').valueChanges.subscribe(val => {
});
this.form.get('USE_VARIABLE_AS_MESSAGE_FILE').valueChanges.subscribe(val => {
});
this.form.get('USE_ECHO_MESSAGE').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdMessageGeneralScdMdpMessageGeneralForm ComponentConfig:", {...ComponentConfig});
