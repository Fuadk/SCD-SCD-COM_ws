...
import { scdgraphGeneralScdBgpGraphGeneral , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-bgp-graph-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-bgp-graph-general.component.html',
  styleUrls: ['./scd-bgp-graph-general.component.scss'],
  standalone: false
})


export class ScdGraphGeneralScdBgpGraphGeneralFormComponent {
  public title =  this.starServices.getNLS([],"SCD_BGP_GRAPH_GENERAL.scdgraphGeneralScdBgpGraphGeneral.component_title","Graph General");
  public compTitleMsg =  "SCD_BGP_GRAPH_GENERAL.scdgraphGeneralScdBgpGraphGeneral";
  public routineName = "ScdGraphGeneralScdBgpGraphGeneralForm";
  ...
  public compSelector = 'app-scd-bgp-graph-general';
...
public labelNEEDLE_WIDTHTop=false;
public labelNEEDLE_WIDTHVisible=true;
public labelNEEDLE_COLORTop=false;
...
public disableBLINK_2 = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdgraphGeneralScdBgpGraphGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdGraphGeneralScdBgpGraphGeneralForm form.SHAPE_ID :' + form.SHAPE_ID);
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdGraphGeneralScdBgpGraphGeneralForm ComponentConfig:", {...ComponentConfig});
