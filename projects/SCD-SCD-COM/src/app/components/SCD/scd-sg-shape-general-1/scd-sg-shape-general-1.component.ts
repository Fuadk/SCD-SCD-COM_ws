...
import { scdshapeGeneralScdSgShapeGeneral1 , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-sg-shape-general-1',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-sg-shape-general-1.component.html',
  styleUrls: ['./scd-sg-shape-general-1.component.scss'],
  standalone: false
})


export class ScdShapeGeneralScdSgShapeGeneral1FormComponent {
  public title =  this.starServices.getNLS([],"SCD_SG_SHAPE_GENERAL_1.scdshapeGeneralScdSgShapeGeneral1.component_title","Shape General");
  public compTitleMsg =  "SCD_SG_SHAPE_GENERAL_1.scdshapeGeneralScdSgShapeGeneral1";
  public routineName = "ScdShapeGeneralScdSgShapeGeneral1Form";
  ...
  public compSelector = 'app-scd-sg-shape-general-1';
  public PK_AUTO = 'SHAPE_GENERAL_ID';
  public customerFacing = false;
  public FormStepsArr = [] ;
public labelSHAPE_GENERAL_IDTop=false;
...
public disableBLINK = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdshapeGeneralScdSgShapeGeneral1();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdShapeGeneralScdSgShapeGeneral1Form form.SHAPE_ID :' + form.SHAPE_ID);
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdShapeGeneralScdSgShapeGeneral1Form ComponentConfig:", {...ComponentConfig});
