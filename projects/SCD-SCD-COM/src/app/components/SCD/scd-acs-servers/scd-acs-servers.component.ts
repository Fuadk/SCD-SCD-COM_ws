...
import { scdcommunicationSetupScdAcsServers , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-acs-servers',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-acs-servers.component.html',
  styleUrls: ['./scd-acs-servers.component.scss'],
  standalone: false
})


export class ScdCommunicationSetupScdAcsServersTreeComponent {
  public title =  this.starServices.getNLS([],"SCD_ACS_SERVERS.scdcommunicationSetupScdAcsServers.component_title","Servers");
  public compTitleMsg =  "SCD_ACS_SERVERS.scdcommunicationSetupScdAcsServers";
  public routineName = "ScdCommunicationSetupScdAcsServersTree";
  ...
  public primarKeyReadOnlyArr = {isCOMMUNICATION_SETUP_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-acs-servers';
...
public visibleSERVER_ID = true;
public visibleSERVER_NAME = true;
public visibleUPLOAD_ALL_EXTENDED_TAG_PROPERTIES = false;
public visiblePROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGS = false;
public visibleSHORTCUT_TYPE = false;
...
public disableSHORTCUT_TYPE = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdcommunicationSetupScdAcsServers();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdCommunicationSetupScdAcsServersTree form.APPLICATION_ID :' + form.APPLICATION_ID);
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdCommunicationSetupScdAcsServersTree ComponentConfig:", {...ComponentConfig});
...
public mapperFrom = {"Menu":"APPLICATION_ID","Item":"SERVER_NAME","Id":"SERVER_ID"};
