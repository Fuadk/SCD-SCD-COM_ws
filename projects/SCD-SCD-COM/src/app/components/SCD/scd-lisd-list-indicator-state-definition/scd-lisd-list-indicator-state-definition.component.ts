...
import { scdlistIndicatorStateScdLisdListIndicatorStateDefinition , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-lisd-list-indicator-state-definition',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-lisd-list-indicator-state-definition.component.html',
  styleUrls: ['./scd-lisd-list-indicator-state-definition.component.scss'],
  standalone: false
})


export class ScdListIndicatorStateScdLisdListIndicatorStateDefinitionFormdivsComponent {
  public title =  this.starServices.getNLS([],"SCD_LISD_LIST_INDICATOR_STATE_DEFINITION.scdlistIndicatorStateScdLisdListIndicatorStateDefinition.component_title","List Indicator State Definition");
  public compTitleMsg =  "SCD_LISD_LIST_INDICATOR_STATE_DEFINITION.scdlistIndicatorStateScdLisdListIndicatorStateDefinition";
  public routineName = "ScdListIndicatorStateScdLisdListIndicatorStateDefinitionFormdivs";
  ...
  public compSelector = 'app-scd-lisd-list-indicator-state-definition';
  public PK_AUTO = 'LIST_INDICATOR_STATE_ID';
  public customerFacing = false;
  public FormStepsArr = [{"CODE":"","CODETEXT_LANG":"","visible":true},{"CODE":"1","CODETEXT_LANG":"General","visible":true},{"CODE":"2","CODETEXT_LANG":"Caption","visible":true}] ;
public labelLIST_INDICATOR_STATE_IDTop=true;
...
public labelSTATE_NAMETop=true;
public labelSTATE_NAMEVisible=true;
public labelVALUETop=true;
...
public disableCAPTION_ALIGNMENT = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdlistIndicatorStateScdLisdListIndicatorStateDefinition();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdListIndicatorStateScdLisdListIndicatorStateDefinitionFormdivs form.SHAPE_ID :' + form.SHAPE_ID);
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdListIndicatorStateScdLisdListIndicatorStateDefinitionFormdivs ComponentConfig:", {...ComponentConfig});
