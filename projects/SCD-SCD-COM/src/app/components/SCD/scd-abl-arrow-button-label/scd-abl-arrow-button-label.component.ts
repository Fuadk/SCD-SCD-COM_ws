...
import { scdarrowButtonLabelScdAblArrowButtonLabel , componentConfigDef} from '@modeldir/model';


 const createFormGroup = (dataItem:any) => new FormGroup({
'ARROW_BUTTON_LABEL_ID' : new FormControl(dataItem.ARROW_BUTTON_LABEL_ID  , ) ,
...
'IMAGE_BACK_STYLE' : new FormControl(dataItem.IMAGE_BACK_STYLE  , ) ,
...
@Component({
  selector: 'app-scd-abl-arrow-button-label',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-abl-arrow-button-label.component.html',
  styleUrls: ['./scd-abl-arrow-button-label.component.scss'],
  standalone: false
})


export class ScdArrowButtonLabelScdAblArrowButtonLabelFormdivsComponent {
  public title =  this.starServices.getNLS([],"SCD_ABL_ARROW_BUTTON_LABEL.scdarrowButtonLabelScdAblArrowButtonLabel.component_title","Arrow Button Label");
  public compTitleMsg =  "SCD_ABL_ARROW_BUTTON_LABEL.scdarrowButtonLabelScdAblArrowButtonLabel";
  public routineName = "ScdArrowButtonLabelScdAblArrowButtonLabelFormdivs";
  private insertCMD = "INSERT_SCD_ARROW_BUTTON_LABEL";
  private updateCMD = "UPDATE_SCD_ARROW_BUTTON_LABEL";
  private deleteCMD =   "DELETE_SCD_ARROW_BUTTON_LABEL";
  private getCMD = "GET_SCD_ARROW_BUTTON_LABEL_QUERY";
  ...
  public primarKeyReadOnlyArr = {isARROW_BUTTON_LABEL_IDreadOnly : false , isSHAPE_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-abl-arrow-button-label';
  public PK_AUTO = 'ARROW_BUTTON_LABEL_ID';
  public customerFacing = false;
  public FormStepsArr = [{"CODE":"","CODETEXT_LANG":"","visible":true},{"CODE":"1","CODETEXT_LANG":"Caption","visible":true},{"CODE":"2","CODETEXT_LANG":"Image Settings","visible":true}] ;
public labelARROW_BUTTON_LABEL_IDTop=true;
public labelARROW_BUTTON_LABEL_IDVisible=true;
...
public visibleIMAGE_SELECT_ABL = true;
public visibleIMAGE_NAME = true;
public visibleIMAGE_BACK_STYLE = true;
...
public disableARROW_BUTTON_LABEL_ID = false;
...
public disableIMAGE_SELECT_ABL = false;
public disableIMAGE_NAME = false;
public disableIMAGE_BACK_STYLE = false;
...
public variableIMAGE_SELECT_ABL;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdarrowButtonLabelScdAblArrowButtonLabel();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdArrowButtonLabelScdAblArrowButtonLabelFormdivs form.SHAPE_ID :' + form.SHAPE_ID);
  ...
  async  enterQuery (form : any){
    ...
    async callBackPost_Insert(NewVal:any) {
      ...
      this.Comp_Config.masterKeyArr =  [NewVal['ARROW_BUTTON_LABEL_ID']];
      this.Comp_Config.masterKeyNameArr =  ["ARROW_BUTTON_LABEL_ID"];
...
this.lookupArrDef =[	{"statment":"SELECT SHAPE_ID CODE, NAME CODETEXT_LANG  FROM SCD_SHAPE  order by CODETEXT_LANG ",
	...
	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"IMAGE_BACK_STYLE\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
			"lkpArrName":"lkpArrIMAGE_BACK_STYLE"},
...
public lkpArrGetIMAGE_BACK_STYLE(CODE: any): any {
var rec = this.lkpArrIMAGE_BACK_STYLE.find((x:any) => x.CODE === CODE);
return rec;
}
...
onChanges(): void {
this.form.get('ARROW_BUTTON_LABEL_ID').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdArrowButtonLabelScdAblArrowButtonLabelFormdivs ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_ARROW_BUTTON_LABEL_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['ARROW_BUTTON_LABEL_ID'] != "undefined" ) 
      this.form.controls['ARROW_BUTTON_LABEL_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['ARROW_BUTTON_LABEL_ID'] != "undefined" ) 
     this.form.get('ARROW_BUTTON_LABEL_ID').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_ARROW_BUTTON_LABEL_ID(event){
...
async WHEN_VALIDATE_ITEM_IMAGE_SELECT_ABL(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['IMAGE_SELECT_ABL'] != "undefined" ) 
      this.form.controls['IMAGE_SELECT_ABL'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['IMAGE_SELECT_ABL'] != "undefined" ) 
     this.form.get('IMAGE_SELECT_ABL').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_IMAGE_SELECT_ABL(event){
...
async WHEN_VALIDATE_ITEM_IMAGE_BACK_STYLE(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['IMAGE_BACK_STYLE'] != "undefined" ) 
      this.form.controls['IMAGE_BACK_STYLE'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['IMAGE_BACK_STYLE'] != "undefined" ) 
     this.form.get('IMAGE_BACK_STYLE').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_IMAGE_BACK_STYLE(event){
...
async WHEN_VALIDATE_ITEM_IMAGE_ALIGNMENT(value) {
 ...
 async onChange_ARROW_BUTTON_LABEL_ID(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_ARROW_BUTTON_LABEL_ID(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onValueChange_IMAGE_SELECT_ABL(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 await this.WHEN_VALIDATE_ITEM_IMAGE_SELECT_ABL(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onValueChange_IMAGE_BACK_STYLE(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 await this.WHEN_VALIDATE_ITEM_IMAGE_BACK_STYLE(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
