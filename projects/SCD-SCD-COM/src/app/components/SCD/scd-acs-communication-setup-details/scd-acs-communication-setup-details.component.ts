...
import { scdcommunicationSetupScdAcsCommunicationSetupDetails , componentConfigDef} from '@modeldir/model';


 const createFormGroup = (dataItem:any) => new FormGroup({
'COMMUNICATION_SETUP_ID' : new FormControl(dataItem.COMMUNICATION_SETUP_ID  , ) ,
'APPLICATION_ID' : new FormControl(dataItem.APPLICATION_ID  ,   Validators.required ) ,
'SERVER_ID' : new FormControl(dataItem.SERVER_ID  ,   Validators.required ) ,
'SERVER_NAME' : new FormControl(dataItem.SERVER_NAME  , ) ,
'UPLOAD_ALL_EXTENDED_TAG_PROPERTIES' : new FormControl(dataItem.UPLOAD_ALL_EXTENDED_TAG_PROPERTIES  , ) ,
'PROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGS' : new FormControl(dataItem.PROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGS  , ) ,
'SHORTCUT_TYPE' : new FormControl(dataItem.SHORTCUT_TYPE  , ) 
});

declare function getParamConfig():any;
@Component({
  selector: 'app-scd-acs-communication-setup-details',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-acs-communication-setup-details.component.html',
  styleUrls: ['./scd-acs-communication-setup-details.component.scss'],
  standalone: false
})


export class ScdCommunicationSetupScdAcsCommunicationSetupDetailsFormComponent {
  public title =  this.starServices.getNLS([],"SCD_ACS_COMMUNICATION_SETUP_DETAILS.scdcommunicationSetupScdAcsCommunicationSetupDetails.component_title","Communication Setup Details");
  public compTitleMsg =  "SCD_ACS_COMMUNICATION_SETUP_DETAILS.scdcommunicationSetupScdAcsCommunicationSetupDetails";
  public routineName = "ScdCommunicationSetupScdAcsCommunicationSetupDetailsForm";
  private insertCMD = "INSERT_SCD_COMMUNICATION_SETUP";
  private updateCMD = "UPDATE_SCD_COMMUNICATION_SETUP";
  private deleteCMD =   "DELETE_SCD_COMMUNICATION_SETUP";
  private getCMD = "GET_SCD_COMMUNICATION_SETUP_QUERY";
  ...
  public primarKeyReadOnlyArr = {isCOMMUNICATION_SETUP_IDreadOnly : false , isAPPLICATION_IDreadOnly : false , isSERVER_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-acs-communication-setup-details';
  public PK_AUTO = 'COMMUNICATION_SETUP_ID';
  public customerFacing = false;
  public FormStepsArr = [] ;
public labelCOMMUNICATION_SETUP_IDTop=false;
public labelCOMMUNICATION_SETUP_IDVisible=true;
public labelAPPLICATION_IDTop=false;
public labelAPPLICATION_IDVisible=true;
public labelSERVER_IDTop=false;
public labelSERVER_IDVisible=true;
public labelSERVER_NAMETop=false;
public labelSERVER_NAMEVisible=true;
public labelUPLOAD_ALL_EXTENDED_TAG_PROPERTIESTop=false;
public labelUPLOAD_ALL_EXTENDED_TAG_PROPERTIESVisible=true;
public labelPROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGSTop=false;
public labelPROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGSVisible=true;
public labelSHORTCUT_TYPETop=false;
public labelSHORTCUT_TYPEVisible=true;

public visibleCOMMUNICATION_SETUP_ID = false;
public visibleAPPLICATION_ID = false;
public visibleSERVER_ID = false;
public visibleSERVER_NAME = true;
public visibleUPLOAD_ALL_EXTENDED_TAG_PROPERTIES = true;
public visiblePROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGS = true;
public visibleSHORTCUT_TYPE = true;

public disableCOMMUNICATION_SETUP_ID = false;
public disableAPPLICATION_ID = false;
public disableSERVER_ID = false;
public disableSERVER_NAME = false;
public disableUPLOAD_ALL_EXTENDED_TAG_PROPERTIES = false;
public disablePROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGS = false;
public disableSHORTCUT_TYPE = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdcommunicationSetupScdAcsCommunicationSetupDetails();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdCommunicationSetupScdAcsCommunicationSetupDetailsForm form.APPLICATION_ID :' + form.APPLICATION_ID);
  ...
  async  enterQuery (form : any){
    ...
    async callBackPost_Insert(NewVal:any) {
      ...
      this.Comp_Config.masterKeyArr =  [NewVal['COMMUNICATION_SETUP_ID']];
      this.Comp_Config.masterKeyNameArr =  ["COMMUNICATION_SETUP_ID"];
...
this.lookupArrDef =[	{"statment":"SELECT APPLICATION_ID CODE, APPLICATION_NAME CODETEXT_LANG  FROM SCD_APPLICATION  order by CODETEXT_LANG ",
	...
	{"statment":"SELECT OPCUA_SERVER_ID CODE, SERVER_NAME CODETEXT_LANG  FROM SCD_OPCUA_SERVER  order by CODETEXT_LANG ",
			"lkpArrName":"lkpArrSERVER_ID"},
	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"SHORTCUT_TYPE\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
			"lkpArrName":"lkpArrSHORTCUT_TYPE"}];
...
public lkpArrSERVER_ID = [];

public lkpArrSHORTCUT_TYPE = [];
...
public lkpArrGetSERVER_ID(CODE: any): any {
var rec = this.lkpArrSERVER_ID.find((x:any) => x.CODE === CODE);
return rec;
}

public lkpArrGetSHORTCUT_TYPE(CODE: any): any {
var rec = this.lkpArrSHORTCUT_TYPE.find((x:any) => x.CODE === CODE);
return rec;
}

onChanges(): void {
this.form.get('COMMUNICATION_SETUP_ID').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdCommunicationSetupScdAcsCommunicationSetupDetailsForm ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_COMMUNICATION_SETUP_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['COMMUNICATION_SETUP_ID'] != "undefined" ) 
      this.form.controls['COMMUNICATION_SETUP_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['COMMUNICATION_SETUP_ID'] != "undefined" ) 
     this.form.get('COMMUNICATION_SETUP_ID').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_COMMUNICATION_SETUP_ID(event){
...
async WHEN_VALIDATE_ITEM_SERVER_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['SERVER_ID'] != "undefined" ) 
      this.form.controls['SERVER_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['SERVER_ID'] != "undefined" ) 
     this.form.get('SERVER_ID').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_SERVER_ID(event){
...
async WHEN_VALIDATE_ITEM_UPLOAD_ALL_EXTENDED_TAG_PROPERTIES(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['UPLOAD_ALL_EXTENDED_TAG_PROPERTIES'] != "undefined" ) 
      this.form.controls['UPLOAD_ALL_EXTENDED_TAG_PROPERTIES'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['UPLOAD_ALL_EXTENDED_TAG_PROPERTIES'] != "undefined" ) 
     this.form.get('UPLOAD_ALL_EXTENDED_TAG_PROPERTIES').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_UPLOAD_ALL_EXTENDED_TAG_PROPERTIES(event){

}

async WHEN_VALIDATE_ITEM_PROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGS(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['PROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGS'] != "undefined" ) 
      this.form.controls['PROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGS'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['PROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGS'] != "undefined" ) 
     this.form.get('PROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGS').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_PROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGS(event){

}

async WHEN_VALIDATE_ITEM_SHORTCUT_TYPE(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['SHORTCUT_TYPE'] != "undefined" ) 
      this.form.controls['SHORTCUT_TYPE'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['SHORTCUT_TYPE'] != "undefined" ) 
     this.form.get('SHORTCUT_TYPE').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_SHORTCUT_TYPE(event){

}
 
 async onChange_COMMUNICATION_SETUP_ID(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_COMMUNICATION_SETUP_ID(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onValueChange_SERVER_ID(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 await this.WHEN_VALIDATE_ITEM_SERVER_ID(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onChange_UPLOAD_ALL_EXTENDED_TAG_PROPERTIES(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_UPLOAD_ALL_EXTENDED_TAG_PROPERTIES(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
  
 } 
 async onChange_PROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGS(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_PROVIDE_PASS_THROUGH_DESCRIPTION_FOR_TAGS(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
  
 } 
 async onValueChange_SHORTCUT_TYPE(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 await this.WHEN_VALIDATE_ITEM_SHORTCUT_TYPE(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
