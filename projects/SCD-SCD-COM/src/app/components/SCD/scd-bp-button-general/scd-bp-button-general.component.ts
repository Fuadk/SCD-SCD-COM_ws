...
import { scdbuttonGeneralScdBpButtonGeneral , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-bp-button-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-bp-button-general.component.html',
  styleUrls: ['./scd-bp-button-general.component.scss'],
  standalone: false
})


export class ScdButtonGeneralScdBpButtonGeneralFormComponent {
  public title =  this.starServices.getNLS([],"SCD_BP_BUTTON_GENERAL.scdbuttonGeneralScdBpButtonGeneral.component_title","Button General");
  public compTitleMsg =  "SCD_BP_BUTTON_GENERAL.scdbuttonGeneralScdBpButtonGeneral";
  public routineName = "ScdButtonGeneralScdBpButtonGeneralForm";
  ...
  public compSelector = 'app-scd-bp-button-general';
...
public visibleCAPTURE_CURSOR = false;
public visibleHIGHLIGHT_WHEN_OBJECT_HAS_FOCUS = false;
...
public disableTAB_INDEX = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdbuttonGeneralScdBpButtonGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdButtonGeneralScdBpButtonGeneralForm form.SHAPE_ID :' + form.SHAPE_ID);
...
this.form.get('BUTTON_STYLE').valueChanges.subscribe(val => {
});
this.form.get('WIDTH').valueChanges.subscribe(val => {
});
this.form.get('CAPTURE_CURSOR').valueChanges.subscribe(val => {
});
this.form.get('HIGHLIGHT_WHEN_OBJECT_HAS_FOCUS').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdButtonGeneralScdBpButtonGeneralForm ComponentConfig:", {...ComponentConfig});
