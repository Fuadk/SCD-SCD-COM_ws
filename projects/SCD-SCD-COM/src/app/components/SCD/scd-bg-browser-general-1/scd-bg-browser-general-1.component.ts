...
import { scdbrowserGeneralScdBgBrowserGeneral1 , componentConfigDef} from '@modeldir/model';


 const createFormGroup = (dataItem:any) => new FormGroup({
'BROWSER_GENERAL_ID' : new FormControl(dataItem.BROWSER_GENERAL_ID  , ) ,
'SHAPE_ID' : new FormControl(dataItem.SHAPE_ID  ,   Validators.required ) ,
'SHOW_ADDRESS_BAR' : new FormControl(dataItem.SHOW_ADDRESS_BAR  , ) ,
'INITIAL_URL' : new FormControl(dataItem.INITIAL_URL  , ) ,
'USE_PARAMETER_PLACEHOLDER' : new FormControl(dataItem.USE_PARAMETER_PLACEHOLDER  , ) 
});

declare function getParamConfig():any;
@Component({
  selector: 'app-scd-bg-browser-general-1',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-bg-browser-general-1.component.html',
  styleUrls: ['./scd-bg-browser-general-1.component.scss'],
  standalone: false
})


export class ScdBrowserGeneralScdBgBrowserGeneral1FormComponent {
  public title =  this.starServices.getNLS([],"SCD_BG_BROWSER_GENERAL_1.scdbrowserGeneralScdBgBrowserGeneral1.component_title","Browser General");
  public compTitleMsg =  "SCD_BG_BROWSER_GENERAL_1.scdbrowserGeneralScdBgBrowserGeneral1";
  public routineName = "ScdBrowserGeneralScdBgBrowserGeneral1Form";
  private insertCMD = "INSERT_SCD_BROWSER_GENERAL";
  private updateCMD = "UPDATE_SCD_BROWSER_GENERAL";
  private deleteCMD =   "DELETE_SCD_BROWSER_GENERAL";
  private getCMD = "GET_SCD_BROWSER_GENERAL_QUERY";
  ...
  public primarKeyReadOnlyArr = {isBROWSER_GENERAL_IDreadOnly : false , isSHAPE_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-bg-browser-general-1';
  public PK_AUTO = 'BROWSER_GENERAL_ID';
  public customerFacing = false;
  public FormStepsArr = [] ;
public labelBROWSER_GENERAL_IDTop=false;
public labelBROWSER_GENERAL_IDVisible=true;
public labelSHAPE_IDTop=false;
public labelSHAPE_IDVisible=true;
public labelSHOW_ADDRESS_BARTop=false;
public labelSHOW_ADDRESS_BARVisible=true;
public labelINITIAL_URLTop=false;
public labelINITIAL_URLVisible=true;
public labelUSE_PARAMETER_PLACEHOLDERTop=false;
public labelUSE_PARAMETER_PLACEHOLDERVisible=true;

public visibleBROWSER_GENERAL_ID = false;
public visibleSHAPE_ID = false;
public visibleSHOW_ADDRESS_BAR = true;
public visibleINITIAL_URL = true;
public visibleUSE_PARAMETER_PLACEHOLDER = false;

public disableBROWSER_GENERAL_ID = false;
public disableSHAPE_ID = false;
public disableSHOW_ADDRESS_BAR = false;
public disableINITIAL_URL = false;
public disableUSE_PARAMETER_PLACEHOLDER = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdbrowserGeneralScdBgBrowserGeneral1();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdBrowserGeneralScdBgBrowserGeneral1Form form.SHAPE_ID :' + form.SHAPE_ID);
  ...
  async  enterQuery (form : any){
    ...
    async callBackPost_Insert(NewVal:any) {
      ...
      this.Comp_Config.masterKeyArr =  [NewVal['BROWSER_GENERAL_ID']];
      this.Comp_Config.masterKeyNameArr =  ["BROWSER_GENERAL_ID"];
...
onChanges(): void {
this.form.get('BROWSER_GENERAL_ID').valueChanges.subscribe(val => {
});
this.form.get('SHOW_ADDRESS_BAR').valueChanges.subscribe(val => {
});
this.form.get('INITIAL_URL').valueChanges.subscribe(val => {
});
this.form.get('USE_PARAMETER_PLACEHOLDER').valueChanges.subscribe(val => {
});
}
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdBrowserGeneralScdBgBrowserGeneral1Form ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_BROWSER_GENERAL_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['BROWSER_GENERAL_ID'] != "undefined" ) 
      this.form.controls['BROWSER_GENERAL_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['BROWSER_GENERAL_ID'] != "undefined" ) 
     this.form.get('BROWSER_GENERAL_ID').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_BROWSER_GENERAL_ID(event){
...
async WHEN_VALIDATE_ITEM_SHOW_ADDRESS_BAR(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['SHOW_ADDRESS_BAR'] != "undefined" ) 
      this.form.controls['SHOW_ADDRESS_BAR'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['SHOW_ADDRESS_BAR'] != "undefined" ) 
     this.form.get('SHOW_ADDRESS_BAR').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_SHOW_ADDRESS_BAR(event){

}

async WHEN_VALIDATE_ITEM_INITIAL_URL(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['INITIAL_URL'] != "undefined" ) 
      this.form.controls['INITIAL_URL'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['INITIAL_URL'] != "undefined" ) 
     this.form.get('INITIAL_URL').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_INITIAL_URL(event){

}

async WHEN_VALIDATE_ITEM_USE_PARAMETER_PLACEHOLDER(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['USE_PARAMETER_PLACEHOLDER'] != "undefined" ) 
      this.form.controls['USE_PARAMETER_PLACEHOLDER'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['USE_PARAMETER_PLACEHOLDER'] != "undefined" ) 
     this.form.get('USE_PARAMETER_PLACEHOLDER').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_USE_PARAMETER_PLACEHOLDER(event){

}
 
 async onChange_BROWSER_GENERAL_ID(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_BROWSER_GENERAL_ID(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onChange_SHOW_ADDRESS_BAR(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_SHOW_ADDRESS_BAR(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
  
 } 
 async onChange_INITIAL_URL(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_INITIAL_URL(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
  
 } 
 async onChange_USE_PARAMETER_PLACEHOLDER(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_USE_PARAMETER_PLACEHOLDER(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
