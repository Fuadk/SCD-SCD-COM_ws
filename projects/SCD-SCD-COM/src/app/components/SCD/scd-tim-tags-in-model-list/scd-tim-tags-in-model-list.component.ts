...
import {   scdtagInModelScdTimTagsInModelList , componentConfigDef } from '@modeldir/model';
...
@Component({
  selector: 'app-scd-tim-tags-in-model-list',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-tim-tags-in-model-list.component.html',
  standalone: false,
  styleUrls: ['./scd-tim-tags-in-model-list.component.scss'
],
...
export class ScdTagInModelScdTimTagsInModelListGridComponent implements OnInit,OnDestroy {
 ...
 public showToolBar = true;
  ...
  public isMaster: boolean = false;
  	...
  	public  isTAG_IN_MODEL_IDEnable : boolean = true; 
  ...
  public title =  this.starServices.getNLS([],"SCD_TIM_TAGS_IN_MODEL_LIST.scdtagInModelScdTimTagsInModelList.component_title","Tags in Model List");
  public PDFfileName = this.title + ".PDF";
  public ExcelfileName = this.title + ".xlsx";
  public componentConfig
  public compTitleMsg =  "SCD_TIM_TAGS_IN_MODEL_LIST.scdtagInModelScdTimTagsInModelList";
  ...
  public primarKeyReadOnlyArr = {isTAG_IN_MODEL_IDreadOnly : false};  
  public paramConfig;
...
public compSelector = 'app-scd-tim-tags-in-model-list';
  ...
  @Output() formValidationChangedOutput: EventEmitter<boolean> = new EventEmitter();
    ...
    constructor(public router: Router,public intl: IntlService, public responsive: BreakpointObserver, private starNotify: StarNotifyService,   public starServices: starServices, private renderer: Renderer2) {
      ...
      this.title = this.componentConfig.title ? this.componentConfig.title :this.starServices.getNLS([],"SCD_TIM_TAGS_IN_MODEL_LIST.scdtagInModelScdTimTagsInModelList.component_title","Tags in Model List");
  }
...
//Next part for filtering
  ...
  private gridInitialValues:any = new scdtagInModelScdTimTagsInModelList();   
  ...
  public commonCallStarNotify(data:any) {
    ...
    let masterParams = {
      data: this.masterKeyArr
       ...
       let masterKeyArr = [data['TAG_IN_MODEL_ID']];
      let masterKeyNameArr = ['TAG_IN_MODEL_ID'];
      //for (let i = 0; i < masterKeyNameArr.length; i++) {
      //  componentConfig.[masterKeyNameArr[i]] = masterKeyArr[i];
      //}
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ScdTagInModelScdTimTagsInModelListGrid ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_TAG_IN_MODEL_ID(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['TAG_IN_MODEL_ID'] != "undefined" ) 
      this.formGroup.controls['TAG_IN_MODEL_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['TAG_IN_MODEL_ID'] != "undefined" ) 
     this.formGroup.get('TAG_IN_MODEL_ID').updateValueAndValidity();
...
async WHEN_VALIDATE_ITEM_TAG_TYPE(formGroup) {
 ...
 async onBlur_TAG_IN_MODEL_ID() { 
  await this.WHEN_VALIDATE_ITEM_TAG_IN_MODEL_ID(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 ...
 async valueChangeTAG_ID(value: any) { 
