...
import { scdapplicationScdAdApplication , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-ad-application',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-ad-application.component.html',
  styleUrls: ['./scd-ad-application.component.scss'],
  standalone: false
})


export class ScdApplicationScdAdApplicationFormComponent {
  public title =  this.starServices.getNLS([],"SCD_AD_APPLICATION.scdapplicationScdAdApplication.component_title","Application");
  public compTitleMsg =  "SCD_AD_APPLICATION.scdapplicationScdAdApplication";
  public routineName = "ScdApplicationScdAdApplicationForm";
  private insertCMD = "INSERT_SCD_APPLICATION";
  private updateCMD = "UPDATE_SCD_APPLICATION";
  private deleteCMD =   "DELETE_SCD_APPLICATION";
  private getCMD = "GET_SCD_APPLICATION_QUERY";
  ...
  public primarKeyReadOnlyArr = {isAPPLICATION_IDreadOnly : false};  
  public paramConfig;
...
public disableAPP_LANGUAGE = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdapplicationScdAdApplication();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdApplicationScdAdApplicationForm form.APPLICATION_ID :' + form.APPLICATION_ID);
  ...
  async  enterQuery (form : any){
    ...
    async callBackPost_Insert(NewVal:any) {
      ...
      this.Comp_Config.masterKeyArr =  [NewVal['APPLICATION_ID']];
      this.Comp_Config.masterKeyNameArr =  ["APPLICATION_ID"];
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdApplicationScdAdApplicationForm ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_APP_LANGUAGE(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['APP_LANGUAGE'] != "undefined" ) 
      this.form.controls['APP_LANGUAGE'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['APP_LANGUAGE'] != "undefined" ) 
     this.form.get('APP_LANGUAGE').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_APP_LANGUAGE(event){
 ...
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_APPLICATION_NAME(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
