...
import { scdlistIndicatorStateScdLispListIndicatorStateDefinition , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-lisp-list-indicator-state-definition',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-lisp-list-indicator-state-definition.component.html',
  styleUrls: ['./scd-lisp-list-indicator-state-definition.component.scss'],
  standalone: false
})


export class ScdListIndicatorStateScdLispListIndicatorStateDefinitionFormComponent {
  public title =  this.starServices.getNLS([],"SCD_LISP_LIST_INDICATOR_STATE_DEFINITION.scdlistIndicatorStateScdLispListIndicatorStateDefinition.component_title","List Indicator State Definition");
  public compTitleMsg =  "SCD_LISP_LIST_INDICATOR_STATE_DEFINITION.scdlistIndicatorStateScdLispListIndicatorStateDefinition";
  public routineName = "ScdListIndicatorStateScdLispListIndicatorStateDefinitionForm";
  ...
  public primarKeyReadOnlyArr = {isLIST_INDICATOR_STATE_IDreadOnly : false , isSHAPE_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-lisp-list-indicator-state-definition';
  public PK_AUTO = 'LIST_INDICATOR_STATE_ID';
  public customerFacing = false;
  public FormStepsArr = [] ;
public labelLIST_INDICATOR_STATE_IDTop=false;
public labelLIST_INDICATOR_STATE_IDVisible=true;
...
public disableLIST_INDICATOR_STATE_ID = false;
...
public disableCAPTION_ALIGNMENT = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdlistIndicatorStateScdLispListIndicatorStateDefinition();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdListIndicatorStateScdLispListIndicatorStateDefinitionForm form.SHAPE_ID :' + form.SHAPE_ID);
  ...
  async  enterQuery (form : any){
    ...
    async callBackPost_Insert(NewVal:any) {
      ...
      this.Comp_Config.masterKeyArr =  [NewVal['LIST_INDICATOR_STATE_ID']];
      this.Comp_Config.masterKeyNameArr =  ["LIST_INDICATOR_STATE_ID"];
...
onChanges(): void {
this.form.get('LIST_INDICATOR_STATE_ID').valueChanges.subscribe(val => {
});
...
this.form.get('CAPTION_COLOR').valueChanges.subscribe(val => {
});
this.form.get('CAPTION_BACK_STYLE').valueChanges.subscribe(val => {
});
this.form.get('CAPTION_BACK_COLOR').valueChanges.subscribe(val => {
});
this.form.get('CAPTION_BLINK').valueChanges.subscribe(val => {
});
this.form.get('CAPTION_ALIGNMENT').valueChanges.subscribe(val => {
});
}
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdListIndicatorStateScdLispListIndicatorStateDefinitionForm ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_LIST_INDICATOR_STATE_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['LIST_INDICATOR_STATE_ID'] != "undefined" ) 
      this.form.controls['LIST_INDICATOR_STATE_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['LIST_INDICATOR_STATE_ID'] != "undefined" ) 
     this.form.get('LIST_INDICATOR_STATE_ID').updateValueAndValidity();
...
async WHEN_VALIDATE_ITEM_CAPTION_ALIGNMENT(value) {
 ...
 async onChange_LIST_INDICATOR_STATE_ID(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_LIST_INDICATOR_STATE_ID(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onChange_CAPTION_COLOR(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 ...
 async onChange_CAPTION_BACK_STYLE(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 ...
 async onChange_CAPTION_BACK_COLOR(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
