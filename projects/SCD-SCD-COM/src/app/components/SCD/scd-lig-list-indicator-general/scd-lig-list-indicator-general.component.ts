...
import { scdlistIndicatorGeneralScdLigListIndicatorGeneral , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-lig-list-indicator-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-lig-list-indicator-general.component.html',
  styleUrls: ['./scd-lig-list-indicator-general.component.scss'],
  standalone: false
})


export class ScdListIndicatorGeneralScdLigListIndicatorGeneralFormdivsComponent {
  public title =  this.starServices.getNLS([],"SCD_LIG_LIST_INDICATOR_GENERAL.scdlistIndicatorGeneralScdLigListIndicatorGeneral.component_title","List Indicator General");
  public compTitleMsg =  "SCD_LIG_LIST_INDICATOR_GENERAL.scdlistIndicatorGeneralScdLigListIndicatorGeneral";
  public routineName = "ScdListIndicatorGeneralScdLigListIndicatorGeneralFormdivs";
  ...
  public compSelector = 'app-scd-lig-list-indicator-general';
  public PK_AUTO = 'LIST_INDICATOR_GENERAL_ID';
  public customerFacing = false;
  public FormStepsArr = [{"CODE":"","CODETEXT_LANG":"","visible":true},{"CODE":"1","CODETEXT_LANG":"Appearance","visible":true},{"CODE":"2","CODETEXT_LANG":"Text","visible":true},{"CODE":"3","CODETEXT_LANG":"State Settings","visible":true},{"CODE":"4","CODETEXT_LANG":"Other","visible":true}] ;
public labelLIST_INDICATOR_GENERAL_IDTop=true;
...
public labelSELECTION_FORE_COLORTop=true;
public labelSELECTION_FORE_COLORVisible=true;
public labelSELECTION_BACK_COLORTop=true;
...
public labelCAPTION_TRUNCATETop=true;
...
public labelWRITE_ON_ENTERTop=true;
...
public labelWRAP_AROUNDTop=true;
...
public visibleCAPTION_TRUNCATE = true;
public visibleNUMBER_OF_STATES = true;
public visibleTRIGGER_TYPE = true;
public visibleWRITE_ON_ENTER = true;
public visibleTAB_INDEX = true;
public visibleKEY_NAVIGATION = true;
public visibleWRAP_AROUND = true;
...
public disableWRAP_AROUND = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdlistIndicatorGeneralScdLigListIndicatorGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdListIndicatorGeneralScdLigListIndicatorGeneralFormdivs form.SHAPE_ID :' + form.SHAPE_ID);
...
public lkpArrGetCAPTION_TRUNCATE(CODE: any): any {
var rec = this.lkpArrCAPTION_TRUNCATE.find((x:any) => x.CODE === CODE);
return rec;
}
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdListIndicatorGeneralScdLigListIndicatorGeneralFormdivs ComponentConfig:", {...ComponentConfig});
  ...
  async WHEN_NOTIFY(ComponentConfig){
    ...
    if (masterSelector.includes("indicator")) {
        this.generalMode = "INDICATOR";
        //alert(this.generalMode);
    }
    else if (masterSelector.includes("display")) {
        this.generalMode = "DISPLAY";
        //alert(this.generalMode);
    }
    else if (masterSelector.includes("piloted")) {
        this.generalMode = "PILOTED";
        //alert(this.generalMode);
    }
    else if (masterSelector.includes("control")) {
        this.generalMode = "CONTROL";
        //alert(this.generalMode);
    }
    switch (this.generalMode) {
        case 'INDICATOR':
            ...
            break;
        case 'DISPLAY':
            this.visibleTRIGGER_TYPE = false;
            this.visibleWRITE_ON_ENTER = false
            //alert(this.generalMode);
            break;
        case 'PILOTED':
            this.visibleTRIGGER_TYPE = false;
