...
import {   scdalarmScdAaAlarmsList , componentConfigDef } from '@modeldir/model';
...
@Component({
  selector: 'app-scd-aa-alarms-list',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-aa-alarms-list.component.html',
  standalone: false,
  styleUrls: ['./scd-aa-alarms-list.component.scss'
],
...
export class ScdAlarmScdAaAlarmsListGridComponent implements OnInit,OnDestroy {
 ...
 public showToolBar = true;
  ...
  public isMaster: boolean = false;
  		...
  		public  isALARM_IDEnable : boolean = true; 
public  isAPPLICATION_IDEnable : boolean = true; 
  ...
  public title =  this.starServices.getNLS([],"SCD_AA_ALARMS_LIST.scdalarmScdAaAlarmsList.component_title","Alarms List");
  public PDFfileName = this.title + ".PDF";
  public ExcelfileName = this.title + ".xlsx";
  public componentConfig
  public compTitleMsg =  "SCD_AA_ALARMS_LIST.scdalarmScdAaAlarmsList";
...
public compSelector = 'app-scd-aa-alarms-list';
  ...
  @Output() formValidationChangedOutput: EventEmitter<boolean> = new EventEmitter();
    ...
    constructor(public router: Router,public intl: IntlService, public responsive: BreakpointObserver, private starNotify: StarNotifyService,   public starServices: starServices, private renderer: Renderer2) {
      ...
      this.title = this.componentConfig.title ? this.componentConfig.title :this.starServices.getNLS([],"SCD_AA_ALARMS_LIST.scdalarmScdAaAlarmsList.component_title","Alarms List");
  }
...
//Next part for filtering
  ...
  private gridInitialValues:any = new scdalarmScdAaAlarmsList();   
  ...
  public commonCallStarNotify(data:any) {
    ...
    let masterParams = {
      data: this.masterKeyArr
       ...
       let masterKeyArr = [data['APPLICATION_ID'],data['ALARM_ID']];
      let masterKeyNameArr = ['APPLICATION_ID','ALARM_ID'];
      //for (let i = 0; i < masterKeyNameArr.length; i++) {
      //  componentConfig.[masterKeyNameArr[i]] = masterKeyArr[i];
      //}
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ScdAlarmScdAaAlarmsListGrid ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_ALARM_ID(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['ALARM_ID'] != "undefined" ) 
      this.formGroup.controls['ALARM_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['ALARM_ID'] != "undefined" ) 
     this.formGroup.get('ALARM_ID').updateValueAndValidity();
...
async WHEN_VALIDATE_ITEM_TYPE(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['TYPE'] != "undefined" ) 
      this.formGroup.controls['TYPE'].setErrors({invalid: true}); 
 // Code goes here 
...
async WHEN_VALIDATE_ITEM_NAME(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['NAME'] != "undefined" ) 
...
async WHEN_VALIDATE_ITEM_INPUT_TAG(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['INPUT_TAG'] != "undefined" ) 
      this.formGroup.controls['INPUT_TAG'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['INPUT_TAG'] != "undefined" ) 
     this.formGroup.get('INPUT_TAG').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
 ...
 async onBlur_ALARM_ID() { 
  await this.WHEN_VALIDATE_ITEM_ALARM_ID(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 ...
 async onBlur_TYPE() { 
  await this.WHEN_VALIDATE_ITEM_TYPE(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_NAME() { 
  await this.WHEN_VALIDATE_ITEM_NAME(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_INPUT_TAG() { 
  await this.WHEN_VALIDATE_ITEM_INPUT_TAG(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 }
