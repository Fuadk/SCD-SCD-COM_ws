...
import {   scdshapeExpressionScdScdShapeExpressionGrid , componentConfigDef } from '@modeldir/model';
...
'SHAPE_EXPRESSIONS' : new FormControl(dataItem.SHAPE_EXPRESSIONS  , ) ,
...
@Component({
  selector: 'app-scd-scd-shape-expression-grid',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-scd-shape-expression-grid.component.html',
  standalone: false,
  styleUrls: ['./scd-scd-shape-expression-grid.component.scss'
],
...
export class ScdShapeExpressionScdScdShapeExpressionGridGridComponent implements OnInit,OnDestroy {
 ...
 public showToolBar = true;
  ...
  public isMaster: boolean = false;
  		...
  		public  isSHAPE_EXPRESSIONSEnable : boolean = true; 
public  isSHAPE_IDEnable : boolean = true; 
  ...
  private insertCMD = "INSERT_SCD_SHAPE_EXPRESSION";
  private updateCMD = "UPDATE_SCD_SHAPE_EXPRESSION";
  private deleteCMD =   "DELETE_SCD_SHAPE_EXPRESSION";
  private getCMD = "GET_SCD_SHAPE_EXPRESSION_QUERY";

  public  executeQueryresult:any;
  public title =  this.starServices.getNLS([],"SCD_SCD_SHAPE_EXPRESSION_GRID.scdshapeExpressionScdScdShapeExpressionGrid.component_title","SCD SHAPE EXPRESSION GRID");
  public PDFfileName = this.title + ".PDF";
  public ExcelfileName = this.title + ".xlsx";
  public componentConfig
  public compTitleMsg =  "SCD_SCD_SHAPE_EXPRESSION_GRID.scdshapeExpressionScdScdShapeExpressionGrid";
  ...
  public primarKeyReadOnlyArr = {isSHAPE_EXPRESSIONSreadOnly : false , isSHAPE_IDreadOnly : false};  
  public paramConfig;
...
public compSelector = 'app-scd-scd-shape-expression-grid';
  ...
  @Output() setComponentConfig_Output: EventEmitter<any> = new EventEmitter();
    ...
    constructor(public router: Router,public intl: IntlService, public responsive: BreakpointObserver, private starNotify: StarNotifyService,   public starServices: starServices, private renderer: Renderer2) {
      ...
      this.title = this.componentConfig.title ? this.componentConfig.title :this.starServices.getNLS([],"SCD_SCD_SHAPE_EXPRESSION_GRID.scdshapeExpressionScdScdShapeExpressionGrid.component_title","SCD SHAPE EXPRESSION GRID");
  }
...
//Next part for filtering
  ...
  private gridInitialValues:any = new scdshapeExpressionScdScdShapeExpressionGrid();   
  ...
  public commonCallStarNotify(data:any) {
    ...
    let masterParams = {
      data: this.masterKeyArr
       ...
       let masterKeyArr = [data['SHAPE_ID'],data['SHAPE_EXPRESSIONS']];
      let masterKeyNameArr = ['SHAPE_ID','SHAPE_EXPRESSIONS'];
      //for (let i = 0; i < masterKeyNameArr.length; i++) {
      //  componentConfig.[masterKeyNameArr[i]] = masterKeyArr[i];
      //}
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ScdShapeExpressionScdScdShapeExpressionGridGrid ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_SHAPE_EXPRESSIONS(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['SHAPE_EXPRESSIONS'] != "undefined" ) 
      this.formGroup.controls['SHAPE_EXPRESSIONS'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['SHAPE_EXPRESSIONS'] != "undefined" ) 
     this.formGroup.get('SHAPE_EXPRESSIONS').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_SHAPE_EXPRESSIONS(event){
...
async WHEN_VALIDATE_ITEM_OPCUA_SERVER_ID(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['OPCUA_SERVER_ID'] != "undefined" ) 
      this.formGroup.controls['OPCUA_SERVER_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['OPCUA_SERVER_ID'] != "undefined" ) 
     this.formGroup.get('OPCUA_SERVER_ID').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_EXPRESSION_DATA(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['EXPRESSION_DATA'] != "undefined" ) 
      this.formGroup.controls['EXPRESSION_DATA'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['EXPRESSION_DATA'] != "undefined" ) 
     this.formGroup.get('EXPRESSION_DATA').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
 ...
 async onBlur_SHAPE_EXPRESSIONS() { 
  await this.WHEN_VALIDATE_ITEM_SHAPE_EXPRESSIONS(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 ...
 async onBlur_OPCUA_SERVER_ID() { 
  await this.WHEN_VALIDATE_ITEM_OPCUA_SERVER_ID(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_TAG_ID() { 
  await this.WHEN_VALIDATE_ITEM_TAG_ID(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_EXPRESSION_DATA() { 
  await this.WHEN_VALIDATE_ITEM_EXPRESSION_DATA(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 }
