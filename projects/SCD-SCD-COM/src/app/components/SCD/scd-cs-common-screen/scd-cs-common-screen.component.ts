...
import { scdshapeScdCsCommonScreen , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-cs-common-screen',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-cs-common-screen.component.html',
  styleUrls: ['./scd-cs-common-screen.component.scss'],
  standalone: false
})


export class ScdShapeScdCsCommonScreenFormdivsComponent {
  public title =  this.starServices.getNLS([],"SCD_CS_COMMON_SCREEN.scdshapeScdCsCommonScreen.component_title","Common Screen");
  public compTitleMsg =  "SCD_CS_COMMON_SCREEN.scdshapeScdCsCommonScreen";
  public routineName = "ScdShapeScdCsCommonScreenFormdivs";
  ...
  public compSelector = 'app-scd-cs-common-screen';
  public PK_AUTO = 'SHAPE_ID';
  public customerFacing = false;
  public FormStepsArr = [{"CODE":"","CODETEXT_LANG":""},{"CODE":"1","CODETEXT_LANG":"General"},{"CODE":"2","CODETEXT_LANG":"Size"},{"CODE":"3","CODETEXT_LANG":"Position"},{"CODE":"4","CODETEXT_LANG":"Other"}] ;
...
public labelDG_SHAPE_IDTop=false;
public labelDG_SHAPE_IDVisible=true;
public labelICON_IDTop=false;
...
public labelTOPTop=false;
public labelTOPVisible=true;
public labelLEFTTop=false;
...
public visibleDG_SHAPE_ID = true;
public visibleICON_ID = true;
...
public visibleFOCUS_HIGHLIGHT = true;
public visiblePOINTER_HIGHLIGHT = true;
...
public disableKEY_NAVIGATION = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdshapeScdCsCommonScreen();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdShapeScdCsCommonScreenFormdivs form.DISPLAY_ID :' + form.DISPLAY_ID);
...
this.lookupArrDef =[	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"SHAPE_TYPE\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdShapeScdCsCommonScreenFormdivs ComponentConfig:", {...ComponentConfig});
