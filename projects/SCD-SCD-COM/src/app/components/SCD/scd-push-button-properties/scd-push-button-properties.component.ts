...
import {  scdshapeScdTpCommonScreen  ,scdbuttonPushGeneralScdPbgPushButtonGeneral  ,scdalarmScdShapeStatesProperties  ,scdshapeConnectionScdScShapeConnections  , componentConfigDef} from '@modeldir/model';
...
@Component({
  ...
  selector: 'app-scd-push-button-properties',
  templateUrl: './scd-push-button-properties.component.html',
  styleUrls: ['./scd-push-button-properties.component.scss'],
  standalone: false
})
export class ScdPushButtonPropertiesComponent implements OnInit {
  ...
  constructor(public router: Router,public responsive: BreakpointObserver, private starNotify: StarNotifyService, public starServices: starServices, public starlib1: Starlib1) {
   this.router = router;
  this.title =  this.starServices.getNLS([],"scd_push_button_properties.scd_push_button_properties.component_title","");
  ...
  public routineName = "scd_push_button_properties";
  ...
  public routineAuth = "ScdPushButtonProperties";

  public ngAfterViewInit() {
    this.starServices.setRTL();
  }
  private componentConfigChangeEvent!: Subscription;
  public compSelector = 'app-scd-push-button-properties';
  ...
  async initComponents(){
   ...
   this.SCD_SHAPEForm_0Config.title = this.starServices.getNLS([],"scd_push_button_properties.scd_push_button_properties.compsTitleID1","Common");
   ...
   this.SCD_BUTTON_PUSH_GENERALFormdivs_1Config.title = this.starServices.getNLS([],"scd_push_button_properties.scd_push_button_properties.compsTitleID2","General");
   this.SCD_BUTTON_PUSH_GENERALFormdivs_1Config.isChild = true;
   this.SCD_BUTTON_PUSH_GENERALFormdivs_1Config.masterSelector = 'app-scd-push-button-properties';
   ...
   this.SCD_ALARMFormtabs_2Config.title = this.starServices.getNLS([],"scd_push_button_properties.scd_push_button_properties.compsTitleID3","States");
   this.SCD_ALARMFormtabs_2Config.isChild = true;
   this.SCD_ALARMFormtabs_2Config.masterSelector = 'app-scd-push-button-properties';
   ...
   this.SCD_SHAPE_CONNECTIONGrid_3Config.title = this.starServices.getNLS([],"scd_push_button_properties.scd_push_button_properties.compsTitleID4","Connections");
   this.SCD_SHAPE_CONNECTIONGrid_3Config.isChild = true;
   this.SCD_SHAPE_CONNECTIONGrid_3Config.masterSelector = 'app-scd-push-button-properties';
 ...
 if ( key != '') { 
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("ComponentConfig:ScdPushButtonPropertiesComponent:",ComponentConfig);
    if (typeof ComponentConfig !== "undefined"){
