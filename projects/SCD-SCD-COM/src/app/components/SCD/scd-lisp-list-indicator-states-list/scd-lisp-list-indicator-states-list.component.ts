...
import {   scdlistIndicatorStateScdLispListIndicatorStatesList , componentConfigDef } from '@modeldir/model';
...
'LIST_INDICATOR_STATE_ID' : new FormControl(dataItem.LIST_INDICATOR_STATE_ID  , ) ,
...
@Component({
  selector: 'app-scd-lisp-list-indicator-states-list',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-lisp-list-indicator-states-list.component.html',
  standalone: false,
  styleUrls: ['./scd-lisp-list-indicator-states-list.component.scss'
],
...
export class ScdListIndicatorStateScdLispListIndicatorStatesListGridComponent implements OnInit,OnDestroy {
 ...
 public showToolBar = true;
  ...
  public isMaster: boolean = false;
  	...
  	public  isLIST_INDICATOR_STATE_IDEnable : boolean = true; 
  ...
  private insertCMD = "INSERT_SCD_LIST_INDICATOR_STATE";
  private updateCMD = "UPDATE_SCD_LIST_INDICATOR_STATE";
  private deleteCMD =   "DELETE_SCD_LIST_INDICATOR_STATE";
  private getCMD = "GET_SCD_LIST_INDICATOR_STATE_QUERY";
  ...
  public primarKeyReadOnlyArr = {isLIST_INDICATOR_STATE_IDreadOnly : false};  
  public paramConfig;
...
//Next part for filtering
  ...
  private gridInitialValues:any = new scdlistIndicatorStateScdLispListIndicatorStatesList();   
  ...
  public commonCallStarNotify(data:any) {
    ...
    let masterParams = {
      data: this.masterKeyArr
       ...
       let masterKeyArr = [data['LIST_INDICATOR_STATE_ID']];
      let masterKeyNameArr = ['LIST_INDICATOR_STATE_ID'];
      //for (let i = 0; i < masterKeyNameArr.length; i++) {
      //  componentConfig.[masterKeyNameArr[i]] = masterKeyArr[i];
      //}
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ScdListIndicatorStateScdLispListIndicatorStatesListGrid ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_LIST_INDICATOR_STATE_ID(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['LIST_INDICATOR_STATE_ID'] != "undefined" ) 
      this.formGroup.controls['LIST_INDICATOR_STATE_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['LIST_INDICATOR_STATE_ID'] != "undefined" ) 
     this.formGroup.get('LIST_INDICATOR_STATE_ID').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_LIST_INDICATOR_STATE_ID(event){
...
async WHEN_VALIDATE_ITEM_CAPTION_ALIGNMENT(formGroup) {
 ...
 async onBlur_LIST_INDICATOR_STATE_ID() { 
  await this.WHEN_VALIDATE_ITEM_LIST_INDICATOR_STATE_ID(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
