...
import { scdsymbolStateScdSspSymbolStateDefinition , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-ssp-symbol-state-definition',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-ssp-symbol-state-definition.component.html',
  styleUrls: ['./scd-ssp-symbol-state-definition.component.scss'],
  standalone: false
})


export class ScdSymbolStateScdSspSymbolStateDefinitionFormComponent {
  public title =  this.starServices.getNLS([],"SCD_SSP_SYMBOL_STATE_DEFINITION.scdsymbolStateScdSspSymbolStateDefinition.component_title","Symbol State Definition");
  public compTitleMsg =  "SCD_SSP_SYMBOL_STATE_DEFINITION.scdsymbolStateScdSspSymbolStateDefinition";
  public routineName = "ScdSymbolStateScdSspSymbolStateDefinitionForm";
  ...
  public compSelector = 'app-scd-ssp-symbol-state-definition';
...
public disableIMAGE_BLINK = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdsymbolStateScdSspSymbolStateDefinition();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdSymbolStateScdSspSymbolStateDefinitionForm form.SHAPE_ID :' + form.SHAPE_ID);
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdSymbolStateScdSspSymbolStateDefinitionForm ComponentConfig:", {...ComponentConfig});
