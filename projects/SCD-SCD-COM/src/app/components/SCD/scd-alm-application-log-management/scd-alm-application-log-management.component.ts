...
import { scdlogManagementScdAlmApplicationLogManagement , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-alm-application-log-management',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-alm-application-log-management.component.html',
  styleUrls: ['./scd-alm-application-log-management.component.scss'],
  standalone: false
})


export class ScdLogManagementScdAlmApplicationLogManagementFormtabsComponent {
  public title =  this.starServices.getNLS([],"SCD_ALM_APPLICATION_LOG_MANAGEMENT.scdlogManagementScdAlmApplicationLogManagement.component_title","Application Log Management");
  public compTitleMsg =  "SCD_ALM_APPLICATION_LOG_MANAGEMENT.scdlogManagementScdAlmApplicationLogManagement";
  public routineName = "ScdLogManagementScdAlmApplicationLogManagementFormtabs";
  ...
  public compSelector = 'app-scd-alm-application-log-management';
  public PK_AUTO = 'LOG_MANAGEMENT_ID';
  public customerFacing = false;
  public FormStepsArr = [{"CODE":"","CODETEXT_LANG":""},{"CODE":"1","CODETEXT_LANG":"Log Management"},{"CODE":"2","CODETEXT_LANG":"Log Triggers"},{"CODE":"3","CODETEXT_LANG":"Tags in Model"}] ;
...
public visibleLOG_MANAGEMENT_ID = true;
...
public disableMAX_FILES = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdlogManagementScdAlmApplicationLogManagement();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdLogManagementScdAlmApplicationLogManagementFormtabs form.APPLICATION_ID :' + form.APPLICATION_ID);
...
this.form.get('START_NEW').valueChanges.subscribe(val => {
});
this.form.get('PERIODIC_OPTION').valueChanges.subscribe(val => {
});
this.form.get('START_TIMES').valueChanges.subscribe(val => {
});
this.form.get('EXPRESSIONS').valueChanges.subscribe(val => {
});
this.form.get('DELETE_OLDEST_AFTER_MAX_TIME').valueChanges.subscribe(val => {
});
this.form.get('MAX_TIME').valueChanges.subscribe(val => {
});
this.form.get('MAX_TIME_OPTIONS').valueChanges.subscribe(val => {
});
this.form.get('DELETE_OLDEST_AFTER_MAX_FILES').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdLogManagementScdAlmApplicationLogManagementFormtabs ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_MAX_FILES(value) {
 ...
 async onChange_START_TIMES(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 ...
 async onChange_EXPRESSIONS(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
