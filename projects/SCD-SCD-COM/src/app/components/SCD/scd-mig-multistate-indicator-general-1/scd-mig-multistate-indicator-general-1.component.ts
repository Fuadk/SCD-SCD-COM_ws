...
import { scdmultistateIndicatorGeneralScdMigMultistateIndicatorGeneral1 , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-mig-multistate-indicator-general-1',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-mig-multistate-indicator-general-1.component.html',
  styleUrls: ['./scd-mig-multistate-indicator-general-1.component.scss'],
  standalone: false
})


export class ScdMultistateIndicatorGeneralScdMigMultistateIndicatorGeneral1FormComponent {
  public title =  this.starServices.getNLS([],"SCD_MIG_MULTISTATE_INDICATOR_GENERAL_1.scdmultistateIndicatorGeneralScdMigMultistateIndicatorGeneral1.component_title","Multistate Indicator General");
  public compTitleMsg =  "SCD_MIG_MULTISTATE_INDICATOR_GENERAL_1.scdmultistateIndicatorGeneralScdMigMultistateIndicatorGeneral1";
  public routineName = "ScdMultistateIndicatorGeneralScdMigMultistateIndicatorGeneral1Form";
  ...
  public compSelector = 'app-scd-mig-multistate-indicator-general-1';
...
public disableTRIGGER_TYPE = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdmultistateIndicatorGeneralScdMigMultistateIndicatorGeneral1();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdMultistateIndicatorGeneralScdMigMultistateIndicatorGeneral1Form form.SHAPE_ID :' + form.SHAPE_ID);
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdMultistateIndicatorGeneralScdMigMultistateIndicatorGeneral1Form ComponentConfig:", {...ComponentConfig});
