...
import { scdgraphGeneralScdGgGraphGeneral , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-gg-graph-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-gg-graph-general.component.html',
  styleUrls: ['./scd-gg-graph-general.component.scss'],
  standalone: false
})


export class ScdGraphGeneralScdGgGraphGeneralFormdivsComponent {
  public title =  this.starServices.getNLS([],"SCD_GG_GRAPH_GENERAL.scdgraphGeneralScdGgGraphGeneral.component_title","Graph General");
  public compTitleMsg =  "SCD_GG_GRAPH_GENERAL.scdgraphGeneralScdGgGraphGeneral";
  public routineName = "ScdGraphGeneralScdGgGraphGeneralFormdivs";
  ...
  public compSelector = 'app-scd-gg-graph-general';
  public PK_AUTO = 'GRAPH_GENERAL_ID';
  public customerFacing = false;
  public FormStepsArr = [{"CODE":"","CODETEXT_LANG":"","visible":true},{"CODE":"1","CODETEXT_LANG":"Appearance","visible":true},{"CODE":"2","CODETEXT_LANG":"Bar Graph Settings","visible":true},{"CODE":"3","CODETEXT_LANG":"Scale Setup","visible":true},{"CODE":"4","CODETEXT_LANG":"Thresholds","visible":true},{"CODE":"5","CODETEXT_LANG":"Threshold 1","visible":true},{"CODE":"6","CODETEXT_LANG":"Threshold 2","visible":true}] ;
public labelGRAPH_GENERAL_IDTop=true;
...
public disableBLINK_2 = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdgraphGeneralScdGgGraphGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdGraphGeneralScdGgGraphGeneralFormdivs form.SHAPE_ID :' + form.SHAPE_ID);
...
this.lookupArrDef =[	{"statment":"SELECT SHAPE_ID CODE, NAME CODETEXT_LANG  FROM SCD_SHAPE  order by CODETEXT_LANG ",
	...
	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"FILL_DIRECTION\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
...
public lkpArrGetSWEEP_STYLE(CODE: any): any {
var rec = this.lkpArrSWEEP_STYLE.find((x:any) => x.CODE === CODE);
return rec;
}
...
public lkpArrGetFILL_DIRECTION(CODE: any): any {
var rec = this.lkpArrFILL_DIRECTION.find((x:any) => x.CODE === CODE);
return rec;
}

public lkpArrGetTICK_DIRECTION(CODE: any): any {
var rec = this.lkpArrTICK_DIRECTION.find((x:any) => x.CODE === CODE);
return rec;
}
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdGraphGeneralScdGgGraphGeneralFormdivs ComponentConfig:", {...ComponentConfig});
  ...
  async WHEN_NOTIFY(ComponentConfig){
    ...
    if (masterSelector.includes("bar")) {
        this.generalMode = "BAR";
        //alert(this.generalMode);
    }
    else if (masterSelector.includes("gauge")) {
        this.generalMode = "GAUGE";
        //alert(this.generalMode);
    }
    else if (masterSelector.includes("scale")) {
