...
import { scdshapeInputGeneralScdNipShapeInputGeneral , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-nip-shape-input-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-nip-shape-input-general.component.html',
  styleUrls: ['./scd-nip-shape-input-general.component.scss'],
  standalone: false
})


export class ScdShapeInputGeneralScdNipShapeInputGeneralFormComponent {
  public title =  this.starServices.getNLS([],"SCD_NIP_SHAPE_INPUT_GENERAL.scdshapeInputGeneralScdNipShapeInputGeneral.component_title","Shape Input General");
  public compTitleMsg =  "SCD_NIP_SHAPE_INPUT_GENERAL.scdshapeInputGeneralScdNipShapeInputGeneral";
  public routineName = "ScdShapeInputGeneralScdNipShapeInputGeneralForm";
  ...
  public compSelector = 'app-scd-nip-shape-input-general';
...
public visibleDISPLAY_ON_SCREEN_KEYBOARD = false;
public visibleCAPTION = false;
public visibleCONTINUOUSLY_UPDATE = false;
public visibleDISCARD_INPUT_AND_RESUME_UPDATING_WHEN_FOCUS_IS_LOST = false;
public visibleE_SIGNATURE_SETTINGS = false;
...
public disableE_SIGNATURE_SETTINGS = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdshapeInputGeneralScdNipShapeInputGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdShapeInputGeneralScdNipShapeInputGeneralForm form.SHAPE_ID :' + form.SHAPE_ID);
...
this.form.get('DISPLAY_ON_SCREEN_KEYBOARD').valueChanges.subscribe(val => {
});
this.form.get('CAPTION').valueChanges.subscribe(val => {
});
this.form.get('CONTINUOUSLY_UPDATE').valueChanges.subscribe(val => {
});
this.form.get('DISCARD_INPUT_AND_RESUME_UPDATING_WHEN_FOCUS_IS_LOST').valueChanges.subscribe(val => {
});
this.form.get('E_SIGNATURE_SETTINGS').valueChanges.subscribe(val => {
});
}
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdShapeInputGeneralScdNipShapeInputGeneralForm ComponentConfig:", {...ComponentConfig});
