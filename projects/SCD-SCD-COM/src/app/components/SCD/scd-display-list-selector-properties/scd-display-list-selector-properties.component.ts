...
import {  scdshapeScdTpCommonScreen  ,scdlistIndicatorGeneralScdLigListIndicatorGeneral  ,scdalarmScdListIndicatorStatesProperties  , componentConfigDef} from '@modeldir/model';
...
@Component({
  ...
  selector: 'app-scd-display-list-selector-properties',
  templateUrl: './scd-display-list-selector-properties.component.html',
  styleUrls: ['./scd-display-list-selector-properties.component.scss'],
  standalone: false
})
export class ScdDisplayListSelectorPropertiesComponent implements OnInit {
  ...
  constructor(public router: Router,public responsive: BreakpointObserver, private starNotify: StarNotifyService, public starServices: starServices, public starlib1: Starlib1) {
   this.router = router;
  this.title =  this.starServices.getNLS([],"scd_display_list_selector_properties.scd_display_list_selector_properties.component_title","");
  ...
  public routineName = "scd_display_list_selector_properties";
  ...
  public routineAuth = "ScdDisplayListSelectorProperties";

  public ngAfterViewInit() {
    this.starServices.setRTL();
  }
  private componentConfigChangeEvent!: Subscription;
  public compSelector = 'app-scd-display-list-selector-properties';
  ...
  async initComponents(){
   ...
   this.SCD_SHAPEForm_0Config.title = this.starServices.getNLS([],"scd_display_list_selector_properties.scd_display_list_selector_properties.compsTitleID1","Common");
   ...
   this.SCD_LIST_INDICATOR_GENERALFormdivs_1Config.title = this.starServices.getNLS([],"scd_display_list_selector_properties.scd_display_list_selector_properties.compsTitleID2","General");
   this.SCD_LIST_INDICATOR_GENERALFormdivs_1Config.isChild = true;
   this.SCD_LIST_INDICATOR_GENERALFormdivs_1Config.masterSelector = 'app-scd-display-list-selector-properties';
   if (typeof this['steps']  !== 'undefined') {
   ...
   this.SCD_ALARMFormtabs_2Config.title = this.starServices.getNLS([],"scd_display_list_selector_properties.scd_display_list_selector_properties.compsTitleID3","States");
   this.SCD_ALARMFormtabs_2Config.isChild = true;
   this.SCD_ALARMFormtabs_2Config.masterSelector = 'app-scd-display-list-selector-properties';
   if (typeof this['steps']  !== 'undefined') {
 ...
 if ( key != '') { 
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("ComponentConfig:ScdDisplayListSelectorPropertiesComponent:",ComponentConfig);
