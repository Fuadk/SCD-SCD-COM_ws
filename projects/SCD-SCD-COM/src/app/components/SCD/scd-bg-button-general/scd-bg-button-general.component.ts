...
import { scdbuttonGeneralScdBgButtonGeneral , componentConfigDef} from '@modeldir/model';


 const createFormGroup = (dataItem:any) => new FormGroup({
'BUTTON_GENERAL_ID' : new FormControl(dataItem.BUTTON_GENERAL_ID  , ) ,
'SHAPE_ID' : new FormControl(dataItem.SHAPE_ID  ,   Validators.required ) ,
'BUTTON_STYLE' : new FormControl(dataItem.BUTTON_STYLE  , ) ,
'WIDTH' : new FormControl(dataItem.WIDTH  , ) ,
'CAPTURE_CURSOR' : new FormControl(dataItem.CAPTURE_CURSOR  , ) ,
'HIGHLIGHT_WHEN_OBJECT_HAS_FOCUS' : new FormControl(dataItem.HIGHLIGHT_WHEN_OBJECT_HAS_FOCUS  , ) ,
'TAB_INDEX' : new FormControl(dataItem.TAB_INDEX  , ) 
});

declare function getParamConfig():any;
@Component({
  selector: 'app-scd-bg-button-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-bg-button-general.component.html',
  styleUrls: ['./scd-bg-button-general.component.scss'],
  standalone: false
})


export class ScdButtonGeneralScdBgButtonGeneralFormdivsComponent {
  public title =  this.starServices.getNLS([],"SCD_BG_BUTTON_GENERAL.scdbuttonGeneralScdBgButtonGeneral.component_title","Button General");
  public compTitleMsg =  "SCD_BG_BUTTON_GENERAL.scdbuttonGeneralScdBgButtonGeneral";
  public routineName = "ScdButtonGeneralScdBgButtonGeneralFormdivs";
  private insertCMD = "INSERT_SCD_BUTTON_GENERAL";
  private updateCMD = "UPDATE_SCD_BUTTON_GENERAL";
  private deleteCMD =   "DELETE_SCD_BUTTON_GENERAL";
  private getCMD = "GET_SCD_BUTTON_GENERAL_QUERY";
  ...
  public primarKeyReadOnlyArr = {isBUTTON_GENERAL_IDreadOnly : false , isSHAPE_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-bg-button-general';
  public PK_AUTO = 'BUTTON_GENERAL_ID';
  public customerFacing = false;
  public FormStepsArr = [{"CODE":"","CODETEXT_LANG":"","visible":true},{"CODE":"1","CODETEXT_LANG":"Button Style","visible":true},{"CODE":"2","CODETEXT_LANG":"Other","visible":true}] ;
public labelBUTTON_GENERAL_IDTop=false;
public labelBUTTON_GENERAL_IDVisible=true;
public labelSHAPE_IDTop=false;
public labelSHAPE_IDVisible=true;
public labelBUTTON_STYLETop=false;
public labelBUTTON_STYLEVisible=true;
public labelWIDTHTop=false;
public labelWIDTHVisible=true;
public labelCAPTURE_CURSORTop=false;
public labelCAPTURE_CURSORVisible=true;
public labelHIGHLIGHT_WHEN_OBJECT_HAS_FOCUSTop=false;
public labelHIGHLIGHT_WHEN_OBJECT_HAS_FOCUSVisible=true;
public labelTAB_INDEXTop=false;
public labelTAB_INDEXVisible=true;

public visibleBUTTON_GENERAL_ID = false;
public visibleSHAPE_ID = false;
public visibleBUTTON_STYLE = true;
public visibleWIDTH = true;
public visibleCAPTURE_CURSOR = true;
public visibleHIGHLIGHT_WHEN_OBJECT_HAS_FOCUS = true;
public visibleTAB_INDEX = true;

public disableBUTTON_GENERAL_ID = false;
public disableSHAPE_ID = false;
public disableBUTTON_STYLE = false;
public disableWIDTH = false;
public disableCAPTURE_CURSOR = false;
public disableHIGHLIGHT_WHEN_OBJECT_HAS_FOCUS = false;
public disableTAB_INDEX = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdbuttonGeneralScdBgButtonGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdButtonGeneralScdBgButtonGeneralFormdivs form.SHAPE_ID :' + form.SHAPE_ID);
  ...
  async  enterQuery (form : any){
    ...
    async callBackPost_Insert(NewVal:any) {
      ...
      this.Comp_Config.masterKeyArr =  [NewVal['BUTTON_GENERAL_ID']];
      this.Comp_Config.masterKeyNameArr =  ["BUTTON_GENERAL_ID"];
...
this.lookupArrDef =[	{"statment":"SELECT SHAPE_ID CODE, NAME CODETEXT_LANG  FROM SCD_SHAPE  order by CODETEXT_LANG ",
	...
	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"BUTTON_STYLE\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
			"lkpArrName":"lkpArrBUTTON_STYLE"}];
...
public lkpArrGetBUTTON_STYLE(CODE: any): any {
var rec = this.lkpArrBUTTON_STYLE.find((x:any) => x.CODE === CODE);
return rec;
}

onChanges(): void {
this.form.get('BUTTON_GENERAL_ID').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdButtonGeneralScdBgButtonGeneralFormdivs ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_BUTTON_GENERAL_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['BUTTON_GENERAL_ID'] != "undefined" ) 
      this.form.controls['BUTTON_GENERAL_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['BUTTON_GENERAL_ID'] != "undefined" ) 
     this.form.get('BUTTON_GENERAL_ID').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_BUTTON_GENERAL_ID(event){
...
async WHEN_VALIDATE_ITEM_BUTTON_STYLE(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['BUTTON_STYLE'] != "undefined" ) 
      this.form.controls['BUTTON_STYLE'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['BUTTON_STYLE'] != "undefined" ) 
     this.form.get('BUTTON_STYLE').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_BUTTON_STYLE(event){
...
async WHEN_VALIDATE_ITEM_CAPTURE_CURSOR(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['CAPTURE_CURSOR'] != "undefined" ) 
      this.form.controls['CAPTURE_CURSOR'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['CAPTURE_CURSOR'] != "undefined" ) 
     this.form.get('CAPTURE_CURSOR').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_CAPTURE_CURSOR(event){

}

async WHEN_VALIDATE_ITEM_HIGHLIGHT_WHEN_OBJECT_HAS_FOCUS(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['HIGHLIGHT_WHEN_OBJECT_HAS_FOCUS'] != "undefined" ) 
      this.form.controls['HIGHLIGHT_WHEN_OBJECT_HAS_FOCUS'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['HIGHLIGHT_WHEN_OBJECT_HAS_FOCUS'] != "undefined" ) 
     this.form.get('HIGHLIGHT_WHEN_OBJECT_HAS_FOCUS').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_HIGHLIGHT_WHEN_OBJECT_HAS_FOCUS(event){
...
async WHEN_VALIDATE_ITEM_TAB_INDEX(value) {
 ...
 async onChange_BUTTON_GENERAL_ID(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_BUTTON_GENERAL_ID(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onChange_BUTTON_STYLE(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_BUTTON_STYLE(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onChange_CAPTURE_CURSOR(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_CAPTURE_CURSOR(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
  
 } 
 async onChange_HIGHLIGHT_WHEN_OBJECT_HAS_FOCUS(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_HIGHLIGHT_WHEN_OBJECT_HAS_FOCUS(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
