...
import { scdjavascriptCodeScdJcsJavascriptCode , componentConfigDef} from '@modeldir/model';


 const createFormGroup = (dataItem:any) => new FormGroup({
'JAVASCRIPT_CODE_ID' : new FormControl(dataItem.JAVASCRIPT_CODE_ID  , ) ,
'DISPLAY_ID' : new FormControl(dataItem.DISPLAY_ID  ,   Validators.required ) ,
'SUBROUTINE_NAME' : new FormControl(dataItem.SUBROUTINE_NAME  , ) ,
'SUBROUTINE_CODE' : new FormControl(dataItem.SUBROUTINE_CODE  , ) 
});

declare function getParamConfig():any;
@Component({
  selector: 'app-scd-jcs-javascript-code',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-jcs-javascript-code.component.html',
  styleUrls: ['./scd-jcs-javascript-code.component.scss'],
  standalone: false
})


export class ScdJavascriptCodeScdJcsJavascriptCodeFormComponent {
  public title =  this.starServices.getNLS([],"SCD_JCS_JAVASCRIPT_CODE.scdjavascriptCodeScdJcsJavascriptCode.component_title","Javascript Code");
  public compTitleMsg =  "SCD_JCS_JAVASCRIPT_CODE.scdjavascriptCodeScdJcsJavascriptCode";
  public routineName = "ScdJavascriptCodeScdJcsJavascriptCodeForm";
  private insertCMD = "INSERT_SCD_JAVASCRIPT_CODE";
  private updateCMD = "UPDATE_SCD_JAVASCRIPT_CODE";
  private deleteCMD =   "DELETE_SCD_JAVASCRIPT_CODE";
  private getCMD = "GET_SCD_JAVASCRIPT_CODE_QUERY";
  ...
  public primarKeyReadOnlyArr = {isJAVASCRIPT_CODE_IDreadOnly : false , isDISPLAY_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-jcs-javascript-code';
  public PK_AUTO = 'JAVASCRIPT_CODE_ID';
  public customerFacing = false;
  public FormStepsArr = [] ;
public labelJAVASCRIPT_CODE_IDTop=false;
public labelJAVASCRIPT_CODE_IDVisible=true;
public labelDISPLAY_IDTop=false;
public labelDISPLAY_IDVisible=true;
public labelSUBROUTINE_NAMETop=false;
public labelSUBROUTINE_NAMEVisible=true;
public labelSUBROUTINE_CODETop=false;
public labelSUBROUTINE_CODEVisible=false;

public visibleJAVASCRIPT_CODE_ID = false;
public visibleDISPLAY_ID = false;
public visibleSUBROUTINE_NAME = false;
public visibleSUBROUTINE_CODE = true;

public disableJAVASCRIPT_CODE_ID = false;
public disableDISPLAY_ID = false;
public disableSUBROUTINE_NAME = false;
public disableSUBROUTINE_CODE = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdjavascriptCodeScdJcsJavascriptCode();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdJavascriptCodeScdJcsJavascriptCodeForm form.DISPLAY_ID :' + form.DISPLAY_ID);
  ...
  async  enterQuery (form : any){
    ...
    async callBackPost_Insert(NewVal:any) {
      ...
      this.Comp_Config.masterKeyArr =  [NewVal['JAVASCRIPT_CODE_ID']];
      this.Comp_Config.masterKeyNameArr =  ["JAVASCRIPT_CODE_ID"];
...
this.lookupArrDef =[	{"statment":"SELECT DISPLAY_ID CODE, DISPLAY_NAME CODETEXT_LANG  FROM SCD_DISPLAY  order by CODETEXT_LANG ",
	...
	{"statment":"SELECT CODE, CODETEXT_LANG , PARTCODE FROM SOM_TABS_CODES WHERE CODENAME = \"SUBROUTINE_NAME\"  and LANGUAGE_NAME = '" + this.userLang + "' order by CODETEXT_LANG ",
			"lkpArrName":"lkpArrSUBROUTINE_NAME"}];
...
public lkpArrGetSUBROUTINE_NAME(CODE: any): any {
var rec = this.lkpArrSUBROUTINE_NAME.find((x:any) => x.CODE === CODE);
return rec;
}

onChanges(): void {
this.form.get('JAVASCRIPT_CODE_ID').valueChanges.subscribe(val => {
});
}
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdJavascriptCodeScdJcsJavascriptCodeForm ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_JAVASCRIPT_CODE_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['JAVASCRIPT_CODE_ID'] != "undefined" ) 
      this.form.controls['JAVASCRIPT_CODE_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['JAVASCRIPT_CODE_ID'] != "undefined" ) 
     this.form.get('JAVASCRIPT_CODE_ID').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_JAVASCRIPT_CODE_ID(event){
...
async WHEN_VALIDATE_ITEM_SUBROUTINE_NAME(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['SUBROUTINE_NAME'] != "undefined" ) 
      this.form.controls['SUBROUTINE_NAME'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['SUBROUTINE_NAME'] != "undefined" ) 
     this.form.get('SUBROUTINE_NAME').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_SUBROUTINE_NAME(event){

}

async WHEN_VALIDATE_ITEM_SUBROUTINE_CODE(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['SUBROUTINE_CODE'] != "undefined" ) 
      this.form.controls['SUBROUTINE_CODE'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['SUBROUTINE_CODE'] != "undefined" ) 
     this.form.get('SUBROUTINE_CODE').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_SUBROUTINE_CODE(event){

}
 
 async onChange_JAVASCRIPT_CODE_ID(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_JAVASCRIPT_CODE_ID(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onValueChange_SUBROUTINE_NAME(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 await this.WHEN_VALIDATE_ITEM_SUBROUTINE_NAME(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
  
  } 
 async onValueChange_SUBROUTINE_CODE(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 await this.WHEN_VALIDATE_ITEM_SUBROUTINE_CODE(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
