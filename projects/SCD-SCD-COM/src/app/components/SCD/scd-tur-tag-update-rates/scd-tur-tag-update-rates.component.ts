...
import {   scdtagUpdateRateScdTurTagUpdateRates , componentConfigDef } from '@modeldir/model';
...
'TAG_UPDATE_RATE_ID' : new FormControl(dataItem.TAG_UPDATE_RATE_ID  , ) ,
'APPLICATION_ID' : new FormControl(dataItem.APPLICATION_ID  ,   Validators.required ) ,
'UPDATE_RATE' : new FormControl(dataItem.UPDATE_RATE  , ) ,
...
@Component({
  selector: 'app-scd-tur-tag-update-rates',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-tur-tag-update-rates.component.html',
  standalone: false,
  styleUrls: ['./scd-tur-tag-update-rates.component.scss'
],
...
export class ScdTagUpdateRateScdTurTagUpdateRatesGridComponent implements OnInit,OnDestroy {
 ...
 public showToolBar = true;
  ...
  public isMaster: boolean = false;
  		...
  		public  isTAG_UPDATE_RATE_IDEnable : boolean = true; 
public  isAPPLICATION_IDEnable : boolean = true; 
  ...
  private insertCMD = "INSERT_SCD_TAG_UPDATE_RATE";
  private updateCMD = "UPDATE_SCD_TAG_UPDATE_RATE";
  private deleteCMD =   "DELETE_SCD_TAG_UPDATE_RATE";
  private getCMD = "GET_SCD_TAG_UPDATE_RATE_QUERY";

  public  executeQueryresult:any;
  public title =  this.starServices.getNLS([],"SCD_TUR_TAG_UPDATE_RATES.scdtagUpdateRateScdTurTagUpdateRates.component_title","Tag Update Rates");
  public PDFfileName = this.title + ".PDF";
  public ExcelfileName = this.title + ".xlsx";
  public componentConfig
  public compTitleMsg =  "SCD_TUR_TAG_UPDATE_RATES.scdtagUpdateRateScdTurTagUpdateRates";
  ...
  public primarKeyReadOnlyArr = {isTAG_UPDATE_RATE_IDreadOnly : false , isAPPLICATION_IDreadOnly : false};  
  public paramConfig;
...
public visibleTAG_UPDATE_RATE_ID = false;
public visibleAPPLICATION_ID = false;
public visibleUPDATE_RATE = true;
public visibleTAG_NAME = true;

public compSelector = 'app-scd-tur-tag-update-rates';
  ...
  @Output() formValidationChangedOutput: EventEmitter<boolean> = new EventEmitter();
    ...
    constructor(public router: Router,public intl: IntlService, public responsive: BreakpointObserver, private starNotify: StarNotifyService,   public starServices: starServices, private renderer: Renderer2) {
      ...
      this.title = this.componentConfig.title ? this.componentConfig.title :this.starServices.getNLS([],"SCD_TUR_TAG_UPDATE_RATES.scdtagUpdateRateScdTurTagUpdateRates.component_title","Tag Update Rates");
  }
...
//Next part for filtering
  ...
  private gridInitialValues:any = new scdtagUpdateRateScdTurTagUpdateRates();   
  ...
  public commonCallStarNotify(data:any) {
    ...
    let masterParams = {
      data: this.masterKeyArr
       ...
       let masterKeyArr = [data['APPLICATION_ID'],data['TAG_UPDATE_RATE_ID']];
      let masterKeyNameArr = ['APPLICATION_ID','TAG_UPDATE_RATE_ID'];
      //for (let i = 0; i < masterKeyNameArr.length; i++) {
      //  componentConfig.[masterKeyNameArr[i]] = masterKeyArr[i];
      //}
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ScdTagUpdateRateScdTurTagUpdateRatesGrid ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_TAG_UPDATE_RATE_ID(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['TAG_UPDATE_RATE_ID'] != "undefined" ) 
      this.formGroup.controls['TAG_UPDATE_RATE_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['TAG_UPDATE_RATE_ID'] != "undefined" ) 
     this.formGroup.get('TAG_UPDATE_RATE_ID').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_TAG_UPDATE_RATE_ID(event){
...
async WHEN_VALIDATE_ITEM_UPDATE_RATE(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['UPDATE_RATE'] != "undefined" ) 
      this.formGroup.controls['UPDATE_RATE'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['UPDATE_RATE'] != "undefined" ) 
     this.formGroup.get('UPDATE_RATE').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_UPDATE_RATE(event){
...
async WHEN_VALIDATE_ITEM_TAG_NAME(formGroup) {
 ...
 async onBlur_TAG_UPDATE_RATE_ID() { 
  await this.WHEN_VALIDATE_ITEM_TAG_UPDATE_RATE_ID(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 ...
 async onBlur_UPDATE_RATE() { 
  await this.WHEN_VALIDATE_ITEM_UPDATE_RATE(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
