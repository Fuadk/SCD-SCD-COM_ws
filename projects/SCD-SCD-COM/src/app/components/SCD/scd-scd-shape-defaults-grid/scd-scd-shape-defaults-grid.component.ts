...
import {   scdshapeDefaultsScdScdShapeDefaultsGrid , componentConfigDef } from '@modeldir/model';
...
@Component({
  selector: 'app-scd-scd-shape-defaults-grid',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-scd-shape-defaults-grid.component.html',
  standalone: false,
  styleUrls: ['./scd-scd-shape-defaults-grid.component.scss'
],
...
export class ScdShapeDefaultsScdScdShapeDefaultsGridGridComponent implements OnInit,OnDestroy {
 ...
 public showToolBar = true;
  ...
  public isMaster: boolean = false;
  	...
  	public  isSHAPE_DEFAULT_IDEnable : boolean = true; 
  ...
  private masterKey ="";
  private masterKeyName ="SHAPE_DEFAULT_ID";
  private insertCMD = "INSERT_SCD_SHAPE_DEFAULTS";
  private updateCMD = "UPDATE_SCD_SHAPE_DEFAULTS";
  private deleteCMD =   "DELETE_SCD_SHAPE_DEFAULTS";
  private getCMD = "GET_SCD_SHAPE_DEFAULTS_QUERY";
  ...
  public primarKeyReadOnlyArr = {isSHAPE_DEFAULT_IDreadOnly : false};  
  public paramConfig;
...
public compSelector = 'app-scd-scd-shape-defaults-grid';
  ...
  @Output() setComponentConfig_Output: EventEmitter<any> = new EventEmitter();
    ...
    constructor(public router: Router,public intl: IntlService, public responsive: BreakpointObserver, private starNotify: StarNotifyService,   public starServices: starServices, private renderer: Renderer2) {
      ...
      this.title = this.componentConfig.title ? this.componentConfig.title :this.starServices.getNLS([],"SCD_SCD_SHAPE_DEFAULTS_GRID.scdshapeDefaultsScdScdShapeDefaultsGrid.component_title","SCD SHAPE DEFAULTS GRID");
  }
...
//Next part for filtering
  ...
  @Input() public set detail_Input(grid: any) {
    ...
    /*
    if ( (grid.SHAPE_DEFAULT_ID != "") &&   (typeof grid.SHAPE_DEFAULT_ID != "undefined"))
    {
      this.masterKey = grid.SHAPE_DEFAULT_ID;
  ...
  private gridInitialValues:any = new scdshapeDefaultsScdScdShapeDefaultsGrid();   
 ...
 async cellClickHandler(event:any ) {
  ...
  if (typeof this[name] === 'function') {
    ...
    this.readCompletedOutput.emit(this.formGroup.value);
     ...
     let componentConfig = new componentConfigDef();
      ...
      let masterKeyArr = [this.formGroup.value['SHAPE_DEFAULT_ID']];
      let masterKeyNameArr = ['SHAPE_DEFAULT_ID'];
  ...
  public enterQuery (grid : GridComponent): void{
   ...
   async callBackFunction(data:any) {
      ...
      let masterKeyArr = [GridData.data[0]['SHAPE_DEFAULT_ID']];
      let masterKeyNameArr = ['SHAPE_DEFAULT_ID'];
      //for (let i = 0; i < masterKeyNameArr.length; i++) {
      //  componentConfig.[masterKeyNameArr[i]] = masterKeyArr[i];
      //}
  ...
  public commonCallStarNotify(data:any) {
    ...
    let masterParams = {
      data: this.masterKeyArr
       ...
       let masterKeyArr = [data['SHAPE_DEFAULT_ID']];
      let masterKeyNameArr = ['SHAPE_DEFAULT_ID'];
      //for (let i = 0; i < masterKeyNameArr.length; i++) {
      //  componentConfig.[masterKeyNameArr[i]] = masterKeyArr[i];
      //}
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ScdShapeDefaultsScdScdShapeDefaultsGridGrid ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_SHAPE_DEFAULT_ID(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['SHAPE_DEFAULT_ID'] != "undefined" ) 
      this.formGroup.controls['SHAPE_DEFAULT_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['SHAPE_DEFAULT_ID'] != "undefined" ) 
     this.formGroup.get('SHAPE_DEFAULT_ID').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_SHAPE_DEFAULT_ID(event){
...
async WHEN_VALIDATE_ITEM_SHAPE_TYPE(formGroup) {
 ...
 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['SHAPE_TYPE'] != "undefined" ) 
      this.formGroup.controls['SHAPE_TYPE'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['SHAPE_TYPE'] != "undefined" ) 
     this.formGroup.get('SHAPE_TYPE').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_FIELD_NAME(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['FIELD_NAME'] != "undefined" ) 
      this.formGroup.controls['FIELD_NAME'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['FIELD_NAME'] != "undefined" ) 
     this.formGroup.get('FIELD_NAME').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }

 async ON_CLICK_FIELD_NAME(event){
...
async WHEN_VALIDATE_ITEM_FIELD_VALUE(formGroup) {
 ...
 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['FIELD_VALUE'] != "undefined" ) 
 ...
 async ON_CLICK_FIELD_VALUE(event){
 ...
 async onBlur_FIELD_NAME() { 
  await this.WHEN_VALIDATE_ITEM_FIELD_NAME(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
