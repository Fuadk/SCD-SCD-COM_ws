...
import {  scdshapeScdTpCommonScreen  ,scdbrowserGeneralScdBgBrowserGeneral  , componentConfigDef} from '@modeldir/model';
...
@Component({
  ...
  selector: 'app-scd-browser-properties',
  templateUrl: './scd-browser-properties.component.html',
  styleUrls: ['./scd-browser-properties.component.scss'],
  standalone: false
})
export class ScdBrowserPropertiesComponent implements OnInit {
  ...
  constructor(public router: Router,public responsive: BreakpointObserver, private starNotify: StarNotifyService, public starServices: starServices, public starlib1: Starlib1) {
   this.router = router;
  this.title =  this.starServices.getNLS([],"scd_browser_properties.scd_browser_properties.component_title","");
  ...
  public routineName = "scd_browser_properties";
  ...
  public form_1_SCD_BROWSER_GENERAL : scdbrowserGeneralScdBgBrowserGeneral;
  public  SCD_SHAPEForm_0Config : componentConfigDef;
  public  hide_comp_1 = false
  public  SCD_BROWSER_GENERALForm_1Config : componentConfigDef;
  public  hide_comp_2 = false
  public PDFfileName = this.title + ".PDF";
  public routineAuth = "ScdBrowserProperties";

  public ngAfterViewInit() {
    this.starServices.setRTL();
  }
  private componentConfigChangeEvent!: Subscription;
  public compSelector = 'app-scd-browser-properties';
  ...
  async initComponents(){
   ...
   this.SCD_SHAPEForm_0Config.title = this.starServices.getNLS([],"scd_browser_properties.scd_browser_properties.compsTitleID1","Common");
   ...
   this.SCD_BROWSER_GENERALForm_1Config = new componentConfigDef();
   this.SCD_BROWSER_GENERALForm_1Config.title = this.starServices.getNLS([],"scd_browser_properties.scd_browser_properties.compsTitleID2","General");
   this.SCD_BROWSER_GENERALForm_1Config.isChild = true;
   this.SCD_BROWSER_GENERALForm_1Config.masterSelector = 'app-scd-browser-properties';
   this.SCD_BROWSER_GENERALForm_1Config.showToolBar = !this.visibleOK_BTNS; 
   if (typeof this['steps']  !== 'undefined') {
     this.SCD_BROWSER_GENERALForm_1Config.navigable = false;
     //this.SCD_BROWSER_GENERALForm_1Config.insertable = true;
     //this.SCD_BROWSER_GENERALForm_1Config.removeable = true;
   }
  }
  ...
  public readCompletedHandler( form_SCD_SHAPE) {
    ...
    let masterKeyNameArr = ["SHAPE_ID","DISPLAY_ID"];
     if (this.isSearchScreen == true) 
	  {
    	this.SCD_BROWSER_GENERALForm_1Config = new componentConfigDef();
    	this.SCD_BROWSER_GENERALForm_1Config.formattedWhere  = form_SCD_SHAPE;
    	return;
	  }
    //this.form_1_SCD_BROWSER_GENERAL = new scdbrowserGeneralScdBgBrowserGeneral();
    //for (let i = 0; i< masterKeyNameArr.length; i++){
    //   this.form_1_SCD_BROWSER_GENERAL[masterKeyNameArr[i]] = masterKeyArr[i];
    //}
    this.SCD_BROWSER_GENERALForm_1Config = new componentConfigDef();
    this.SCD_BROWSER_GENERALForm_1Config.masterKeyArr =  [form_SCD_SHAPE.SHAPE_ID,form_SCD_SHAPE.DISPLAY_ID];
    this.SCD_BROWSER_GENERALForm_1Config.masterKeyNameArr =  ["SHAPE_ID","DISPLAY_ID"];
    this.SCD_BROWSER_GENERALForm_1Config.masterReadCompleted = true;
   if (typeof this['steps'] !== 'undefined') {
     this.SCD_BROWSER_GENERALForm_1Config.queryable = false;
     //this.SCD_BROWSER_GENERALForm_1Config.removeable = true;
     //this.SCD_BROWSER_GENERALForm_1Config.updateable = true;
   }
  }
  ...
  public sendToChildren(componentConfig, pageNo){ 
   if ( (pageNo + 1) == 2){
  	this.SCD_BROWSER_GENERALForm_1Config = new componentConfigDef(); 
  	this.SCD_BROWSER_GENERALForm_1Config = componentConfig; 
   }
 } 
 ...
 if ( key != '') { 
    this.SCD_BROWSER_GENERALForm_1Config = new componentConfigDef();
    this.SCD_BROWSER_GENERALForm_1Config.masterSaved = form_SCD_SHAPE;
    this.SCD_BROWSER_GENERALForm_1Config.masterKeyArr =  [form_SCD_SHAPE.SHAPE_ID,form_SCD_SHAPE.DISPLAY_ID];
    this.SCD_BROWSER_GENERALForm_1Config.masterKeyNameArr =  ["SHAPE_ID","DISPLAY_ID"];
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("ComponentConfig:ScdBrowserPropertiesComponent:",ComponentConfig);
    if (typeof ComponentConfig !== "undefined"){
       ...
       if (ComponentConfig.languageChanged != null) { 
           setTimeout(() => {
             ...
             this.SCD_SHAPEForm_0Config.title = this.starServices.getNLS([],"scd_browser_properties.scd_browser_properties.compsTitleID1","Common");
             this.SCD_BROWSER_GENERALForm_1Config = new componentConfigDef();
             this.SCD_BROWSER_GENERALForm_1Config.languageChanged = ComponentConfig.languageChanged;
             this.SCD_BROWSER_GENERALForm_1Config.title = this.starServices.getNLS([],"scd_browser_properties.scd_browser_properties.compsTitleID2","General");
           this.setSteps(this);
           }, 500);
       }
       ...
       if (ComponentConfig.masterParams != null) {
              ...
              this.SCD_BROWSER_GENERALForm_1Config.masterParams = ComponentConfig.masterParams;
   		
       }
       if (ComponentConfig.showToolBar != null) {
              this.SCD_SHAPEForm_0Config.showToolBar = ComponentConfig.showToolBar;
              this.SCD_BROWSER_GENERALForm_1Config.showToolBar = ComponentConfig.showToolBar;
       }
      ...
      if (ComponentConfig.newRec != null)
      {
       ...
       this.SCD_BROWSER_GENERALForm_1Config.newRec = ComponentConfig.newRec;
      }
      if (ComponentConfig.clearScreen != null)
      {
       this.SCD_SHAPEForm_0Config.clearScreen = ComponentConfig.clearScreen;
       this.SCD_BROWSER_GENERALForm_1Config.clearScreen = ComponentConfig.clearScreen;
	   }
      if ((ComponentConfig.masterKeyArr != null) && (ComponentConfig.masterKeyNameArr != null) )
      {
       if ((ComponentConfig.masterKeyArr.length != 0) && (ComponentConfig.masterKeyNameArr.length != 0) )
       {
         ...
         this.SCD_BROWSER_GENERALForm_1Config.masterKeyArr = ComponentConfig.masterKeyArr;
         this.SCD_BROWSER_GENERALForm_1Config.masterKeyNameArr = ComponentConfig.masterKeyNameArr;
         if (ComponentConfig.masterReadCompleted != null) 
         {
             this.SCD_BROWSER_GENERALForm_1Config.masterReadCompleted = ComponentConfig.masterReadCompleted;
          }
       }
      }
    }
  }
   public form_1_SCD_BROWSER_GENERALOpened = false;
  public  form_1_SCD_BROWSER_GENERALClose() { 
    this.form_1_SCD_BROWSER_GENERALOpened = false;  
  }
  public  form_1_SCD_BROWSER_GENERALOpen() { 
    this.form_1_SCD_BROWSER_GENERALOpened = true;  
  }
