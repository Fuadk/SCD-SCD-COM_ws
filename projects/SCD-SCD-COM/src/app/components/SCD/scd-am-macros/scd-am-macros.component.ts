...
import {   scdmacroScdAmMacros , componentConfigDef } from '@modeldir/model';
...
@Component({
  selector: 'app-scd-am-macros',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-am-macros.component.html',
  standalone: false,
  styleUrls: ['./scd-am-macros.component.scss'
],
...
export class ScdMacroScdAmMacrosGridComponent implements OnInit,OnDestroy {
 ...
 public showToolBar = true;
  ...
  public isMaster: boolean = false;
  	...
  	public  isMACRO_IDEnable : boolean = true; 
  ...
  public title =  this.starServices.getNLS([],"SCD_AM_MACROS.scdmacroScdAmMacros.component_title","Macros");
  public PDFfileName = this.title + ".PDF";
  public ExcelfileName = this.title + ".xlsx";
  public componentConfig
  public compTitleMsg =  "SCD_AM_MACROS.scdmacroScdAmMacros";
  ...
  public primarKeyReadOnlyArr = {isMACRO_IDreadOnly : false};  
  public paramConfig;
...
public visibleMACRO_TEXT = false;

public compSelector = 'app-scd-am-macros';
  ...
  @Output() formValidationChangedOutput: EventEmitter<boolean> = new EventEmitter();
    ...
    constructor(public router: Router,public intl: IntlService, public responsive: BreakpointObserver, private starNotify: StarNotifyService,   public starServices: starServices, private renderer: Renderer2) {
      ...
      this.title = this.componentConfig.title ? this.componentConfig.title :this.starServices.getNLS([],"SCD_AM_MACROS.scdmacroScdAmMacros.component_title","Macros");
  }
...
//Next part for filtering
  ...
  private gridInitialValues:any = new scdmacroScdAmMacros();   
  ...
  public commonCallStarNotify(data:any) {
    ...
    let masterParams = {
      data: this.masterKeyArr
       ...
       let masterKeyArr = [data['MACRO_ID']];
      let masterKeyNameArr = ['MACRO_ID'];
      //for (let i = 0; i < masterKeyNameArr.length; i++) {
      //  componentConfig.[masterKeyNameArr[i]] = masterKeyArr[i];
      //}
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ScdMacroScdAmMacrosGrid ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_MACRO_ID(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['MACRO_ID'] != "undefined" ) 
      this.formGroup.controls['MACRO_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['MACRO_ID'] != "undefined" ) 
     this.formGroup.get('MACRO_ID').updateValueAndValidity();
...
async WHEN_VALIDATE_ITEM_MACRO_NAME(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['MACRO_NAME'] != "undefined" ) 
      this.formGroup.controls['MACRO_NAME'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['MACRO_NAME'] != "undefined" ) 
     this.formGroup.get('MACRO_NAME').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_MACRO_TEXT(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['MACRO_TEXT'] != "undefined" ) 
      this.formGroup.controls['MACRO_TEXT'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['MACRO_TEXT'] != "undefined" ) 
     this.formGroup.get('MACRO_TEXT').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
 ...
 async onBlur_MACRO_ID() { 
  await this.WHEN_VALIDATE_ITEM_MACRO_ID(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 ...
 async onBlur_MACRO_NAME() { 
  await this.WHEN_VALIDATE_ITEM_MACRO_NAME(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_MACRO_TEXT() { 
  await this.WHEN_VALIDATE_ITEM_MACRO_TEXT(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 }
