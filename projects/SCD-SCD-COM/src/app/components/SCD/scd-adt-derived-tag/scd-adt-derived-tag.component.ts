...
import { scdderivedTagScdAdtDerivedTag , componentConfigDef} from '@modeldir/model';


 const createFormGroup = (dataItem:any) => new FormGroup({
'DERIVED_TAG_ID' : new FormControl(dataItem.DERIVED_TAG_ID  , ) ,
...
@Component({
  selector: 'app-scd-adt-derived-tag',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-adt-derived-tag.component.html',
  styleUrls: ['./scd-adt-derived-tag.component.scss'],
  standalone: false
})


export class ScdDerivedTagScdAdtDerivedTagFormComponent {
  public title =  this.starServices.getNLS([],"SCD_ADT_DERIVED_TAG.scdderivedTagScdAdtDerivedTag.component_title","Derived Tag");
  public compTitleMsg =  "SCD_ADT_DERIVED_TAG.scdderivedTagScdAdtDerivedTag";
  public routineName = "ScdDerivedTagScdAdtDerivedTagForm";
  private insertCMD = "INSERT_SCD_DERIVED_TAG";
  private updateCMD = "UPDATE_SCD_DERIVED_TAG";
  private deleteCMD =   "DELETE_SCD_DERIVED_TAG";
  private getCMD = "GET_SCD_DERIVED_TAG_QUERY";
  ...
  public primarKeyReadOnlyArr = {isDERIVED_TAG_IDreadOnly : false , isAPPLICATION_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-adt-derived-tag';
  public PK_AUTO = 'DERIVED_TAG_ID';
  public customerFacing = false;
  public FormStepsArr = [] ;
public labelDERIVED_TAG_IDTop=false;
public labelDERIVED_TAG_IDVisible=true;
...
public labelSELECT_TAGTop=false;
public labelSELECT_TAGVisible=true;
...
public disableDERIVED_TAG_ID = false;
public disableAPPLICATION_ID = false;
public disableTAG_NAME = false;
public disableSELECT_TAG = false;
...
public variableSELECT_TAG;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdderivedTagScdAdtDerivedTag();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdDerivedTagScdAdtDerivedTagForm form.APPLICATION_ID :' + form.APPLICATION_ID);
  ...
  async  enterQuery (form : any){
    ...
    async callBackPost_Insert(NewVal:any) {
      ...
      this.Comp_Config.masterKeyArr =  [NewVal['DERIVED_TAG_ID']];
      this.Comp_Config.masterKeyNameArr =  ["DERIVED_TAG_ID"];
...
onChanges(): void {
this.form.get('DERIVED_TAG_ID').valueChanges.subscribe(val => {
});
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdDerivedTagScdAdtDerivedTagForm ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_DERIVED_TAG_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['DERIVED_TAG_ID'] != "undefined" ) 
      this.form.controls['DERIVED_TAG_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['DERIVED_TAG_ID'] != "undefined" ) 
     this.form.get('DERIVED_TAG_ID').updateValueAndValidity();
...
async WHEN_VALIDATE_ITEM_SELECT_TAG(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['SELECT_TAG'] != "undefined" ) 
      this.form.controls['SELECT_TAG'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['SELECT_TAG'] != "undefined" ) 
     this.form.get('SELECT_TAG').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_SELECT_TAG(event){
...
async WHEN_VALIDATE_ITEM_ERROR_MSG(value) {
 ...
 async onChange_DERIVED_TAG_ID(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_DERIVED_TAG_ID(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onValueChange_SELECT_TAG(value) { 
  this.FORM_TRIGGER_FAILURE = false;	
 await this.WHEN_VALIDATE_ITEM_SELECT_TAG(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
