...
@Component({
  selector: 'app-scd-application-users',
  templateUrl: './scd-application-users.component.html',
  styleUrls: ['./scd-application-users.component.scss'],
  standalone: false
})
export class ScdApplicationUsersComponent implements OnInit {
  ...
  public routineName = "ScdApplicationUsers";
  ...
  constructor(public responsive: BreakpointObserver, private starNotify: StarNotifyService, public starServices: starServices) {
    this.title =  this.starServices.getNLS([],"SCD_application_users.SCD_application_users.component_title","Application Users");
...
public ngAfterViewInit() {
 ...
 @Input() public set detail_Input(form: any) { 
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("ComponentConfig:ScdApplicationUsersComponent:",ComponentConfig);
