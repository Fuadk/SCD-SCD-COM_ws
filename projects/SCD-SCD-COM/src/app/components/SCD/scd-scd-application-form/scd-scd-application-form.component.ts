...
@Component({
  selector: 'app-scd-scd-application-form',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-scd-application-form.component.html',
  styleUrls: ['./scd-scd-application-form.component.scss'],
  standalone: false
})


export class ScdApplicationScdScdApplicationFormFormComponent {
  public title =  this.starServices.getNLS([],"SCD_SCD_APPLICATION_FORM.scdapplicationScdScdApplicationForm.component_title","SCD APPLICATION FORM");
  public compTitleMsg =  "SCD_SCD_APPLICATION_FORM.scdapplicationScdScdApplicationForm";
  public routineName = "ScdApplicationScdScdApplicationFormForm";
  ...
  public compSelector = 'app-scd-scd-application-form';
...
public variableHIDE_BUT;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdapplicationScdScdApplicationForm();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdApplicationScdScdApplicationFormForm form.APPLICATION_ID :' + form.APPLICATION_ID);
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdApplicationScdScdApplicationFormForm ComponentConfig:", {...ComponentConfig});
