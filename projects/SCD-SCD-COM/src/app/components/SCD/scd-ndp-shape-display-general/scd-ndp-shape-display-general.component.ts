...
import { scdshapeDisplayGeneralScdNdpShapeDisplayGeneral , componentConfigDef} from '@modeldir/model';


 const createFormGroup = (dataItem:any) => new FormGroup({
'SHAPE_DISPLAY_GENERAL_ID' : new FormControl(dataItem.SHAPE_DISPLAY_GENERAL_ID  , ) ,
...
'OFFSET' : new FormControl(dataItem.OFFSET  , ) 
});

declare function getParamConfig():any;
@Component({
  selector: 'app-scd-ndp-shape-display-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-ndp-shape-display-general.component.html',
  styleUrls: ['./scd-ndp-shape-display-general.component.scss'],
  standalone: false
})


export class ScdShapeDisplayGeneralScdNdpShapeDisplayGeneralFormComponent {
  public title =  this.starServices.getNLS([],"SCD_NDP_SHAPE_DISPLAY_GENERAL.scdshapeDisplayGeneralScdNdpShapeDisplayGeneral.component_title","Shape Display General");
  public compTitleMsg =  "SCD_NDP_SHAPE_DISPLAY_GENERAL.scdshapeDisplayGeneralScdNdpShapeDisplayGeneral";
  public routineName = "ScdShapeDisplayGeneralScdNdpShapeDisplayGeneralForm";
  private insertCMD = "INSERT_SCD_SHAPE_DISPLAY_GENERAL";
  private updateCMD = "UPDATE_SCD_SHAPE_DISPLAY_GENERAL";
  private deleteCMD =   "DELETE_SCD_SHAPE_DISPLAY_GENERAL";
  private getCMD = "GET_SCD_SHAPE_DISPLAY_GENERAL_QUERY";
  ...
  public primarKeyReadOnlyArr = {isSHAPE_DISPLAY_GENERAL_IDreadOnly : false , isSHAPE_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-ndp-shape-display-general';
  public PK_AUTO = 'SHAPE_DISPLAY_GENERAL_ID';
  public customerFacing = false;
  public FormStepsArr = [] ;
public labelSHAPE_DISPLAY_GENERAL_IDTop=false;
public labelSHAPE_DISPLAY_GENERAL_IDVisible=true;
...
public labelOFFSETTop=false;
public labelOFFSETVisible=true;

public visibleSHAPE_DISPLAY_GENERAL_ID = false;
public visibleSHAPE_ID = false;
public visibleEXPRESSION_DATA = false;
public visibleFORMAT = true;
public visibleOVERFLOW = false;
public visibleFIELD_LENGTH = true;
public visibleSHOW_DIGIT_GROUPING = false;
public visibleDECIMAL_PLACES = false;
public visibleFIXED_DECIMAL_PLACES = false;
public visibleDYNAMIC_DECIMAL_PLACES = false;
public visibleJUSTIFICATION = true;
public visibleLEADING_CHARACTER = false;
public visibleWIDTH = false;
public visibleHEIGHT = false;
public visibleOFFSET = false;

public disableSHAPE_DISPLAY_GENERAL_ID = false;
...
public disableOFFSET = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdshapeDisplayGeneralScdNdpShapeDisplayGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdShapeDisplayGeneralScdNdpShapeDisplayGeneralForm form.SHAPE_ID :' + form.SHAPE_ID);
  ...
  async  enterQuery (form : any){
    ...
    async callBackPost_Insert(NewVal:any) {
      ...
      this.Comp_Config.masterKeyArr =  [NewVal['SHAPE_DISPLAY_GENERAL_ID']];
      this.Comp_Config.masterKeyNameArr =  ["SHAPE_DISPLAY_GENERAL_ID"];
...
this.form.get('OVERFLOW').valueChanges.subscribe(val => {
});
this.form.get('FIELD_LENGTH').valueChanges.subscribe(val => {
});
this.form.get('SHOW_DIGIT_GROUPING').valueChanges.subscribe(val => {
});
this.form.get('DECIMAL_PLACES').valueChanges.subscribe(val => {
});
...
this.form.get('JUSTIFICATION').valueChanges.subscribe(val => {
});
this.form.get('LEADING_CHARACTER').valueChanges.subscribe(val => {
});
this.form.get('WIDTH').valueChanges.subscribe(val => {
});
this.form.get('HEIGHT').valueChanges.subscribe(val => {
});
this.form.get('OFFSET').valueChanges.subscribe(val => {
});
}
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdShapeDisplayGeneralScdNdpShapeDisplayGeneralForm ComponentConfig:", {...ComponentConfig});
...
async WHEN_VALIDATE_ITEM_SHAPE_DISPLAY_GENERAL_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['SHAPE_DISPLAY_GENERAL_ID'] != "undefined" ) 
      this.form.controls['SHAPE_DISPLAY_GENERAL_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['SHAPE_DISPLAY_GENERAL_ID'] != "undefined" ) 
     this.form.get('SHAPE_DISPLAY_GENERAL_ID').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_SHAPE_DISPLAY_GENERAL_ID(event){
...
async WHEN_VALIDATE_ITEM_OFFSET(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['OFFSET'] != "undefined" ) 
      this.form.controls['OFFSET'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['OFFSET'] != "undefined" ) 
     this.form.get('OFFSET').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_OFFSET(event){

}
 
 async onChange_SHAPE_DISPLAY_GENERAL_ID(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_SHAPE_DISPLAY_GENERAL_ID(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
 ...
 async onChange_OVERFLOW(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 ...
 async onChange_OFFSET(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_OFFSET(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
