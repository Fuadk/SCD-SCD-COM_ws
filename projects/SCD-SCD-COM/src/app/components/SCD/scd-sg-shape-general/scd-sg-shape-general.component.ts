...
import { scdshapeGeneralScdSgShapeGeneral , componentConfigDef} from '@modeldir/model';
...
@Component({
  selector: 'app-scd-sg-shape-general',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-sg-shape-general.component.html',
  styleUrls: ['./scd-sg-shape-general.component.scss'],
  standalone: false
})


export class ScdShapeGeneralScdSgShapeGeneralFormComponent {
  public title =  this.starServices.getNLS([],"SCD_SG_SHAPE_GENERAL.scdshapeGeneralScdSgShapeGeneral.component_title","Shape General");
  public compTitleMsg =  "SCD_SG_SHAPE_GENERAL.scdshapeGeneralScdSgShapeGeneral";
  public routineName = "ScdShapeGeneralScdSgShapeGeneralForm";
  private insertCMD = "INSERT_SCD_SHAPE_GENERAL";
  private updateCMD = "UPDATE_SCD_SHAPE_GENERAL";
  private deleteCMD =   "DELETE_SCD_SHAPE_GENERAL";
  private getCMD = "GET_SCD_SHAPE_GENERAL_QUERY";
  ...
  public primarKeyReadOnlyArr = {isSHAPE_GENERAL_IDreadOnly : false , isSHAPE_IDreadOnly : false};  
  public paramConfig;
  ...
  public compSelector = 'app-scd-sg-shape-general';
  public PK_AUTO = 'SHAPE_GENERAL_ID';
  public customerFacing = false;
  public FormStepsArr = [] ;
public labelSHAPE_GENERAL_IDTop=true;
...
public disableBLINK = false;
 ...
 // Subscribing the event.
  ...
  private formInitialValues:any =   new scdshapeGeneralScdSgShapeGeneral();   
    @Input() public set detail_Input(form: any) {
      ...
      /*
    if (this.paramConfig.DEBUG_FLAG) console.log('detail_Input ScdShapeGeneralScdSgShapeGeneralForm form.SHAPE_ID :' + form.SHAPE_ID);
  ...
  async  enterQuery (form : any){
    ...
    async callBackPost_Insert(NewVal:any) {
      ...
      this.Comp_Config.masterKeyArr =  [NewVal['SHAPE_GENERAL_ID']];
      this.Comp_Config.masterKeyNameArr =  ["SHAPE_GENERAL_ID"];
...
public printScreen(){
  ...
  public handleComponentConfig(ComponentConfig:any) {
    if (typeof ComponentConfig !== "undefined") {
      if (this.paramConfig.DEBUG_FLAG) console.log("ScdShapeGeneralScdSgShapeGeneralForm ComponentConfig:", {...ComponentConfig});
  ...
  async WHEN_NOTIFY(ComponentConfig){
    if (ComponentConfig.masterParams != null) {
      ...
      switch (ComponentConfig.masterParams.data.SHAPE_TYPE) {
        case "panel":
...
async WHEN_VALIDATE_ITEM_SHAPE_GENERAL_ID(value) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.form.controls['SHAPE_GENERAL_ID'] != "undefined" ) 
      this.form.controls['SHAPE_GENERAL_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.form.controls['SHAPE_GENERAL_ID'] != "undefined" ) 
     this.form.get('SHAPE_GENERAL_ID').updateValueAndValidity();
 this.form.updateValueAndValidity(); 
 }

 async ON_CLICK_SHAPE_GENERAL_ID(event){
...
async WHEN_VALIDATE_ITEM_BLINK(value) {
 ...
 async onChange_SHAPE_GENERAL_ID(event:any) { 
 var value = event.target.value; 
 if ((value == null) || (value == '')) 	
 	return;  
    this.FORM_TRIGGER_FAILURE = false;	
 await   this.WHEN_VALIDATE_ITEM_SHAPE_GENERAL_ID(value); if ( this.FORM_TRIGGER_FAILURE) return; 
 this.formValidationChangedOutput.emit(this.form.valid); 
