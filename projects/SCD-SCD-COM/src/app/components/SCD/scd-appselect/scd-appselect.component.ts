...
import {  scdapplicationScdAdApplication  ,scdapplicationScdScdApplicationTree  , componentConfigDef} from '@modeldir/model';
...
@Component({
  ...
  selector: 'app-scd-appselect',
  templateUrl: './scd-appselect.component.html',
  styleUrls: ['./scd-appselect.component.scss'],
  standalone: false
})
export class ScdAppselectComponent implements OnInit {
  ...
  constructor(public router: Router,public responsive: BreakpointObserver, private starNotify: StarNotifyService, public starServices: starServices, public starlib1: Starlib1) {
   this.router = router;
  this.title =  this.starServices.getNLS([],"scd_appselect.scd_appselect.component_title","");
  ...
  public routineName = "scd_appselect";
  ...
  public tree_1_SCD_APPLICATION : scdapplicationScdScdApplicationTree;
  public  SCD_APPLICATIONForm_0Config : componentConfigDef;
  public  SCD_APPLICATIONTree_1Config : componentConfigDef;
  public PDFfileName = this.title + ".PDF";
  public routineAuth = "ScdAppselect";

  public ngAfterViewInit() {
    this.starServices.setRTL();
  }
  private componentConfigChangeEvent!: Subscription;
  public compSelector = 'app-scd-appselect';
  ...
  async initComponents(){
   ...
   this.SCD_APPLICATIONForm_0Config.title = this.starServices.getNLS([],"scd_appselect.scd_appselect.compsTitleID1","App");
   ...
   this.SCD_APPLICATIONTree_1Config = new componentConfigDef();
   this.SCD_APPLICATIONTree_1Config.title = this.starServices.getNLS([],"scd_appselect.scd_appselect.compsTitleID2","App");
   this.SCD_APPLICATIONTree_1Config.isChild = true;
   this.SCD_APPLICATIONTree_1Config.masterSelector = 'app-scd-appselect';
   if (typeof this['steps']  !== 'undefined') {
     this.SCD_APPLICATIONTree_1Config.navigable = false;
     //this.SCD_APPLICATIONTree_1Config.insertable = true;
     //this.SCD_APPLICATIONTree_1Config.removeable = true;
   }
  }
  ...
  public readCompletedHandler( form_SCD_APPLICATION) {
    ...
    let masterKeyNameArr = ["APPLICATION_ID"];
     if (this.isSearchScreen == true) 
	  {
    	this.SCD_APPLICATIONTree_1Config = new componentConfigDef();
    	this.SCD_APPLICATIONTree_1Config.formattedWhere  = form_SCD_APPLICATION;
    	return;
	  }
    //this.tree_1_SCD_APPLICATION = new scdapplicationScdScdApplicationTree();
    //for (let i = 0; i< masterKeyNameArr.length; i++){
    //   this.tree_1_SCD_APPLICATION[masterKeyNameArr[i]] = masterKeyArr[i];
    //}
    this.SCD_APPLICATIONTree_1Config = new componentConfigDef();
    this.SCD_APPLICATIONTree_1Config.masterKeyArr =  [form_SCD_APPLICATION.APPLICATION_ID];
    this.SCD_APPLICATIONTree_1Config.masterKeyNameArr =  ["APPLICATION_ID"];
    this.SCD_APPLICATIONTree_1Config.masterReadCompleted = true;
   if (typeof this['steps'] !== 'undefined') {
     this.SCD_APPLICATIONTree_1Config.queryable = false;
     //this.SCD_APPLICATIONTree_1Config.removeable = true;
     //this.SCD_APPLICATIONTree_1Config.updateable = true;
   }
  }
  ...
  public sendToChildren(componentConfig, pageNo){ 
   if ( (pageNo + 1) == 2){
  	this.SCD_APPLICATIONTree_1Config = new componentConfigDef(); 
  	this.SCD_APPLICATIONTree_1Config = componentConfig; 
   }
 } 
 ...
 if ( key != '') { 
    this.SCD_APPLICATIONTree_1Config = new componentConfigDef();
    this.SCD_APPLICATIONTree_1Config.masterSaved = form_SCD_APPLICATION;
    this.SCD_APPLICATIONTree_1Config.masterKeyArr =  [form_SCD_APPLICATION.APPLICATION_ID];
    this.SCD_APPLICATIONTree_1Config.masterKeyNameArr =  ["APPLICATION_ID"];
  ...
  @Input() public set setComponentConfig_Input(ComponentConfig: componentConfigDef) {
    ...
    if (this.paramConfig.DEBUG_FLAG) console.log("ComponentConfig:ScdAppselectComponent:",ComponentConfig);
    if (typeof ComponentConfig !== "undefined"){
       ...
       if (ComponentConfig.languageChanged != null) { 
           setTimeout(() => {
             ...
             this.SCD_APPLICATIONForm_0Config.title = this.starServices.getNLS([],"scd_appselect.scd_appselect.compsTitleID1","App");
             this.SCD_APPLICATIONTree_1Config = new componentConfigDef();
             this.SCD_APPLICATIONTree_1Config.languageChanged = ComponentConfig.languageChanged;
             this.SCD_APPLICATIONTree_1Config.title = this.starServices.getNLS([],"scd_appselect.scd_appselect.compsTitleID2","App");
           this.setSteps(this);
           }, 400);
       }
      ...
      if (ComponentConfig.masterSaved != null)
      {
       ...
       this.SCD_APPLICATIONTree_1Config.masterSaved = ComponentConfig.masterSaved;
      }
      if (ComponentConfig.newRec != null)
      {
       this.SCD_APPLICATIONForm_0Config.newRec = ComponentConfig.newRec;
       this.SCD_APPLICATIONTree_1Config.newRec = ComponentConfig.newRec;
      }
      if (ComponentConfig.clearScreen != null)
      {
       this.SCD_APPLICATIONForm_0Config.clearScreen = ComponentConfig.clearScreen;
       this.SCD_APPLICATIONTree_1Config.clearScreen = ComponentConfig.clearScreen;
	   }
      if ((ComponentConfig.masterKeyArr != null) && (ComponentConfig.masterKeyNameArr != null) )
      {
       if ((ComponentConfig.masterKeyArr.length != 0) && (ComponentConfig.masterKeyNameArr.length != 0) )
       {
         ...
         this.SCD_APPLICATIONTree_1Config.masterKeyArr = ComponentConfig.masterKeyArr;
         this.SCD_APPLICATIONTree_1Config.masterKeyNameArr = ComponentConfig.masterKeyNameArr;
         if (ComponentConfig.masterReadCompleted != null) 
         {
             this.SCD_APPLICATIONTree_1Config.masterReadCompleted = ComponentConfig.masterReadCompleted;
          }
       }
      }
     }
   ...
   public tree_1_SCD_APPLICATIONOpened = false;
  public  tree_1_SCD_APPLICATIONClose() { 
    this.tree_1_SCD_APPLICATIONOpened = false;  
  }
  public  tree_1_SCD_APPLICATIONOpen() { 
    this.tree_1_SCD_APPLICATIONOpened = true;  
  }
