...
import {   scdappTreeContextScdScdAppTreeContextGrid , componentConfigDef } from '@modeldir/model';
...
@Component({
  selector: 'app-scd-scd-app-tree-context-grid',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-scd-app-tree-context-grid.component.html',
  standalone: false,
  styleUrls: ['./scd-scd-app-tree-context-grid.component.scss'
],
...
export class ScdAppTreeContextScdScdAppTreeContextGridGridComponent implements OnInit,OnDestroy {
 ...
 public showToolBar = true;
  ...
  private insertCMD = "INSERT_SCD_APP_TREE_CONTEXT";
  private updateCMD = "UPDATE_SCD_APP_TREE_CONTEXT";
  private deleteCMD =   "DELETE_SCD_APP_TREE_CONTEXT";
  private getCMD = "GET_SCD_APP_TREE_CONTEXT_QUERY";

  public  executeQueryresult:any;
  public title =  this.starServices.getNLS([],"SCD_SCD_APP_TREE_CONTEXT_GRID.scdappTreeContextScdScdAppTreeContextGrid.component_title","SCD APP TREE CONTEXT GRID");
  public PDFfileName = this.title + ".PDF";
  public ExcelfileName = this.title + ".xlsx";
  public componentConfig
  public compTitleMsg =  "SCD_SCD_APP_TREE_CONTEXT_GRID.scdappTreeContextScdScdAppTreeContextGrid";
...
public compSelector = 'app-scd-scd-app-tree-context-grid';
  ...
  @Output() formValidationChangedOutput: EventEmitter<boolean> = new EventEmitter();
    ...
    constructor(public router: Router,public intl: IntlService, public responsive: BreakpointObserver, private starNotify: StarNotifyService,   public starServices: starServices, private renderer: Renderer2) {
      ...
      this.title = this.componentConfig.title ? this.componentConfig.title :this.starServices.getNLS([],"SCD_SCD_APP_TREE_CONTEXT_GRID.scdappTreeContextScdScdAppTreeContextGrid.component_title","SCD APP TREE CONTEXT GRID");
  }
...
//Next part for filtering
  ...
  private gridInitialValues:any = new scdappTreeContextScdScdAppTreeContextGrid();   
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ScdAppTreeContextScdScdAppTreeContextGridGrid ComponentConfig:", ComponentConfig);
