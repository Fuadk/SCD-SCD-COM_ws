...
import {   scdjavascriptCodeScdScdJavascriptCodeGrid , componentConfigDef } from '@modeldir/model';
...
@Component({
  selector: 'app-scd-scd-javascript-code-grid',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './scd-scd-javascript-code-grid.component.html',
  standalone: false,
  styleUrls: ['./scd-scd-javascript-code-grid.component.scss'
],
...
export class ScdJavascriptCodeScdScdJavascriptCodeGridGridComponent implements OnInit,OnDestroy {
 ...
 public showToolBar = true;
  ...
  public isMaster: boolean = false;
  		...
  		public  isJAVASCRIPT_CODE_IDEnable : boolean = true; 
public  isDISPLAY_IDEnable : boolean = true; 
  ...
  private masterKey ="";
  private masterKeyName ="DISPLAY_ID";
  ...
  public title =  this.starServices.getNLS([],"SCD_SCD_JAVASCRIPT_CODE_GRID.scdjavascriptCodeScdScdJavascriptCodeGrid.component_title","SCD JAVASCRIPT CODE GRID");
  public PDFfileName = this.title + ".PDF";
  public ExcelfileName = this.title + ".xlsx";
  public componentConfig
  public compTitleMsg =  "SCD_SCD_JAVASCRIPT_CODE_GRID.scdjavascriptCodeScdScdJavascriptCodeGrid";
...
public visibleJAVASCRIPT_CODE_ID = true;
public visibleDISPLAY_ID = true;
public visibleSUBROUTINE_NAME = true;
public visibleSUBROUTINE_CODE = true;

public compSelector = 'app-scd-scd-javascript-code-grid';
  ...
  @Output() formValidationChangedOutput: EventEmitter<boolean> = new EventEmitter();
    ...
    constructor(public router: Router,public intl: IntlService, public responsive: BreakpointObserver, private starNotify: StarNotifyService,   public starServices: starServices, private renderer: Renderer2) {
      ...
      this.title = this.componentConfig.title ? this.componentConfig.title :this.starServices.getNLS([],"SCD_SCD_JAVASCRIPT_CODE_GRID.scdjavascriptCodeScdScdJavascriptCodeGrid.component_title","SCD JAVASCRIPT CODE GRID");
  }
...
//Next part for filtering
  ...
  @Input() public set detail_Input(grid: any) {
    ...
    /*
    if ( (grid.DISPLAY_ID != "") &&   (typeof grid.DISPLAY_ID != "undefined"))
    {
      this.masterKey = grid.DISPLAY_ID;
  ...
  private gridInitialValues:any = new scdjavascriptCodeScdScdJavascriptCodeGrid();   
 ...
 async cellClickHandler(event:any ) {
  ...
  if (typeof this[name] === 'function') {
    ...
    this.readCompletedOutput.emit(this.formGroup.value);
     ...
     let componentConfig = new componentConfigDef();
      ...
      let masterKeyArr = [this.formGroup.value['DISPLAY_ID']];
      let masterKeyNameArr = ['DISPLAY_ID'];
  ...
  public enterQuery (grid : GridComponent): void{
   ...
   async callBackFunction(data:any) {
      ...
      let masterKeyArr = [GridData.data[0]['DISPLAY_ID']];
      let masterKeyNameArr = ['DISPLAY_ID'];
      //for (let i = 0; i < masterKeyNameArr.length; i++) {
      //  componentConfig.[masterKeyNameArr[i]] = masterKeyArr[i];
      //}
  ...
  public commonCallStarNotify(data:any) {
    ...
    let masterParams = {
      data: this.masterKeyArr
       ...
       let masterKeyArr = [data['DISPLAY_ID'],data['JAVASCRIPT_CODE_ID']];
      let masterKeyNameArr = ['DISPLAY_ID','JAVASCRIPT_CODE_ID'];
      //for (let i = 0; i < masterKeyNameArr.length; i++) {
      //  componentConfig.[masterKeyNameArr[i]] = masterKeyArr[i];
      //}
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("ScdJavascriptCodeScdScdJavascriptCodeGridGrid ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_JAVASCRIPT_CODE_ID(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['JAVASCRIPT_CODE_ID'] != "undefined" ) 
      this.formGroup.controls['JAVASCRIPT_CODE_ID'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['JAVASCRIPT_CODE_ID'] != "undefined" ) 
     this.formGroup.get('JAVASCRIPT_CODE_ID').updateValueAndValidity();
...
async WHEN_VALIDATE_ITEM_SUBROUTINE_NAME(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['SUBROUTINE_NAME'] != "undefined" ) 
      this.formGroup.controls['SUBROUTINE_NAME'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['SUBROUTINE_NAME'] != "undefined" ) 
     this.formGroup.get('SUBROUTINE_NAME').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_SUBROUTINE_CODE(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 if (typeof this.formGroup.controls['SUBROUTINE_CODE'] != "undefined" ) 
      this.formGroup.controls['SUBROUTINE_CODE'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 if (typeof this.formGroup.controls['SUBROUTINE_CODE'] != "undefined" ) 
     this.formGroup.get('SUBROUTINE_CODE').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
 ...
 async onBlur_JAVASCRIPT_CODE_ID() { 
  await this.WHEN_VALIDATE_ITEM_JAVASCRIPT_CODE_ID(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 ...
 async onBlur_SUBROUTINE_NAME() { 
  await this.WHEN_VALIDATE_ITEM_SUBROUTINE_NAME(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_SUBROUTINE_CODE() { 
  await this.WHEN_VALIDATE_ITEM_SUBROUTINE_CODE(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 }
