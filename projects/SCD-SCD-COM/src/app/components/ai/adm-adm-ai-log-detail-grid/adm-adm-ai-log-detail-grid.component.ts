...
import {   admaiLogDetailAdmAdmAiLogDetailGrid , componentConfigDef } from '@modeldir/model';
...
@Component({
  selector: 'app-adm-adm-ai-log-detail-grid',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './adm-adm-ai-log-detail-grid.component.html',
  styleUrls: ['./adm-adm-ai-log-detail-grid.component.scss'
],
...
export class AdmAiLogDetailAdmAdmAiLogDetailGridGridComponent implements OnInit,OnDestroy {
...
public  isSTAGEEnable : boolean = true; 
public  isAI_SEQEnable : boolean = true; 
  ...
  public title =  this.starServices.getNLS([],"ADM_ADM_AI_LOG_DETAIL_GRID.admaiLogDetailAdmAdmAiLogDetailGrid.component_title","ADM AI LOG DETAIL GRID");
  ...
  public primarKeyReadOnlyArr = {isUSERNAMEreadOnly : false , isAP_IDreadOnly : false , isAI_ACTION_IDreadOnly : false , isAI_ENTITY_IDreadOnly : false , 
    isREQUESTED_ONreadOnly : false , isAI_SEQreadOnly : false, isSTAGEreadOnly : false};  
  public paramConfig;
...
public compSelector = 'app-adm-adm-ai-log-detail-grid';
...
//Next part for filtering
  ...
  private gridInitialValues:any = new admaiLogDetailAdmAdmAiLogDetailGrid();   
  ...
  public commonCallStarNotify(data:any) {
    ...
    let masterParams = {
      data: this.masterKeyArr
       ...
       let masterKeyArr = [data['USERNAME'],data['APP_ID'],data['AI_ACTION_ID'],data['AI_ENTITY_ID'],data['REQUESTED_ON'],data['AI_SEQ'],data['STAGE']];
  ...
  window.print();
   ...
   public handleComponentConfig(ComponentConfig:any) {
      ...
      if (typeof ComponentConfig !== "undefined") {
         if (this.paramConfig.DEBUG_FLAG) console.log("AdmAiLogDetailAdmAdmAiLogDetailGridGrid ComponentConfig:", ComponentConfig);
...
async WHEN_VALIDATE_ITEM_AI_SEQ(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 this.formGroup.controls['AI_SEQ'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 this.formGroup.get('AI_SEQ').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_STAGE(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 this.formGroup.controls['STAGE'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 this.formGroup.get('STAGE').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_QUESTION(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 this.formGroup.controls['QUESTION'].setErrors({invalid: true}); 
 // Code goes here 
 ...
 this.formGroup.get('QUESTION').updateValueAndValidity();
 this.formGroup.updateValueAndValidity(); 
 }
...
async WHEN_VALIDATE_ITEM_ANSWER(formGroup) {

 this.FORM_TRIGGER_FAILURE = false ; 
 this.formGroup.controls['ANSWER'].setErrors({invalid: true}); 
 // Code goes here 
...
async WHEN_VALIDATE_ITEM_LOGDATE(formGroup) {
 ...
 async onBlur_AI_SEQ() { 
  await this.WHEN_VALIDATE_ITEM_AI_SEQ(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_STAGE() { 
  await this.WHEN_VALIDATE_ITEM_STAGE(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_QUESTION() { 
  await this.WHEN_VALIDATE_ITEM_QUESTION(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
 async onBlur_ANSWER() { 
  await this.WHEN_VALIDATE_ITEM_ANSWER(this.formGroup); if ( this.FORM_TRIGGER_FAILURE) return;  
 } 
